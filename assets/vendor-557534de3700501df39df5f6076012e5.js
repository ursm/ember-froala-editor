...
var l="suspendedStart",u="suspendedYield",c="executing",p="completed",f={},d=y.prototype=g.prototype
...
return!!t&&(t===v||"GeneratorFunction"===(t.displayName||t.name))},a.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,y):(e.__proto__=y,o in e||(e[o]="GeneratorFunction")),e.prototype=Object.create(d),e},a.awrap=function(e){return new E(e)},b(T.prototype),a.async=function(e,t,n,r){var i=new T(h(e,t,n,r))
...
A(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:S(e),resultName:t,nextLoc:n},f}}}function h(e,n,r,i){var o=n&&n.prototype instanceof g?n:g,s=Object.create(o.prototype),a=new C(i||[])
...
if(h.arg!==f)return g
r.delegate&&"next"===o&&(s=t)}else"throw"===h.type&&(i=p,o="throw",s=h.arg)}}}(e,r,a),s}function m(e,t,n){try{return{type:"normal",arg:e.call(t,n)}}catch(e){return{type:"throw",arg:e}}}function g(){}function v(){}function y(){}function b(e){["next","throw","return"].forEach(function(t){e[t]=function(e){return this._invoke(t,e)}})}function E(e){this.arg=e}function T(e){function t(n,r,i,o){var s=m(e[n],e,r)
...
var n=[],r=e.document,i=Object.getPrototypeOf,o=n.slice,s=n.concat,a=n.push,l=n.indexOf,u={},c=u.toString,p=u.hasOwnProperty,f=p.toString,d=f.call(Object),h={},m=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},g=function(e){return null!=e&&e===e.window},v={type:!0,src:!0,noModule:!0}
function y(e,t,n){var i,o=(t=t||r).createElement("script")
if(o.text=e,n)for(i in v)n[i]&&(o[i]=n[i])
t.head.appendChild(o).parentNode.removeChild(o)}function b(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?u[c.call(e)]||"object":typeof e}var E=function(e,t){return new E.fn.init(e,t)},T=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g
...
var A=function(e){var t,n,r,i,o,s,a,l,u,c,p,f,d,h,m,g,v,y,b,E="sizzle"+1*new Date,T=e.document,_=0,A=0,C=se(),S=se(),R=se(),w=function(e,t){return e===t&&(p=!0),0},O={}.hasOwnProperty,x=[],N=x.pop,L=x.push,I=x.push,k=x.slice,D=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
return-1},P="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",M="[\\x20\\t\\r\\n\\f]",F="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",B="\\["+M+"*("+F+")(?:"+M+"*([*^$|!~]?=)"+M+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+F+"))|)"+M+"*\\]",j=":("+F+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+B+")*)|.*)\\)|)",H=new RegExp(M+"+","g"),U=new RegExp("^"+M+"+|((?:^|[^\\\\])(?:\\\\.)*)"+M+"+$","g"),$=new RegExp("^"+M+"*,"+M+"*"),W=new RegExp("^"+M+"*([>+~]|"+M+")"+M+"*"),q=new RegExp("="+M+"*([^\\]'\"]*?)"+M+"*\\]","g"),K=new RegExp(j),z=new RegExp("^"+F+"$"),V={ID:new RegExp("^#("+F+")"),CLASS:new RegExp("^\\.("+F+")"),TAG:new RegExp("^("+F+"|[*])"),ATTR:new RegExp("^"+B),PSEUDO:new RegExp("^"+j),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+M+"*(even|odd|(([+-]|)(\\d*)n|)"+M+"*(?:([+-]|)"+M+"*(\\d+)|))"+M+"*\\)|)","i"),bool:new RegExp("^(?:"+P+")$","i"),needsContext:new RegExp("^"+M+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+M+"*((?:-\\d)?\\d*)"+M+"*\\)|)(?=[^-]|$)","i")},G=/^(?:input|select|textarea|button)$/i,Y=/^h\d$/i,Q=/^[^{]+\{\s*\[native \w/,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,J=/[+~]/,Z=new RegExp("\\\\([\\da-f]{1,6}"+M+"?|("+M+")|.)","ig"),ee=function(e,t,n){var r="0x"+t-65536
...
try{I.apply(x=k.call(T.childNodes),T.childNodes),x[T.childNodes.length].nodeType}catch(e){I={apply:x.length?function(e,t){L.apply(e,k.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function oe(e,t,r,i){var o,a,u,c,p,h,v,y=t&&t.ownerDocument,_=t?t.nodeType:9
if(r=r||[],"string"!=typeof e||!e||1!==_&&9!==_&&11!==_)return r
if(!i&&((t?t.ownerDocument||t:T)!==d&&f(t),t=t||d,m)){if(11!==_&&(p=X.exec(e)))if(o=p[1]){if(9===_){if(!(u=t.getElementById(o)))return r
if(u.id===o)return r.push(u),r}else if(y&&(u=y.getElementById(o))&&b(t,u)&&u.id===o)return r.push(u),r}else{if(p[2])return I.apply(r,t.getElementsByTagName(e)),r
if((o=p[3])&&n.getElementsByClassName&&t.getElementsByClassName)return I.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&&!R[e+" "]&&(!g||!g.test(e))){if(1!==_)y=t,v=e
...
v=h.join(","),y=J.test(e)&&me(t.parentNode)||t}if(v)try{return I.apply(r,y.querySelectorAll(v)),r}catch(e){}finally{c===E&&t.removeAttribute("id")}}}return l(e.replace(U,"$1"),t,r,i)}function se(){var e=[]
return function t(n,i){return e.push(n+" ")>r.cacheLength&&delete t[e.shift()],t[n+" "]=i}}function ae(e){return e[E]=!0,e}function le(e){var t=d.createElement("fieldset")
...
return!!t&&"HTML"!==t.nodeName},f=oe.setDocument=function(e){var t,i,s=e?e.ownerDocument||e:T
...
t.setAttribute("type","hidden"),e.appendChild(t).setAttribute("name","D"),e.querySelectorAll("[name=d]").length&&g.push("name"+M+"*[*^$|!~]?="),2!==e.querySelectorAll(":enabled").length&&g.push(":enabled",":disabled"),h.appendChild(e).disabled=!0,2!==e.querySelectorAll(":disabled").length&&g.push(":enabled",":disabled"),e.querySelectorAll("*,:x"),g.push(",.*:")})),(n.matchesSelector=Q.test(y=h.matches||h.webkitMatchesSelector||h.mozMatchesSelector||h.oMatchesSelector||h.msMatchesSelector))&&le(function(e){n.disconnectedMatch=y.call(e,"*"),y.call(e,"[s!='']:x"),v.push("!=",j)}),g=g.length&&new RegExp(g.join("|")),v=v.length&&new RegExp(v.join("|")),t=Q.test(h.compareDocumentPosition),b=t||Q.test(h.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,r=t&&t.parentNode
return e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains(r):e.compareDocumentPosition&&16&e.compareDocumentPosition(r)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0
return!1},w=t?function(e,t){if(e===t)return p=!0,0
var r=!e.compareDocumentPosition-!t.compareDocumentPosition
return r||(1&(r=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1)||!n.sortDetached&&t.compareDocumentPosition(e)===r?e===d||e.ownerDocument===T&&b(T,e)?-1:t===d||t.ownerDocument===T&&b(T,t)?1:c?D(c,e)-D(c,t):0:4&r?-1:1)}:function(e,t){if(e===t)return p=!0,0
...
for(;s[r]===a[r];)r++
return r?ce(s[r],a[r]):s[r]===T?-1:a[r]===T?1:0},d):d},oe.matches=function(e,t){return oe(e,null,null,t)},oe.matchesSelector=function(e,t){if((e.ownerDocument||e)!==d&&f(e),t=t.replace(q,"='$1']"),n.matchesSelector&&m&&!R[t+" "]&&(!v||!v.test(t))&&(!g||!g.test(t)))try{var r=y.call(e,t)
if(r||n.disconnectedMatch||e.document&&11!==e.document.nodeType)return r}catch(e){}return oe(t,d,null,[e]).length>0},oe.contains=function(e,t){return(e.ownerDocument||e)!==d&&f(e),b(e,t)},oe.attr=function(e,t){(e.ownerDocument||e)!==d&&f(e)
...
return 1===r&&0===i?function(e){return!!e.parentNode}:function(t,n,l){var u,c,p,f,d,h,m=o!==s?"nextSibling":"previousSibling",g=t.parentNode,v=a&&t.nodeName.toLowerCase(),y=!l&&!a,b=!1
if(g){if(o){for(;m;){for(f=t;f=f[m];)if(a?f.nodeName.toLowerCase()===v:1===f.nodeType)return!1
h=m="only"===e&&!h&&"nextSibling"}return!0}if(h=[s?g.firstChild:g.lastChild],s&&y){for(b=(d=(u=(c=(p=(f=g)[E]||(f[E]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]||[])[0]===_&&u[1])&&u[2],f=d&&g.childNodes[d];f=++d&&f&&f[m]||(b=d=0)||h.pop();)if(1===f.nodeType&&++b&&f===t){c[e]=[_,d,b]
break}}else if(y&&(b=d=(u=(c=(p=(f=t)[E]||(f[E]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]||[])[0]===_&&u[1]),!1===b)for(;(f=++d&&f&&f[m]||(b=d=0)||h.pop())&&((a?f.nodeName.toLowerCase()!==v:1!==f.nodeType)||!++b||(y&&((c=(p=f[E]||(f[E]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]=[_,b]),f!==t)););return(b-=i)===r||b%r==0&&b/r>=0}}},PSEUDO:function(e,t){var n,i=r.pseudos[e]||r.setFilters[e.toLowerCase()]||oe.error("unsupported pseudo: "+e)
...
return r[E]?ae(function(e,t,n,i){for(var o,s=r(e,null,i,[]),a=e.length;a--;)(o=s[a])&&(e[a]=!(t[a]=o))}):function(e,i,o){return t[0]=e,r(t,null,o,n),t[0]=null,!n.pop()}}),has:ae(function(e){return function(t){return oe(e,t).length>0}}),contains:ae(function(e){return e=e.replace(Z,ee),function(t){return(t.textContent||t.innerText||i(t)).indexOf(e)>-1}}),lang:ae(function(e){return z.test(e||"")||oe.error("unsupported lang: "+e),e=e.replace(Z,ee).toLowerCase(),function(t){var n
...
return!1}:function(t,n,l){var u,c,p,f=[_,a]
...
else{if((u=c[o])&&u[0]===_&&u[1]===a)return f[2]=u[2]
if(c[o]=f,f[2]=e(t,n,l))return!0}return!1}}function be(e){return e.length>1?function(t,n,r){for(var i=e.length;i--;)if(!e[i](t,n,r))return!1
return!0}:e[0]}function Ee(e,t,n,r,i){for(var o,s=[],a=0,l=e.length,u=null!=t;a<l;a++)(o=e[a])&&(n&&!n(o,r,i)||(s.push(o),u&&t.push(a)))
return s}function Te(e,t,n,r,i,o){return r&&!r[E]&&(r=Te(r)),i&&!i[E]&&(i=Te(i,o)),ae(function(o,s,a,l){var u,c,p,f=[],d=[],h=s.length,m=o||function(e,t,n){for(var r=0,i=t.length;r<i;r++)oe(e,t[r],n)
return n}(t||"*",a.nodeType?[a]:a,[]),g=!e||!o&&t?m:Ee(m,f,e,a,l),v=n?i||(o?e:h||r)?[]:s:g
if(n&&n(g,v,a,l),r)for(u=Ee(v,d),r(u,[],a,l),c=u.length;c--;)(p=u[c])&&(v[d[c]]=!(g[d[c]]=p))
if(o){if(i||e){if(i){for(u=[],c=v.length;c--;)(p=v[c])&&u.push(g[c]=p)
i(null,v=[],u,l)}for(c=v.length;c--;)(p=v[c])&&(u=i?D(o,p):f[c])>-1&&(o[u]=!(s[u]=p))}}else v=Ee(v===s?v.splice(h,v.length):v),i?i(null,s,v,l):I.apply(s,v)})}function _e(e){for(var t,n,i,o=e.length,s=r.relative[e[0].type],a=s||r.relative[" "],l=s?1:0,c=ye(function(e){return e===t},a,!0),p=ye(function(e){return D(t,e)>-1},a,!0),f=[function(e,n,r){var i=!s&&(r||n!==u)||((t=n).nodeType?c(e,n,r):p(e,n,r))
return t=null,i}];l<o;l++)if(n=r.relative[e[l].type])f=[ye(be(f),n)]
else{if((n=r.filter[e[l].type].apply(null,e[l].matches))[E]){for(i=++l;i<o&&!r.relative[e[i].type];i++);return Te(l>1&&be(f),l>1&&ve(e.slice(0,l-1).concat({value:" "===e[l-2].type?"*":""})).replace(U,"$1"),n,l<i&&_e(e.slice(l,i)),i<o&&_e(e=e.slice(i)),i<o&&ve(e))}f.push(n)}return be(f)}return ge.prototype=r.filters=r.pseudos,r.setFilters=new ge,s=oe.tokenize=function(e,t){var n,i,o,s,a,l,u,c=S[e+" "]
...
if(!a){for(t||(t=s(e)),n=t.length;n--;)(a=_e(t[n]))[E]?i.push(a):o.push(a);(a=R(e,function(e,t){var n=t.length>0,i=e.length>0,o=function(o,s,a,l,c){var p,h,g,v=0,y="0",b=o&&[],E=[],T=u,A=o||i&&r.find.TAG("*",c),C=_+=null==T?1:Math.random()||.1,S=A.length
for(c&&(u=s===d||s||c);y!==S&&null!=(p=A[y]);y++){if(i&&p){for(h=0,s||p.ownerDocument===d||(f(p),a=!m);g=e[h++];)if(g(p,s||d,a)){l.push(p)
break}c&&(_=C)}n&&((p=!g&&p)&&v--,o&&b.push(p))}if(v+=y,n&&y!==v){for(h=0;g=t[h++];)g(b,E,s,a)
if(o){if(v>0)for(;y--;)b[y]||E[y]||(E[y]=N.call(l))
E=Ee(E)}I.apply(l,E),c&&!o&&E.length>0&&v+t.length>1&&oe.uniqueSort(l)}return c&&(_=C,u=T),b}
return n?ae(o):o}(o,i))).selector=e}return a},l=oe.select=function(e,t,n,i){var o,l,u,c,p,f="function"==typeof e&&e,d=!i&&s(e=f.selector||e)
...
f&&(t=t.parentNode),e=e.slice(l.shift().value.length)}for(o=V.needsContext.test(e)?0:l.length;o--&&(u=l[o],!r.relative[c=u.type]);)if((p=r.find[c])&&(i=p(u.matches[0].replace(Z,ee),J.test(l[0].type)&&me(t.parentNode)||t))){if(l.splice(o,1),!(e=i.length&&ve(l)))return I.apply(n,i),n
break}}return(f||a(e,d))(i,t,!m,n,!t||J.test(e)&&me(t.parentNode)||t),n},n.sortStable=E.split("").sort(w).join("")===E,n.detectDuplicates=!!p,f(),n.sortDetached=le(function(e){return 1&e.compareDocumentPosition(d.createElement("fieldset"))}),le(function(e){return e.innerHTML="<a href='#'></a>","#"===e.firstChild.getAttribute("href")})||ue("type|href|height|width",function(e,t,n){if(!n)return e.getAttribute(t,"type"===t.toLowerCase()?1:2)}),n.attributes&&le(function(e){return e.innerHTML="<input/>",e.firstChild.setAttribute("value",""),""===e.firstChild.getAttribute("value")})||ue("value",function(e,t,n){if(!n&&"input"===e.nodeName.toLowerCase())return e.defaultValue}),le(function(e){return null==e.getAttribute("disabled")})||ue(P,function(e,t,n){var r
...
return i?e:u?t.call(e):l?t(e[0],n):o},W=/^-ms-/,q=/-([a-z])/g
function K(e,t){return t.toUpperCase()}function z(e){return e.replace(W,"ms-").replace(q,K)}var V=function(e){return 1===e.nodeType||9===e.nodeType||!+e.nodeType}
...
if(void 0===e){if(this.length&&(i=Q.get(o),1===o.nodeType&&!Y.get(o,"hasDataAttrs"))){for(n=s.length;n--;)s[n]&&0===(r=s[n].name).indexOf("data-")&&(r=z(r.slice(5)),Z(o,r,i[r]))
...
return n=void 0!==e.getElementsByTagName?e.getElementsByTagName(t||"*"):void 0!==e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&w(e,t)?E.merge([e],n):n}function he(e,t){for(var n=0,r=e.length;n<r;n++)Y.set(e[n],"globalEval",!t||Y.get(t[n],"globalEval"))}fe.optgroup=fe.option,fe.tbody=fe.tfoot=fe.colgroup=fe.caption=fe.thead,fe.th=fe.td
var me,ge,ve=/<|&#?\w+;/
function ye(e,t,n,r,i){for(var o,s,a,l,u,c,p=t.createDocumentFragment(),f=[],d=0,h=e.length;d<h;d++)if((o=e[d])||0===o)if("object"===b(o))E.merge(f,o.nodeType?[o]:o)
else if(ve.test(o)){for(s=s||p.appendChild(t.createElement("div")),a=(ce.exec(o)||["",""])[1].toLowerCase(),l=fe[a]||fe._default,s.innerHTML=l[1]+E.htmlPrefilter(o)+l[2],c=l[0];c--;)s=s.lastChild
E.merge(f,s.childNodes),(s=p.firstChild).textContent=""}else f.push(t.createTextNode(o))
for(p.textContent="",d=0;o=f[d++];)if(r&&E.inArray(o,r)>-1)i&&i.push(o)
else if(u=E.contains(o.ownerDocument,o),s=de(p.appendChild(o),"script"),u&&he(s),n)for(c=0;o=s[c++];)pe.test(o.type||"")&&n.push(o)
...
var be=r.documentElement,Ee=/^key/,Te=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,_e=/^([^.]*)(?:\.(.+)|)/
...
return 1===o&&(s=i,(i=function(e){return E().off(e),s.apply(this,arguments)}).guid=s.guid||(s.guid=E.guid++)),e.each(function(){E.event.add(this,t,i,r,n)})}E.event={global:{},add:function(e,t,n,r,i){var o,s,a,l,u,c,p,f,d,h,m,g=Y.get(e)
if(g)for(n.handler&&(n=(o=n).handler,i=o.selector),i&&E.find.matchesSelector(be,i),n.guid||(n.guid=E.guid++),(l=g.events)||(l=g.events={}),(s=g.handle)||(s=g.handle=function(t){return void 0!==E&&E.event.triggered!==t.type?E.event.dispatch.apply(e,arguments):void 0}),u=(t=(t||"").match(P)||[""]).length;u--;)d=m=(a=_e.exec(t[u])||[])[1],h=(a[2]||"").split(".").sort(),d&&(p=E.event.special[d]||{},d=(i?p.delegateType:p.bindType)||d,p=E.event.special[d]||{},c=E.extend({type:d,origType:m,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&E.expr.match.needsContext.test(i),namespace:h.join(".")},o),(f=l[d])||((f=l[d]=[]).delegateCount=0,p.setup&&!1!==p.setup.call(e,r,h,s)||e.addEventListener&&e.addEventListener(d,s)),p.add&&(p.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),i?f.splice(f.delegateCount++,0,c):f.push(c),E.event.global[d]=!0)},remove:function(e,t,n,r,i){var o,s,a,l,u,c,p,f,d,h,m,g=Y.hasData(e)&&Y.get(e)
if(g&&(l=g.events)){for(u=(t=(t||"").match(P)||[""]).length;u--;)if(d=m=(a=_e.exec(t[u])||[])[1],h=(a[2]||"").split(".").sort(),d){for(p=E.event.special[d]||{},f=l[d=(r?p.delegateType:p.bindType)||d]||[],a=a[2]&&new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=o=f.length;o--;)c=f[o],!i&&m!==c.origType||n&&n.guid!==c.guid||a&&!a.test(c.namespace)||r&&r!==c.selector&&("**"!==r||!c.selector)||(f.splice(o,1),c.selector&&f.delegateCount--,p.remove&&p.remove.call(e,c))
s&&!f.length&&(p.teardown&&!1!==p.teardown.call(e,h,g.handle)||E.removeEvent(e,d,g.handle),delete l[d])}else for(d in l)E.event.remove(e,d+t[u],n,r,!0)
...
var i,o,a,l,u,c,p=0,f=e.length,d=f-1,g=t[0],v=m(g)
if(v||f>1&&"string"==typeof g&&!h.checkClone&&xe.test(g))return e.each(function(i){var o=e.eq(i)
v&&(t[0]=g.call(this,i,o.html())),Pe(o,t,n,r)})
if(f&&(o=(i=ye(t,e[0].ownerDocument,!1,e,r)).firstChild,1===i.childNodes.length&&(i=o),o||r)){for(l=(a=E.map(de(i,"script"),Ie)).length;p<f;p++)u=i,p!==d&&(u=E.clone(u,!0,!0),l&&E.merge(a,de(u,"script"))),n.call(e[p],u,p)
if(l)for(c=a[a.length-1].ownerDocument,E.map(a,ke),p=0;p<l;p++)u=a[p],pe.test(u.type||"")&&!Y.access(u,"globalEval")&&E.contains(c,u)&&(u.src&&"module"!==(u.type||"").toLowerCase()?E._evalUrl&&E._evalUrl(u.src):y(u.textContent.replace(Ne,""),c,u))}return e}function Me(e,t,n){for(var r,i=t?E.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||E.cleanData(de(r)),r.parentNode&&(n&&E.contains(r.ownerDocument,r)&&he(de(r,"script")),r.parentNode.removeChild(r))
...
if(!(h.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||E.isXMLDoc(e)))for(s=de(c),r=0,i=(o=de(e)).length;r<i;r++)a=o[r],l=s[r],void 0,"input"===(u=l.nodeName.toLowerCase())&&ue.test(a.type)?l.checked=a.checked:"input"!==u&&"textarea"!==u||(l.defaultValue=a.defaultValue)
if(t)if(n)for(o=o||de(e),s=s||de(c),r=0,i=o.length;r<i;r++)De(o[r],s[r])
else De(e,c)
return(s=de(c,"script")).length>0&&he(s,!p&&de(e,"script")),c},cleanData:function(e){for(var t,n,r,i=E.event.special,o=0;void 0!==(n=e[o]);o++)if(V(n)){if(t=n[Y.expando]){if(t.events)for(r in t.events)i[r]?E.event.remove(n,r):E.removeEvent(n,r,t.handle)
...
if("string"==typeof e&&!Oe.test(e)&&!fe[(ce.exec(e)||["",""])[1].toLowerCase()]){e=E.htmlPrefilter(e)
...
E.inArray(this,e)<0&&(E.cleanData(de(this)),n&&n.replaceChild(t,this))},e)}}),E.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){E.fn[e]=function(e){for(var n,r=[],i=E(e),o=i.length-1,s=0;s<=o;s++)n=s===o?this:this.clone(!0),E(i[s])[t](n),a.apply(r,n.get())
...
i="1%"!==t.top,l=12===n(t.marginLeft),c.style.right="60%",a=36===n(t.right),o=36===n(t.width),c.style.position="absolute",s=36===c.offsetWidth||"absolute",be.removeChild(u),c=null}}function n(e){return Math.round(parseFloat(e))}var i,o,s,a,l,u=r.createElement("div"),c=r.createElement("div")
...
var $e=/^(none|table(?!-c[ea]).+)/,We=/^--/,qe={position:"absolute",visibility:"hidden",display:"block"},Ke={letterSpacing:"0",fontWeight:"400"},ze=["Webkit","Moz","ms"],Ve=r.createElement("div").style
...
return""===n?"1":n}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{},style:function(e,t,n,r){if(e&&3!==e.nodeType&&8!==e.nodeType&&e.style){var i,o,s,a=z(t),l=We.test(t),u=e.style
if(l||(t=Ge(a)),s=E.cssHooks[t]||E.cssHooks[a],void 0===n)return s&&"get"in s&&void 0!==(i=s.get(e,!1,r))?i:u[t]
"string"===(o=typeof n)&&(i=te.exec(n))&&i[1]&&(n=oe(e,t,i),o="number"),null!=n&&n==n&&("number"===o&&(n+=i&&i[3]||(E.cssNumber[a]?"":"px")),h.clearCloneStyle||""!==n||0!==t.indexOf("background")||(u[t]="inherit"),s&&"set"in s&&void 0===(n=s.set(e,n,r))||(l?u.setProperty(t,n):u[t]=n))}},css:function(e,t,n,r){var i,o,s,a=z(t)
return We.test(t)||(t=Ge(a)),(s=E.cssHooks[t]||E.cssHooks[a])&&"get"in s&&(i=s.get(e,!0,n)),void 0===i&&(i=He(e,t,r)),"normal"===i&&t in Ke&&(i=Ke[t]),""===n||n?(o=parseFloat(i),!0===n||isFinite(o)?o||0:i):i}}),E.each(["height","width"],function(e,t){E.cssHooks[t]={get:function(e,n,r){if(n)return!$e.test(E.css(e,"display"))||e.getClientRects().length&&e.getBoundingClientRect().width?Xe(e,t,r):ie(e,qe,function(){return Xe(e,t,r)})},set:function(e,n,r){var i,o=Be(e),s="border-box"===E.css(e,"boxSizing",!1,o),a=r&&Qe(e,t,r,s,o)
...
for(var n,r=0,i=e.length;r<i;r++)n=e[r],at.tweeners[n]=at.tweeners[n]||[],at.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var r,i,o,s,a,l,u,c,p="width"in t||"height"in t,f=this,d={},h=e.style,m=e.nodeType&&re(e),g=Y.get(e,"fxshow")
for(r in n.queue||(null==(s=E._queueHooks(e,"fx")).unqueued&&(s.unqueued=0,a=s.empty.fire,s.empty.fire=function(){s.unqueued||a()}),s.unqueued++,f.always(function(){f.always(function(){s.unqueued--,E.queue(e,"fx").length||s.empty.fire()})})),t)if(i=t[r],tt.test(i)){if(delete t[r],o=o||"toggle"===i,i===(m?"hide":"show")){if("show"!==i||!g||void 0===g[r])continue
m=!0}d[r]=g&&g[r]||E.style(e,r)}if((l=!E.isEmptyObject(t))||!E.isEmptyObject(d))for(r in p&&1===e.nodeType&&(n.overflow=[h.overflow,h.overflowX,h.overflowY],null==(u=g&&g.display)&&(u=Y.get(e,"display")),"none"===(c=E.css(e,"display"))&&(u?c=u:(le([e],!0),u=e.style.display||u,c=E.css(e,"display"),le([e]))),("inline"===c||"inline-block"===c&&null!=u)&&"none"===E.css(e,"float")&&(l||(f.done(function(){h.display=u}),null==u&&(c=h.display,u="none"===c?"":c)),h.display="inline-block")),n.overflow&&(h.overflow="hidden",f.always(function(){h.overflow=n.overflow[0],h.overflowX=n.overflow[1],h.overflowY=n.overflow[2]})),l=!1,d)l||(g?"hidden"in g&&(m=g.hidden):g=Y.access(e,"fxshow",{display:u}),o&&(g.hidden=!m),m&&le([e],!0),f.done(function(){for(r in m||le([e]),Y.remove(e,"fxshow"),d)E.style(e,r,d[r])})),l=st(m?g[r]:0,r,f),r in g||(g[r]=l.start,m&&(l.end=l.start,l.start=0))}],prefilter:function(e,t){t?at.prefilters.unshift(e):at.prefilters.push(e)}}),E.speed=function(e,t,n){var r=e&&"object"==typeof e?E.extend({},e):{complete:n||!n&&t||m(e)&&e,duration:e,easing:n&&t||t&&!m(t)&&t}
...
function ft(e){return(e.match(P)||[]).join(" ")}function dt(e){return e.getAttribute&&e.getAttribute("class")||""}function ht(e){return Array.isArray(e)?e:"string"==typeof e&&e.match(P)||[]}E.fn.extend({prop:function(e,t){return $(this,E.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[E.propFix[e]||e]})}}),E.extend({prop:function(e,t,n){var r,i,o=e.nodeType
...
if((t=ht(e)).length)for(;n=this[l++];)if(i=dt(n),r=1===n.nodeType&&" "+ft(i)+" "){for(s=0;o=t[s++];)r.indexOf(" "+o+" ")<0&&(r+=o+" ")
i!==(a=ft(r))&&n.setAttribute("class",a)}return this},removeClass:function(e){var t,n,r,i,o,s,a,l=0
if(m(e))return this.each(function(t){E(this).removeClass(e.call(this,t,dt(this)))})
if(!arguments.length)return this.attr("class","")
if((t=ht(e)).length)for(;n=this[l++];)if(i=dt(n),r=1===n.nodeType&&" "+ft(i)+" "){for(s=0;o=t[s++];)for(;r.indexOf(" "+o+" ")>-1;)r=r.replace(" "+o+" "," ")
i!==(a=ft(r))&&n.setAttribute("class",a)}return this},toggleClass:function(e,t){var n=typeof e,r="string"===n||Array.isArray(e)
return"boolean"==typeof t&&r?t?this.addClass(e):this.removeClass(e):m(e)?this.each(function(n){E(this).toggleClass(e.call(this,n,dt(this),t),t)}):this.each(function(){var t,i,o,s
...
return null!=t?t:ft(E.text(e))}},select:{get:function(e){var t,n,r,i=e.options,o=e.selectedIndex,s="select-one"===e.type,a=s?null:[],l=s?o+1:i.length
...
E.extend(E.event,{trigger:function(t,n,i,o){var s,a,l,u,c,f,d,h,v=[i||r],y=p.call(t,"type")?t.type:t,b=p.call(t,"namespace")?t.namespace.split("."):[]
if(a=h=l=i=i||r,3!==i.nodeType&&8!==i.nodeType&&!gt.test(y+E.event.triggered)&&(y.indexOf(".")>-1&&(b=y.split("."),y=b.shift(),b.sort()),c=y.indexOf(":")<0&&"on"+y,(t=t[E.expando]?t:new E.Event(y,"object"==typeof t&&t)).isTrigger=o?2:3,t.namespace=b.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+b.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),n=null==n?[t]:E.makeArray(n,[t]),d=E.event.special[y]||{},o||!d.trigger||!1!==d.trigger.apply(i,n))){if(!o&&!d.noBubble&&!g(i)){for(u=d.delegateType||y,gt.test(u+y)||(a=a.parentNode);a;a=a.parentNode)v.push(a),l=a
l===(i.ownerDocument||r)&&v.push(l.defaultView||l.parentWindow||e)}for(s=0;(a=v[s++])&&!t.isPropagationStopped();)h=a,t.type=s>1?u:d.bindType||y,(f=(Y.get(a,"events")||{})[t.type]&&Y.get(a,"handle"))&&f.apply(a,n),(f=c&&a[c])&&f.apply&&V(a)&&(t.result=f.apply(a,n),!1===t.result&&t.preventDefault())
return t.type=y,o||t.isDefaultPrevented()||d._default&&!1!==d._default.apply(v.pop(),n)||!V(i)||c&&m(i[y])&&!g(i)&&((l=i[c])&&(i[c]=null),E.event.triggered=y,t.isPropagationStopped()&&h.addEventListener(y,vt),i[y](),t.isPropagationStopped()&&h.removeEventListener(y,vt),E.event.triggered=void 0,l&&(i[c]=l)),t.result}},simulate:function(e,t,n){var r=E.extend(new E.Event,n,{type:e,isSimulated:!0})
...
var yt=e.location,bt=Date.now(),Et=/\?/
...
var i,o,s,a,l,u,c,p,f,d,h=E.ajaxSetup({},n),m=h.context||h,g=h.context&&(m.nodeType||m.jquery)?E(m):E.event,v=E.Deferred(),y=E.Callbacks("once memory"),b=h.statusCode||{},T={},_={},A="canceled",C={readyState:0,getResponseHeader:function(e){var t
...
if(v.promise(C),h.url=((t||h.url||yt.href)+"").replace(Lt,yt.protocol+"//"),h.type=n.method||n.type||h.method||h.type,h.dataTypes=(h.dataType||"*").toLowerCase().match(P)||[""],null==h.crossDomain){u=r.createElement("a")
...
for(f in(p=E.event&&h.global)&&0==E.active++&&E.event.trigger("ajaxStart"),h.type=h.type.toUpperCase(),h.hasContent=!Nt.test(h.type),o=h.url.replace(wt,""),h.hasContent?h.data&&h.processData&&0===(h.contentType||"").indexOf("application/x-www-form-urlencoded")&&(h.data=h.data.replace(Rt,"+")):(d=h.url.slice(o.length),h.data&&(h.processData||"string"==typeof h.data)&&(o+=(Et.test(o)?"&":"?")+h.data,delete h.data),!1===h.cache&&(o=o.replace(Ot,"$1"),d=(Et.test(o)?"&":"?")+"_="+bt+++d),h.url=o+d),h.ifModified&&(E.lastModified[o]&&C.setRequestHeader("If-Modified-Since",E.lastModified[o]),E.etag[o]&&C.setRequestHeader("If-None-Match",E.etag[o])),(h.data&&h.hasContent&&!1!==h.contentType||n.contentType)&&C.setRequestHeader("Content-Type",h.contentType),C.setRequestHeader("Accept",h.dataTypes[0]&&h.accepts[h.dataTypes[0]]?h.accepts[h.dataTypes[0]]+("*"!==h.dataTypes[0]?", "+Dt+"; q=0.01":""):h.accepts["*"]),h.headers)C.setRequestHeader(f,h.headers[f])
if(h.beforeSend&&(!1===h.beforeSend.call(m,C,h)||c))return C.abort()
if(A="abort",y.add(h.complete),C.done(h.success),C.fail(h.error),i=Ft(kt,h,n,C)){if(C.readyState=1,p&&g.trigger("ajaxSend",[C,h]),c)return C
...
function S(t,n,r,a){var u,f,d,T,_,A=n
...
var Ut,$t=[],Wt=/(=)\?(?=&|$)|\?\?/
E.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=$t.pop()||E.expando+"_"+bt++
...
return e||be})}}),E.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,t){var n="pageYOffset"===t
...
return E.noConflict=function(t){return e.$===E&&(e.$=Kt),t&&e.jQuery===E&&(e.jQuery=qt),E},t||(e.jQuery=e.$=E),E}),function(){var e,t,n
...
for(var u=a.deps,c=a.callback,p=new Array(u.length),f=0;f<u.length;f++)"exports"===u[f]?p[f]=l:"require"===u[f]?p[f]=t:p[f]=r(u[f],s)
...
return{fullName:e,type:s,fullNameWithoutType:a,dirname:p,name:l,root:u,resolveMethodName:"resolve"+f}},i.prototype.lookupDescription=function(e){var t=this.parseName(e),n=void 0
...
var f=new Array(s.length),d=void 0,h=void 0,m=a()
for(d=0;d<s.length;d++)h=s[d],f[d]=h.before(e,m,u)
return function(){var t=void 0,n=void 0,r=a()
for(t=0;t<s.length;t++)"function"==typeof(n=s[t]).after&&n.after(e,r,u,f[t])
...
return[n,r=r||"asc"]})}(l)
0===d.length?(s=f?"[]":e+".[]",(0,n.addObserver)(this,s,p),c=[[this,s,p]]):c=d.map(function(t){var r=t[0],i=f?"@each."+r:e+".@each."+r
return(0,n.addObserver)(a,i,p),[a,i,p]}),u.set(this,c)
var h=f?this:(0,n.get)(this,e)
return(0,r.isArray)(h)?0===d.length?(0,r.A)(h.slice()):function(e,t){return(0,r.A)(e.slice().sort(function(e,i){var o,s,a,l,u
for(o=0;o<t.length;o++)if(s=t[o],a=s[0],l=s[1],0!==(u=(0,r.compare)((0,n.get)(e,a),(0,n.get)(i,a))))return"desc"===l?-1*u:u
return 0}))}(h,d):(0,r.A)()},{dependentKeys:[t+".[]"],readOnly:!0})
...
function E(e,t){var n,o=function(){if(d)return d
var e=d=new f
...
var A=[]
for(this.getComponentSelf(i.Register.s0),A.push({symbol:0,isBlock:!1}),u=0;u<_.length;u++)switch((c=_[u]).charAt(0)){case"&":if(f=null,"&default"===c)f=l
else if("&inverse"===c)f=E
else{if(c!==p)throw(0,r.unreachable)()
f=n}f?(this.pushYieldableBlock(f),A.push({symbol:u+1,isBlock:!0})):(this.pushYieldableBlock(null),A.push({symbol:u+1,isBlock:!0}))
break
case"@":if(!s)break
d=s[0],h=s[1],m=c,a&&(m=c.slice(1)),-1!==(g=d.indexOf(m))&&(this.expr(h[g]),A.push({symbol:u+1,isBlock:!1}))}for(this.pushRootScope(_.length+1,!!(l||E||n)),v=A.length-1;v>=0;v--)b=(y=A[v]).symbol,y.isBlock?this.setBlock(b):this.setVariable(b)
...
this.blocks=t,this.inlines=n},e.LazyCompiler=N,e.compile=E,e.AbstractCompiler=_,e.debugCompiler=void 0,e.CompilableBlock=b,e.CompilableProgram=y,e.LazyOpcodeBuilder=O,e.EagerOpcodeBuilder=x,e.OpcodeBuilder=w,e.StdOpcodeBuilder=R,e.PartialDefinition=L,e.templateFactory=function(e){var t=e.id,n=e.meta,i=e.block,o=void 0,s=t||"client-"+I++
...
function u(e,t,n){return e|t<<16|n<<30}function c(e,t){return e|t<<30}var p=1048576,f=function(){function e(e){var t,n,r
...
return{handle:this.handle,table:this.table,buffer:t}},e}(),d=function(){function e(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:new i,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new f
this.constants=e,this.heap=t,this._opcode=new l(this.heap)}return e.prototype.opcode=function(e){return this._opcode.offset=e,this._opcode},e}(),h=function(){function e(e,t){this.constants=e,this.heap=t,this._opcode=new l(this.heap)}return e.hydrate=function(t,n,r){var i=new f(t)
...
return r}e.WELL_KNOWN_EMPTY_ARRAY_POSITION=0,e.WriteOnlyConstants=i,e.RuntimeConstants=o,e.Constants=s,e.LazyConstants=a,e.Heap=f,e.WriteOnlyProgram=d,e.RuntimeProgram=h,e.Program=m,e.Opcode=l}),e("@glimmer/reference",["exports","ember-babel","@glimmer/util"],function(e,t,n){"use strict"
...
var d=function(e){function n(){var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:f,r=(0,t.possibleConstructorReturn)(this,e.call(this))
...
l(y)
var b,E=function(){function e(){this.lastRevision=null,this.lastValue=null}return e.prototype.value=function(){var e=this.tag,t=this.lastRevision,n=this.lastValue
...
r!==u&&i.push(r)}return h(i)},e.CachedTag=m,e.UpdatableTag=y,e.CachedReference=E,e.map=function(e,t){return new T(e,t)},e.ReferenceCache=_,e.isModified=function(e){return e!==A}}),e("@glimmer/runtime",["exports","ember-babel","@glimmer/util","@glimmer/reference","@glimmer/vm","@glimmer/low-level"],function(e,t,n,r,i,o){"use strict"
...
e.stack.push(n?d:h)}),s.add(11,function(e,t){var n,r=t.op1,i=new Array(r)
...
function b(e){return!(!e||!e[y])}var E=function(){function e(e,t){this.inner=e,this.args=t,this[y]=!0}return e.prototype.unwrap=function(e){e.realloc(this.offset)
...
return function(e){return S(e)||_(e)||"boolean"==typeof e||"number"==typeof e}(t)?1:(e=t)&&e[y]?0:A(t)?3:function(e){return C(e)&&11===e.nodeType}(t)?4:C(t)?5:1},e}()
...
var f=i.getTag(c);(0,r.isConstTag)(f)||e.updateWith(new k(f,i,c))})
...
var r=null
return b(n)?r=n:"string"==typeof n&&n&&(r=P(this.resolver,n,this.meta)),r=this.curry(r),this.lastValue=n,this.lastDefinition=r,r},e.prototype.get=function(){return p},e.prototype.curry=function(e){var t=this.args
return!t&&b(e)?e:e?new E(e,t):null},e}(),F=function(){function e(e){this.list=e,this.tag=(0,r.combineTagged)(e),this.list=e}return e.prototype.value=function(){var e,t,n=[],r=this.list
...
t.push(n)}),s.add(79,function(e,t){var n,r,i,o,s,a,l,u=t.op1,c=e.stack,p=e.fetchValue(u),f=c.pop(),d=p.definition
b(d)&&(d=function(e,t,n){var r=e.definition=t.unwrap(n),i=r.manager,o=r.state
return e.manager=i,e.capabilities=B(i.getCapabilities(o)),r}(p,d,f))
var h=d,m=h.manager,g=h.state
if(!0===j(p.capabilities,4)){var v=f.blocks.values,y=f.blocks.names,E=m.prepareArgs(g,f)
if(E){for(f.clear(),n=0;n<v.length;n++)c.push(v[n])
for(r=E.positional,i=E.named,o=r.length,s=0;s<o;s++)c.push(r[s])
for(a=Object.keys(i),l=0;l<a.length;l++)c.push(i[a[l]])
f.setup(c,a,y,o,!0)}c.push(f)}else c.push(f)}),s.add(81,function(e,t){var n=t.op1,i=t.op2,o=e.fetchValue(i),s=o.definition,a=o.manager,l=o.capabilities=B(a.getCapabilities(s.state)),u=null
j(l,64)&&(u=e.dynamicScope())
var c=null
j(l,8)&&(c=e.stack.peek())
var p=null
j(l,128)&&(p=e.getSelf())
var f=a.create(e.env,s.state,c,u,p,!!(1&n))
o.state=f
var d=a.getTag(f)
j(l,256)&&!(0,r.isConstTag)(d)&&e.updateWith(new $(d,f,a,u))}),s.add(82,function(e,t){var n=t.op1,r=e.fetchValue(n),i=r.manager,o=r.state,s=i.getDestructor(o)
...
e.stack.push(s.getTagName(o))}),s.add(86,function(e,t){var r=t.op1,i=e.fetchValue(r),o=i.manager,s=i.definition,a=e.constants.resolver,l=e.stack,u=i.state,c=i.capabilities,p=s.state,f=void 0
if(function(e){return!1===j(e,1)}(c))f=o.getLayout(p,a)
else{if(!function(e){return!0===j(e,1)}(c))throw(0,n.unreachable)()
f=o.getDynamicLayout(u,a)}l.push(f.symbolTable),l.push(f.handle)}),s.add(68,function(e,t){var n=t.op1,r=e.stack.pop(),i=e.stack.pop(),o=r.manager,s=B(o.getCapabilities(r.state)),a={definition:r,manager:o,capabilities:s,state:null,handle:i.handle,table:i.symbolTable,lookup:null}
...
function q(e,t){console.info("Use `context`, and `get(<path>)` to debug this template."),t("this")}var K=q,z=function(){function e(e,t,r){var i,o,s,a
...
K(e.getSelf().value(),function(e){return s.get(e).value()})}),s.add(95,function(e,t){var n,r,i,o,s,a,l,u,c,p,f,d,h=t.op1,m=t.op2,g=t.op3,v=e.constants,y=e.constants.resolver,b=e.stack.pop().value(),E=v.getSerializable(h),T=v.getStringArray(m),_=v.getArray(g),A=y.lookupPartial(b,E),C=y.resolve(A).getPartial(),S=C.symbolTable,R=C.handle
...
if(o)for(p=0;p<n.length;p++)f=p+1,void 0!==(d=o[n[p]])&&i.bind(f,d)
...
return new Y(i,l,a)}var fe=ce
fe=ne(ae,fe)
var de=fe=te(ae,fe,re),he=le.DOMTreeConstruction,me=["javascript:","vbscript:"],ge=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],ve=["EMBED"],ye=["href","src","background","action"],be=["src"]
function Ee(e,t){return-1!==e.indexOf(t)}function Te(e,t){return(null===e||Ee(ge,e))&&Ee(ye,t)}function _e(e,t){return null!==e&&(Ee(ve,e)&&Ee(be,t))}function Ae(e,t){return Te(e,t)||_e(e,t)}function Ce(e,t,n,r){var i,o=null
if(null==r)return r
...
for(l=0;l<y.length;l++)u=y[l],c=b[l],u.update(c)},e}(),je=function(){function e(e){var t=e.appendOperations,n=e.updateOperations
...
case 25:return this.returnTo(e.op1)}},e.prototype.evaluateSyscall=function(e,t){s.evaluate(t,e,e.type)},e}(),$e=function(){function e(e){this.node=e}return e.prototype.firstNode=function(){return this.node},e}(),We=function(){function e(e){this.node=e}return e.prototype.lastNode=function(){return this.node},e}(),qe=function(){function e(e,t,r){this.constructing=null,this.operations=null,this.cursorStack=new n.Stack,this.blockStack=new n.Stack,this.pushElement(t,r),this.env=e,this.dom=e.getAppendOperations(),this.updateOperations=e.getDOM()}return e.forInitialRender=function(e,t){var n=new this(e,t.element,t.nextSibling)
return n.pushSimpleBlock(),n},e.resume=function(e,t,n){var r=new this(e,t.parentElement(),n)
return r.pushSimpleBlock(),r.pushBlockTracker(t),r},e.prototype.expectConstructing=function(){return this.constructing},e.prototype.block=function(){return this.blockStack.current},e.prototype.popElement=function(){this.cursorStack.pop(),this.cursorStack.current},e.prototype.pushSimpleBlock=function(){return this.pushBlockTracker(new Ke(this.element))},e.prototype.pushUpdatableBlock=function(){return this.pushBlockTracker(new Ve(this.element))},e.prototype.pushBlockList=function(e){return this.pushBlockTracker(new Ge(this.element,e))},e.prototype.pushBlockTracker=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=this.blockStack.current
...
return o.set(this,t,this.env),o},(0,t.createClass)(e,[{key:"element",get:function(){return this.cursorStack.current.element}},{key:"nextSibling",get:function(){return this.cursorStack.current.nextSibling}}]),e}(),Ke=function(){function e(e){this.parent=e,this.first=null,this.last=null,this.destroyables=null,this.nesting=0}return e.prototype.destroy=function(){var e,t=this.destroyables
if(t&&t.length)for(e=0;e<t.length;e++)t[e].destroy()},e.prototype.parentElement=function(){return this.parent},e.prototype.firstNode=function(){return this.first&&this.first.firstNode()},e.prototype.lastNode=function(){return this.last&&this.last.lastNode()},e.prototype.openElement=function(e){this.didAppendNode(e),this.nesting++},e.prototype.closeElement=function(){this.nesting--},e.prototype.didAppendNode=function(e){0===this.nesting&&(this.first||(this.first=new $e(e)),this.last=new We(e))},e.prototype.didAppendBounds=function(e){0===this.nesting&&(this.first||(this.first=e),this.last=e)},e.prototype.newDestroyable=function(e){this.destroyables=this.destroyables||[],this.destroyables.push(e)},e.prototype.finalize=function(e){this.first||e.appendComment("")},e}(),ze=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.destroy=function(){e.prototype.destroy.call(this),ee(this)},n}(Ke),Ve=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.reset=function(e){var t,n=this.destroyables
if(n&&n.length)for(t=0;t<n.length;t++)e.didDestroy(n[t])
var r=ee(this)
return this.first=null,this.last=null,this.destroyables=null,this.nesting=0,r},n}(Ke),Ge=function(){function e(e,t){this.parent=e,this.boundList=t,this.parent=e,this.boundList=t}return e.prototype.destroy=function(){this.boundList.forEachNode(function(e){return e.destroy()})},e.prototype.parentElement=function(){return this.parent},e.prototype.firstNode=function(){var e=this.boundList.head()
...
i.clear()
var u=qe.resume(l.env,r,r.reset(l.env)),c=gt.resume(t,l,u),p=new n.LinkedList
...
var c=s.vmForInsertion(l),p=null,f=s.start
c.execute(f,function(i){o[e]=p=i.iterate(r,t),i.updatingOpcodeStack.push(new n.LinkedList),i.updateWith(p),i.updatingOpcodeStack.push(p.children)}),a.insertBefore(p,u),this.didInsert=!0},e.prototype.retain=function(){},e.prototype.move=function(e,t,n,r){var i=this.map,o=this.updating,s=i[e],a=i[r]||null
...
return-1===t?null:[this.values[3*t+2],this.values[3*t+1],this.values[3*t]]},e}(),dt=new ct(r.CONSTANT_TAG,n.EMPTY_ARRAY,n.EMPTY_ARRAY),ht=new lt(r.CONSTANT_TAG,n.EMPTY_ARRAY),mt={tag:r.CONSTANT_TAG,length:0,positional:ht,named:dt},gt=function(){function e(e,t,r,i){var o=this
...
return new vt(s)},e.NULL_REFERENCE=f,e.UNDEFINED_REFERENCE=p,e.PrimitiveReference=l,e.ConditionalReference=m,e.setDebuggerCallback=function(e){K=e},e.resetDebuggerCallback=function(){K=q},e.getDynamicVar=function(e,t){var n=e.dynamicScope(),r=t.positional.at(0)
return new yt(n,r)},e.LowLevelVM=gt,e.UpdatingVM=Ze,e.RenderResult=ot,e.SimpleDynamicAttribute=Ne,e.DynamicAttribute=xe,e.EMPTY_ARGS=mt,e.Scope=Fe,e.Environment=je,e.DefaultEnvironment=He,e.DEFAULT_CAPABILITIES={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!1,elementHook:!1,dynamicScope:!0,createCaller:!1,updateHook:!0,createInstance:!0},e.MINIMAL_CAPABILITIES={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,dynamicScope:!1,createCaller:!1,updateHook:!1,createInstance:!1},e.CurriedComponentDefinition=E,e.isCurriedComponentDefinition=b,e.curry=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
return new E(e,t)},e.DOMChanges=de,e.SVG_NAMESPACE=re,e.IDOMChanges=ce,e.DOMTreeConstruction=he,e.isWhitespace=function(e){return se.test(e)},e.insertHTMLBefore=pe,e.normalizeProperty=Se,e.NewElementBuilder=qe
e.clientBuilder=function(e,t){return qe.forInitialRender(e,t)},e.rehydrationBuilder=function(e,t){return Et.forInitialRender(e,t)},e.RehydrateBuilder=Et,e.ConcreteBounds=Y,e.Cursor=G,e.capabilityFlagsFrom=B,e.hasCapability=j}),e("@glimmer/util",["exports","ember-babel"],function(e,t){"use strict"
...
function f(e){for(var t=e(),n=t.next();!1===n.done;)n.value(),n=t.next()}var d=function(){},h=Object.freeze([])
function m(){var e,t,n,r,i,o,s=arguments.length,a=void 0,l=void 0,u=void 0
...
return 2===arguments.length?(n=arguments[0],o=arguments[1],t=null):(t=(e=m.apply(void 0,arguments))[0],n=e[1],void 0===(i=e[2])?o=0:s(o=i.pop())||(r=!0===o,o=i.pop())),[t,n,i,o=parseInt(o,10),r]}var v=0,y=0,b=0,E=0,T=0,_=0,A=0,C=0,S=0,R=0,w=0,O=0,x=0,N=0,L=0,I=0,k=0,D=0,P=0,M=0,F=0,B=function(){function e(e,t){var n=this
this.DEBUG=!1,this.currentInstance=null,this.instanceStack=[],this._eventCallbacks={end:[],begin:[]},this._timerTimeoutId=null,this._timers=[],this._autorun=null,this.queueNames=e,this.options=t||{},"string"==typeof this.options.defaultQueue?this._defaultQueue=this.options.defaultQueue:this._defaultQueue=this.queueNames[0],this._onBegin=this.options.onBegin||d,this._onEnd=this.options.onEnd||d,this._boundRunExpiredTimers=this._runExpiredTimers.bind(this),this._boundAutorunEnd=function(){P++,null!==n._autorun&&(n._autorun=null,n._end(!0))}
...
if(!i)throw new TypeError("Cannot off() callback that does not exist")},e.prototype.run=function(){T++
var e=m.apply(void 0,arguments),t=e[0],n=e[1],r=e[2]
return this._run(t,n,r)},e.prototype.join=function(){_++
var e=m.apply(void 0,arguments),t=e[0],n=e[1],r=e[2]
...
var t,n,r,i=m.apply(void 0,n),o=i[0],s=i[1],a=i[2],l=this.DEBUG?new Error:void 0
...
return this.scheduleOnce.apply(this,[e,t,n].concat(i))},e.prototype.scheduleOnce=function(e){for(w++,t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
var t,n,r,i=m.apply(void 0,n),o=i[0],s=i[1],a=i[2],l=this.DEBUG?new Error:void 0
return this._ensureInstance().schedule(e,o,s,a,!0,l)},e.prototype.setTimeout=function(){return O++,this.later.apply(this,arguments)},e.prototype.later=function(){x++
...
var e,t=g.apply(void 0,arguments),n=t[0],r=t[1],i=t[2],o=t[3],s=t[4],a=void 0===s||s,l=u(n,r,this._timers),c=void 0
return-1===l?(c=this._later(n,r,a?h:i,o),a&&this._join(n,r,i)):(c=this._timers[l+1],e=l+4,this._timers[e]!==h&&(this._timers[e]=i)),c},e.prototype.debounce=function(){L++
var e,t,n=g.apply(void 0,arguments),r=n[0],i=n[1],o=n[2],s=n[3],a=n[4],l=void 0!==a&&a,c=u(r,i,this._timers),p=void 0
return-1===c?(p=this._later(r,i,l?h:o,s),l&&this._join(r,i,o)):(e=this._platform.now()+s||this._timers[c],this._timers[c]=e,t=c+4,this._timers[t]!==h&&(this._timers[t]=o),p=this._timers[c+1],0===c&&this._reinstallTimerTimeout()),p},e.prototype.cancelTimers=function(){I++,this._clearTimerTimeout(),this._timers=[],this._cancelAutorun()},e.prototype.hasTimers=function(){return this._timers.length>0||null!==this._autorun},e.prototype.cancel=function(e){if(k++,null==e)return!1
var t=typeof e
...
if(void 0!==i)for(r=0;r<i.length;r++)i[r](t,n)},e.prototype._runExpiredTimers=function(){this._timerTimeoutId=null,this._timers.length>0&&(this.begin(),this._scheduleExpiredTimers(),this.end())},e.prototype._scheduleExpiredTimers=function(){for(var e,t,n,r,i=this._timers,o=0,s=i.length,a=this._defaultQueue,l=this._platform.now();o<s&&!(i[o]>l);o+=6)(e=i[o+4])!==h&&(t=i[o+2],n=i[o+3],r=i[o+5],this.currentInstance.schedule(a,t,n,e,!1,r))
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:y,end:b,events:{begin:E,end:0},autoruns:{created:D,completed:P},run:T,join:_,defer:A,schedule:C,scheduleIterable:S,deferOnce:R,scheduleOnce:w,setTimeout:O,later:x,throttle:N,debounce:L,cancelTimers:I,cancel:k,loops:{total:M,nested:F}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
...
return e.factoryManagerCache[t]=o,o}}function f(e,t,n){var r,i,o,s,a,u=n.injections
for(void 0===u&&(u=n.injections={}),r=0;r<t.length;r++)o=(i=t[r]).property,s=i.specifier,a=i.source,u[o]=a?c(e,s,{source:a}):c(e,s),n.isDynamic||(n.isDynamic=!l(e,s))}function d(e,t){var n=e.registry,r=t.split(":")[0]
return function(e,t,n){var r={injections:void 0,isDynamic:!1}
return void 0!==t&&f(e,t,r),void 0!==n&&f(e,n,r),r}(e,n.getTypeInjections(r),n.getInjections(t))}function h(e){var t,n,r=e.cache,i=Object.keys(r)
...
return null!==this.fallback&&(a=this.fallback.knownForType(e)),null!==this.resolver&&this.resolver.knownForType&&(l=this.resolver.knownForType(e)),(0,n.assign)({},a,o,l)},e.prototype.isValidFullName=function(e){return y.test(e)},e.prototype.getInjections=function(e){var t,n=this._injections[e]
...
e.Registry=b,e.privatize=function(e){var t=e[0],n=E[t]
if(n)return n
...
function p(e){n([e])}var f=u.map(function(e){return a.push(s.observeRecord(e,p)),s.wrapRecord(e)}),d={didChange:function(e,n,o,l){var u,c,f
for(u=n;u<n+l;u++)c=(0,r.objectAt)(e,u),f=s.wrapRecord(c),a.push(s.observeRecord(c,p)),t([f])
o&&i(n,o)},willChange:function(){return this}}
return(0,r.addArrayObserver)(u,this,d),c=function(){a.forEach(function(e){return e()}),(0,r.removeArrayObserver)(u,s,d),s.releaseMethods.removeObject(c)},t(f),this.releaseMethods.pushObject(c),c},willDestroy:function(){this._super.apply(this,arguments),this.releaseMethods.forEach(function(e){return e()})},detect:function(){return!1},columnsForType:function(){return(0,o.A)()},observeModelType:function(e,t){var i=this,o=this._nameToClass(e),s=this.getRecords(o,e)
...
function $(e){return new U(e)}function W(e){return(0,l.isArray)(e)?0!==e.length:!!e}var q=(0,u.symbol)("UPDATE"),K=(0,u.symbol)("INVOKE"),z=(0,u.symbol)("ACTION"),V=function(){function e(){}return e.prototype.get=function(e){return Q.create(this,e)},e}(),G=function(e){function t(){var t=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return n.inner=t,n}return(0,i.inherits)(t,e),t.prototype.compute=function(){return this.inner.value()},t.prototype.get=function(e){return this.inner.get(e)},(0,i.createClass)(t,[{key:"tag",get:function(){return this.inner.tag}},{key:K,get:function(){return this.inner[K]}}]),t}(G)
function se(e,t){var n,r=e
for(n=0;n<t.length;n++)r=r.get(t[n])
return r}function ae(e){var n=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
return null!==e&&"object"==typeof e?n?new Y(e):new ie(e):"function"==typeof e?new ie(e):t.PrimitiveReference.create(e)}var le=(0,u.symbol)("DIRTY_TAG"),ue=(0,u.symbol)("ARGS"),ce=(0,u.symbol)("ROOT_REF"),pe=(0,u.symbol)("IS_DISPATCHING_ATTRS"),fe=(0,u.symbol)("HAS_BLOCK"),de=(0,u.symbol)("BOUNDS"),he=f.CoreView.extend(f.ChildViewsSupport,f.ViewStateSupport,f.ClassNamesSupport,l.TargetActionSupport,f.ActionSupport,f.ViewMixin,((L={isComponent:!0,init:function(){this._super.apply(this,arguments),this[pe]=!1,this[le]=a.DirtyableTag.create(),this[ce]=new Y(this),this[de]=null},rerender:function(){this[le].inner.dirty(),this._super()}})[c.PROPERTY_DID_CHANGE]=function(e){if(!this[pe]){var t=this[ue],n=void 0!==t?t[e]:void 0
void 0!==n&&void 0!==n[q]&&n[q]((0,c.get)(this,e))}},L.getAttr=function(e){return this.get(e)},L.readDOMAttr=function(e){var n=(0,f.getViewElement)(this),r=n.namespaceURI===t.SVG_NAMESPACE,i=(0,t.normalizeProperty)(n,e),o=i.type,s=i.normalized
...
var be=he.extend(f.TextSupport,{classNames:["ember-text-area"],layout:me,tagName:"textarea",attributeBindings:["rows","cols","name","selectionEnd","selectionStart","autocomplete","wrap","lang","dir","value"],rows:null,cols:null})
...
return void 0===s?(t[o]=0,o):(t[o]=++s,o+"be277757-bbbe-4620-9fcb-213ef433cca2"+s)}}var We=function(){function e(e){this.string=e}return e.prototype.toString=function(){return""+this.string},e.prototype.toHTML=function(){return this.toString()},e}(),qe={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},Ke=/[&<>"'`=]/,ze=/[&<>"'`=]/g
function Ve(e){return qe[e]}function Ge(e){return null==e?e="":"string"!=typeof e&&(e=""+e),new We(e)}function Ye(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}var Qe=void 0,Xe=void 0
...
if(-1!==a){if(t=s[a],!Array.isArray(t))return;(n=t[0])!==E.Ops.Get&&n!==E.Ops.MaybeLocal||(i=(r=t[t.length-1])[r.length-1],s[a]=[E.Ops.Helper,"-class",[t,i],null])}}}var ft={parse:function(e){var t=e.indexOf(":")
...
"style"===a&&(u=new ht(u,ut(n,"isVisible"))),i.setAttribute(a,u,!1,null)}},dt=Ge("display: none;"),ht=function(e){function t(t,n){var r=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return!1!==this.isVisible.value()?t:t?(e=t+" display: none;",Ye(t)?Ge(e):e):dt},t}(a.CachedReference),mt={install:function(e,t,n){n.setAttribute("style",(0,a.map)(ut(t,"isVisible"),this.mapStyleValue),!1,null)},mapStyleValue:function(e){return!1===e?dt:null}},gt=function(e,n,r,i){var o,s,a,l,u=r.split(":"),c=u[0],p=u[1],f=u[2]
""===c?i.setAttribute("class",t.PrimitiveReference.create(p),!0,null):(s=(o=c.indexOf(".")>-1)?c.split("."):[],a=o?ct(n,s):ut(n,c),l=void 0,l=void 0===p?new vt(a,o?s[s.length-1]:c):new yt(a,p,f),i.setAttribute("class",l,!1,null))},vt=function(e){function t(t,n){var r=(0,i.possibleConstructorReturn)(this,e.call(this))
...
function bt(e){var t,n,r,i,o=e.names,s=e.value(),a=Object.create(null),l=Object.create(null)
for(a[ue]=l,t=0;t<o.length;t++)n=o[t],r=e.get(n),"function"==typeof(i=s[n])&&i[z]?s[n]=i:r[q]&&(s[n]=new Tt(r,i)),l[n]=r,a[n]=i
return a.attrs=s,a}var Et=(0,u.symbol)("REF"),Tt=function(){function e(e,t){this[f.MUTABLE_CELL]=!0,this[Et]=e,this.value=t}return e.prototype.update=function(e){this[Et][q](e)},e}()
...
if(i=Math.min(s.length,t.positional.length),a={},(0,v.assign)(a,t.named.capture().map),T.POSITIONAL_PARAM_CONFLICT)for(o=0;o<i;o++)a[s[o]]=t.positional.at(o)}return{positional:n.EMPTY_ARRAY,named:a}},r.prototype.create=function(e,t,n,r,i,o){var s=r.view,a=t.ComponentClass,l=n.named.capture(),u=bt(l);(function(e,t){e.named.has("id")&&(t.elementId=t.id)})(n,u),u.parentView=s,u[fe]=o,u._targetObject=i.value(),t.template&&(u.layout=t.template)
var c=a.create(u),p=(0,h._instrumentStart)("render.component",Ct,c)
r.view=c,null!=s&&(0,f.addChildView)(s,c),!0===y.ENV._ENABLE_DID_INIT_ATTRS_SUPPORT&&c.trigger("didInitAttrs"),c.trigger("didReceiveAttrs")
var d=""!==c.tagName
d||(e.isInteractive&&c.trigger("willRender"),c._transitionTo("hasElement"),e.isInteractive&&c.trigger("willInsertElement"))
var m=new lt(e,c,l,p,d)
return n.named.has("class")&&(m.classRef=n.named.get("class")),e.isInteractive&&d&&c.trigger("willRender"),m},r.prototype.getSelf=function(e){return e.component[ce]},r.prototype.didCreateElement=function(e,n,r){var i,o,s=e.component,a=e.classRef,l=e.environment;(0,f.setViewElement)(s,n)
var c=s.attributeBindings,p=s.classNames,d=s.classNameBindings
c&&c.length?function(e,n,r,i){for(var o,s,a,l,c=[],p=n.length-1;-1!==p;)o=n[p],a=(s=ft.parse(o))[1],-1===c.indexOf(a)&&(c.push(a),ft.install(e,r,s,i)),p--;-1===c.indexOf("id")&&(l=r.elementId?r.elementId:(0,u.guidFor)(r),i.setAttribute("id",t.PrimitiveReference.create(l),!1,null)),-1===c.indexOf("style")&&mt.install(e,r,i)}(n,c,s,r):(i=s.elementId?s.elementId:(0,u.guidFor)(s),r.setAttribute("id",t.PrimitiveReference.create(i),!1,null),mt.install(n,s,r)),a&&(o=new vt(a,a._propertyKey),r.setAttribute("class",o,!1,null)),p&&p.length&&p.forEach(function(e){r.setAttribute("class",t.PrimitiveReference.create(e),!1,null)}),d&&d.length&&d.forEach(function(e){gt(n,s,e,r)}),r.setAttribute("class",t.PrimitiveReference.create("ember-view"),!1,null),"ariaRole"in s&&r.setAttribute("role",ut(s,"ariaRole"),!1,null),s._transitionTo("hasElement"),l.isInteractive&&s.trigger("willInsertElement")},r.prototype.didRenderLayout=function(e,t){e.component[de]=t,e.finalize()},r.prototype.getTag=function(e){var t=e.args,n=e.component
...
function Ct(e){return e.instrumentDetails({initialRender:!0})}function St(e){return e.instrumentDetails({initialRender:!1})}var Rt={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},wt=new At,Ot=function(e,t,n,r,i){this.name=e,this.ComponentClass=t,this.handle=n,this.manager=wt
var o=r&&r.asLayout(),s=o?o.symbolTable:void 0
this.symbolTable=s,this.template=r,this.args=i,this.state={name:e,ComponentClass:t,handle:n,template:r,capabilities:Rt,symbolTable:s}},xt=function(e){function t(t){var n=(0,i.possibleConstructorReturn)(this,e.call(this))
...
var d=l.result=f.value
l.render=function(){return d.rerender(u)}}}return e.prototype.isFor=function(e){return this.root===e},e.prototype.destroy=function(){var e,t=this.result,n=this.env
...
var jt=function(){function e(e,n){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:f.fallbackViewRegistry,i=arguments.length>3&&void 0!==arguments[3]&&arguments[3],o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:t.clientBuilder
...
return new Y(r)},t.prototype.getDestructor=function(e){return Vt(e.delegate)?e:null},t.prototype.getCapabilities=function(){return Kt},t.prototype.getTag=function(e){return e.args.tag},t.prototype.didRenderLayout=function(){},t.prototype.getLayout=function(e){return{handle:e.template.asLayout().compile(),symbolTable:e.symbolTable}},t}(tt)),Qt=function(){function e(e,t,n){this.delegate=e,this.component=t,this.args=n}return e.prototype.destroy=function(){var e=this.delegate,t=this.component
Vt(e)&&e.destroyComponent(t)},e}(),Xt=function(e,t,n,r){this.name=e,this.ComponentClass=t,this.delegate=n,this.template=r,this.manager=Yt
...
return new We(t.value())}function rn(e){return"checkbox"===e.positional.at(0).value()?"-checkbox":"-text-field"}function on(e){var t=e.positional,n=t.at(0).value().split("."),r=n[n.length-1],i=t.at(1).value()
return!0===i?(0,b.dasherize)(r):i||0===i?String(i):""}function sn(e){return e}function an(e,t,n,r,i){var o,s=void 0,a=void 0
return"function"==typeof n[K]?(s=n,a=n[K]):"string"===(o=typeof n)?(s=t,a=t.actions&&t.actions[n]):"function"===o&&(s=e,a=n),function(){for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
var e,t,n,i={target:s,args:t,label:"@glimmer/closure-action"}
return(0,h.flaggedInstrument)("interaction.ember-action",i,function(){return A.join.apply(void 0,[s,a].concat(r(t)))})}}var ln=function(e){return function(e){return null==e||"function"!=typeof e.toString}(e)?"":String(e)}
...
return r!==e&&(t=cn(this.sourceReference,r),n.inner.update(t.tag),this.innerReference=t,this.lastPath=r),t.value()},n.prototype[q]=function(e){(0,c.set)(this.sourceReference.value(),this.pathReference.value(),e)},n}(G),fn=function(e){function t(t,n,r){var o=(0,i.possibleConstructorReturn)(this,e.call(this))
...
function dn(e){var t,n=e.positional;(t=console).log.apply(t,n.value())}var hn=(0,u.symbol)("MUT"),mn=(0,u.symbol)("SOURCE")
function gn(e){e.positional
var t=e.named
return new S.QueryParams((0,v.assign)({},t.value()))}var vn=["alt","shift","meta","ctrl"],yn=/^click|mouse|touch/
f.ActionManager.registeredActions
var bn=function(e){var t=e.actionId
return f.ActionManager.registeredActions[t]=e,t},En=function(e){var t=e.actionId
delete f.ActionManager.registeredActions[t]},Tn=function(){function e(e,t,n,r,i,o,s,a,l){this.element=e,this.actionId=t,this.actionName=n,this.actionArgs=r,this.namedArgs=i,this.positional=o,this.implicitTarget=s,this.dom=a,this.eventName=this.getEventName(),this.tag=l}return e.prototype.getEventName=function(){return this.namedArgs.get("on").value()||"click"},e.prototype.getActionArgs=function(){var e,t=new Array(this.actionArgs.length)
...
if(null==t){if(yn.test(e.type))return(0,f.isSimpleClick)(e)
...
"function"!=typeof n[K]?"function"!=typeof n?(r.name=n,a.send?(0,h.flaggedInstrument)("interaction.ember-action",r,function(){a.send.apply(a,[n].concat(e))}):(0,h.flaggedInstrument)("interaction.ember-action",r,function(){a[n].apply(a,e)})):(0,h.flaggedInstrument)("interaction.ember-action",r,function(){n.apply(a,e)}):(0,h.flaggedInstrument)("interaction.ember-action",r,function(){n[K].apply(n,e)})}),l)},e.prototype.destroy=function(){En(this)},e}(),_n=function(){function e(){}return e.prototype.create=function(e,t,n,r){var i,o=t.capture(),s=o.named,a=o.positional,l=o.tag,c=void 0,p=void 0,f=void 0
a.length>1&&(c=a.at(0),(f=a.at(1))[K]?p=f:(f._propertyKey,p=f.value()))
var d=[]
for(i=2;i<a.length;i++)d.push(a.at(i))
var h=(0,u.uuid)()
return new Tn(e,h,p,d,s,a,c,r,l)},e.prototype.install=function(e){var t=e.dom,n=e.element,r=e.actionId
...
function An(e){return null===e?null:[e[0].map(function(e){return"@"+e}),e[1]]}function Cn(e,t,n,r){var i=r.compiler.resolver.lookupComponentDefinition("-text-area",r.referrer)
return pt(n),r.component.static(i,[t||[],An(n),null,null]),!0}function Sn(e,t,n,r){var i=r.compiler.resolver.lookupComponentDefinition(e,r.referrer)
return r.component.static(i,[t,An(n),null,null]),!0}function Rn(e,t,n,r){var i,o,s,a,l
...
r.tag.validate(i)||(t=r.value(),e.modelRev=r.tag.value(),n.set("model",t))},t}(tt)),Nn=function(e,t){this.manager=xn,this.state={name:e,modelRef:t}}
function Ln(e,t,n,r){var i=[E.Ops.Helper,"-mount",t||[],n]
...
return"string"==typeof i?this._lastName===i?this._lastDef:e.owner.hasRegistration("engine:"+i)?(this._lastName=i,this._lastDef=(0,t.curry)(new Nn(i,r)),this._lastDef):null:(this._lastDef=null,this._lastName=null,null)},e.prototype.get=function(){return t.UNDEFINED_REFERENCE},e}(),kn=function(){function e(e){this.outletState=e,this.tag=a.DirtyableTag.create()}return e.prototype.get=function(e){return new Pn(this,e)},e.prototype.value=function(){return this.outletState},e.prototype.update=function(e){this.outletState.outlets.main=e,this.tag.inner.dirty()},e}(),Dn=function(){function e(e,t){this.parentStateRef=e,this.outletNameRef=t,this.tag=(0,a.combine)([e.tag,t.tag])}return e.prototype.value=function(){var e=this.parentStateRef.value(),t=void 0===e?void 0:e.outlets
return void 0===t?void 0:t[this.outletNameRef.value()]},e.prototype.get=function(e){return new Pn(this,e)},e}(),Pn=function(){function e(e,t){this.parent=e,this.key=t,this.tag=e.tag}return e.prototype.get=function(t){return new e(this,t)},e.prototype.value=function(){var e=this.parent.value()
...
return i[r.render.outlet]=r,r.wasUsed=!0,{outlets:i,render:void 0}}}},e.prototype.get=function(e){return new Pn(this,e)},e}()
function Fn(e,t,n,r){var i=[E.Ops.Helper,"-outlet",t||[],n]
...
var jn=void 0,Hn=void 0,Un=void 0
...
t.set("model",n.value())},t.prototype.getCapabilities=function(){return x},t.prototype.getTag=function(e){return e.model.tag},t.prototype.getDestructor=function(e){return e.controller},t}(R),jn=new N,Un=function(e,t,n){this.manager=n,this.state={name:e,template:t}})
var $n=void 0
T.RENDER_HELPER&&($n=function(e,n){var r,i,o,s=e.env,a=n.positional.at(0),l=a.value(),u=s.owner.lookup("template:"+l),c=void 0
return c=n.named.has("controller")?n.named.get("controller").value():l,1===n.positional.length?(r=new Un(c,u,Hn),ie.create((0,t.curry)(r))):(i=new Un(c,u,jn),o=n.capture(),ie.create((0,t.curry)(i,o)))})
var Wn=void 0
function qn(e,t,n,r){if(-1===e.indexOf("-"))return!1
var i=r.compiler.resolver.lookupComponentDefinition(e,r.referrer)
return null!==i&&(r.component.static(i,[null===t?[]:t,An(n),null,null]),!0)}function Kn(e,t,n,r,i,o){if(-1===e.indexOf("-"))return!1
var s=o.compiler.resolver.lookupComponentDefinition(e,o.referrer)
return null!==s&&(pt(n),o.component.static(s,[t,An(n),r,i]),!0)}T.RENDER_HELPER&&(Wn=function(e,t,n,r){var i
return!(!T.RENDER_HELPER||!0!==y.ENV._ENABLE_RENDER_SUPPORT)&&(i=[E.Ops.Helper,"-render",t||[],n],r.dynamicComponent(i,null,null,null,!1,null,null),!0)})
var zn=[]
var Vn=Object.getPrototypeOf,Gn=new WeakMap
function Yn(e){for(var t=e;null!=t;){if(Gn.has(t))return Gn.get(t)
t=Vn(t)}}function Qn(e){return{object:"component:"+e}}function Xn(e,t){return{source:void 0!==e?"template:"+e:void 0,namespace:t}}var Jn={if:function(e,t){var n=t.positional
return fn.create(n.at(0),n.at(1),n.at(2))},action:function(e,t){var n=t.named,r=t.positional.capture().references,i=r[0],o=r[1],s=r.slice(2),l=(o._propertyKey,n.has("target")?n.get("target"):i),u=function(e,t){var n=void 0
...
return(p="function"==typeof o[K]?an(o,o,o[K],u):(0,a.isConst)(l)&&(0,a.isConst)(o)?an(i.value(),l.value(),o.value(),u):function(e,t,n,r,i){return function(){return an(e,t.value(),n.value(),r).apply(void 0,arguments)}}(i.value(),l,o,u))[z]=!0,new ie(p)},concat:function(e,t){return new re(un,t.capture())},get:function(e,t){return pn.create(t.positional.at(0),t.positional.at(1))},hash:function(e,t){return t.named.capture()},log:function(e,t){return new re(dn,t.capture())},mut:function(e,t){var n,r=t.positional.at(0)
if((n=r)&&n[hn])return r
var i=Object.create(r)
return i[mn]=r,i[K]=r[q],i[hn]=!0,i},"query-params":function(e,t){return new re(gn,t.capture())},readonly:function(e,t){var n=function(e){return e[mn]||e}(t.positional.at(0))
return new oe(n)},unbound:function(e,t){return ie.create(t.positional.at(0).value())},unless:function(e,t){var n=t.positional
return fn.create(n.at(0),n.at(2),n.at(1))},"-class":function(e,t){return new re(tn,t.capture())},"-each-in":function(e,t){return new Ae(t.positional.at(0))},"-input-type":function(e,t){return new re(rn,t.capture())},"-normalize-class":function(e,t){return new re(on,t.capture())},"-html-safe":function(e,t){return new re(nn,t.capture())},"-get-dynamic-var":t.getDynamicVar,"-mount":function(e,t){var n=e.env,r=t.positional.at(0),i=t.named.has("model")?t.named.get("model"):void 0
return new In(r,n,i)},"-outlet":function(e,t){var n=e.dynamicScope(),r=void 0
return r=0===t.positional.length?new a.ConstReference("main"):t.positional.at(0),new Bn(new Dn(n.outletState,r))}}
T.RENDER_HELPER&&(Jn["-render"]=$n)
var Zn={action:new _n},er=function(){function e(){this.handles=[void 0],this.objToHandle=new WeakMap,this.builtInHelpers=Jn,this.builtInModifiers=Zn,this.templateCache=new Map,this.componentDefinitionCache=new Map,this.customManagerCache=new Map,this.templateCacheHits=0,this.templateCacheMisses=0,this.componentDefinitionCount=0,this.helperDefinitionCount=0
var e=new o.Macros;(function(e){var t,n=e.inlines,r=e.blocks
for(n.add("outlet",Fn),T.RENDER_HELPER&&n.add("render",Wn),n.add("mount",Ln),n.add("input",Rn),n.add("textarea",Cn),n.addMissing(qn),r.add("let",wn),r.addMissing(Kn),t=0;t<zn.length;t++)(0,zn[t])(r,n)})(e),this.compiler=new o.LazyCompiler(new qt(this),this,e)}return e.prototype.lookupComponentDefinition=function(e,t){var n=this.lookupComponentHandle(e,t)
...
return-1!==r&&(t=e.slice(r+2),n=e.slice(0,r)),{name:t,namespace:n}},e.prototype._lookupComponentDefinition=function(e,t){var n,r,i,o,s=e,a=(0,f.lookupComponent)(t.owner,s,Xn(t.moduleName,void 0)),l=a.layout,u=a.component,c=void 0===u?l:u
if(void 0===c)return null
var p=this.componentDefinitionCache.get(c)
if(void 0!==p)return p
var d=(0,h._instrumentStart)("render.getComponentDefinition",Qn,s)
if(l&&!u&&y.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS)return n=new en(l),d(),this.componentDefinitionCache.set(c,n),n
if(u&&u.class&&(r=Yn(u.class)))return i=this._lookupComponentManager(t.owner,r),o=new Xt(s,u,i,l||t.owner.lookup((0,_.privatize)(I))),d(),this.componentDefinitionCache.set(c,o),o
var m=l||u?new Ot(s,u||t.owner.factoryFor((0,_.privatize)(k)),null,l):null
...
var i=this.ref=new kn({outlets:{main:void 0},render:{owner:n,into:void 0,outlet:or,name:ir,controller:void 0,template:r}})
...
e.RootTemplate=B,e.template=M,e.Checkbox=ge,e.TextField=ye,e.TextArea=be,e.LinkComponent=Te,e.Component=he,e.ROOT_REF=ce,e.Helper=H,e.helper=$,e.Environment=et,e.SafeString=We,e.escapeExpression=function(e){if("string"!=typeof e){if(e&&e.toHTML)return e.toHTML()
if(null==e)return""
if(!e)return e+""
e=""+e}return Ke.test(e)?e.replace(ze,Ve):e},e.htmlSafe=Ge,e.isHTMLSafe=Ye,e.Renderer=jt,e.InertRenderer=Ht,e.InteractiveRenderer=Ut,e._resetRenderers=function(){Dt.length=0},e.renderSettled=function(){return null===Ft&&(Ft=C.default.defer(),(0,A.getCurrentRunLoop)()||A.backburner.schedule("actions",null,Mt)),Ft.promise},e.getTemplate=function(e){if($t.hasOwnProperty(e))return $t[e]},e.setTemplate=function(e,t){return $t[e]=t},e.hasTemplate=function(e){return $t.hasOwnProperty(e)},e.getTemplates=function(){return $t},e.setTemplates=function(e){$t=e},e.setupEngineRegistry=function(e){e.register("view:-outlet",sr),e.register("template:-outlet",rr),e.injection("view:-outlet","template","template:-outlet"),e.injection("service:-dom-changes","document","service:-document"),e.injection("service:-dom-tree-construction","document","service:-document"),e.register((0,_.privatize)(I),nr),e.register("service:-glimmer-environment",et),e.register((0,_.privatize)(P),tr),e.injection("template","compiler",(0,_.privatize)(P)),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",Wt),e.register("component:-text-field",ye),e.register("component:-text-area",be),e.register("component:-checkbox",ge),e.register("component:link-to",Te),y.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register((0,_.privatize)(k),he)},e.setupApplicationRegistry=function(e){e.injection("service:-glimmer-environment","appendOperations","service:-dom-tree-construction"),e.injection("renderer","env","service:-glimmer-environment"),e.register("service:-dom-builder",{create:function(e){switch(e.bootOptions._renderMode){case"serialize":return r.serializeBuilder.bind(null)
case"rehydrate":return t.rehydrationBuilder.bind(null)
default:return t.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,_.privatize)(D),B),e.injection("renderer","rootTemplate",(0,_.privatize)(D)),e.register("renderer:-dom",Ut),e.register("renderer:-inert",Ht),d.hasDOM&&e.injection("service:-glimmer-environment","updateOperations","service:-dom-changes"),e.register("service:-dom-changes",{create:function(e){var n=e.document
...
e.UpdatableReference=Z,e.INVOKE=K,e.iterableFor=Ce,e.DebugStack=void 0,e.OutletView=sr,e.capabilities=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
return{asyncLifeCycleCallbacks:!!t.asyncLifecycleCallbacks,destructor:!!t.destructor}},e.setComponentManager=function(e,t){return Gn.set(t,e),t},e.getComponentManager=Yn}),e("ember-meta/index",["exports","ember-meta/lib/meta"],function(e,t){"use strict"
...
t=u(t)}}var d=e.meta=function(e){var t=f(e)
...
e("ember-metal",["exports","ember-babel","@ember/polyfills","ember-utils","@ember/debug","@ember/deprecated-features","ember-environment","ember-meta","@ember/runloop","@glimmer/reference","@ember/error","ember/version","ember-owner"],function(e,t,n,r,i,o,s,a,l,u,c,p,f){"use strict"
...
function y(e){return"string"==typeof e&&-1!==v.get(e)}function b(e){return e+":change"}function E(e,t,n,r,i){o.DID_INIT_ATTRS&&s.ENV._ENABLE_DID_INIT_ATTRS_SUPPORT,r||"function"!=typeof n||(r=n,n=null),(0,a.meta)(e).addToListeners(t,n,r,!0===i)}function T(e,t,n,r){r||"function"!=typeof n||(r=n,n=null),(0,a.meta)(e).removeFromListeners(t,n,r)}function _(e,t,n,r,i){var o,s,l,u,c
...
i.forEachInDeps(n,function(n){void 0!==(s=(0,a.descriptorFor)(t,n,i))&&s._suspended===t||e(t,n,i)})}})(M,e,t,F,n),r&&(F.clear(),B=!0)}(e,t,r),function(e,t,n){var r=n.readableChainWatchers()
...
try{e()}finally{U()}}var W=function(){function e(){this.isDescriptor=!0,this.enumerable=!0}return e.prototype.setup=function(){},e.prototype.teardown=function(){},e}()
...
var c,p,f=void 0
n instanceof W?(f=n,Object.defineProperty(e,t,{configurable:!0,enumerable:u,get:(c=t,p=f,function(){return p.get(this,c)})}),i.writeDescriptors(t,f),n.setup(e,t)):null==n?(f=r,l||!1===u?Object.defineProperty(e,t,{configurable:!0,enumerable:u,writable:!0,value:f}):e[t]=r):(f=n,Object.defineProperty(e,t,n)),o&&j(0,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,f)}function K(e,t,n){var r,i=void 0===n?(0,a.meta)(e):n,o=i.peekWatching(t)
...
1===o?(i.writeWatching(t,0),void 0!==(r=(0,a.descriptorFor)(e,t,i))&&void 0!==r.didUnwatch&&r.didUnwatch(e,t,i),"function"==typeof e.didUnwatchProperty&&e.didUnwatchProperty(t)):o>1&&i.writeWatching(t,o-1)}}var V=new WeakMap
...
return r(e,"@array:before",t,o),r(e,"@array:change",t,s),a===i&&M(e,"hasArrayObservers"),e}function ue(e,t,n,r){E(e,b(t),n,r),we(e,t)}function ce(e,t,n,r){xe(e,t),T(e,b(t),n,r)}function pe(e){var t=V.get(e)
return void 0===t&&(t=new fe(e),V.set(e,t)),t}var fe=function(){function e(e){this._content=e,this._keys=void 0,(0,a.meta)(this)}return e.prototype.arrayWillChange=function(e,t,n){var r=this._keys
...
for(var l in i)o>0&&de(e,l,this,t,o),M(this,l,s)}},e.prototype.willWatchProperty=function(e){this.beginObservingContentKey(e)},e.prototype.didUnwatchProperty=function(e){this.stopObservingContentKey(e)},e.prototype.beginObservingContentKey=function(e){var t,n=this._keys
...
void 0!==n&&n[e]>0&&--n[e]<=0&&he(t=this._content,e,this,0,t.length)},e.prototype.contentKeyDidChange=function(e,t){M(this,t)},e}()
function de(e,t,n,r,i){for(var o;--i>=r;)(o=oe(e,i))&&ue(o,t,n,"contentKeyDidChange")}function he(e,t,n,r,i){for(var o;--i>=r;)(o=oe(e,i))&&ce(o,t,n,"contentKeyDidChange")}function me(e){return"object"==typeof e&&null!==e}var ge=function(){function e(){this.chains=Object.create(null)}return e.prototype.add=function(e,t){var n=this.chains[e]
...
r.writableChainWatchers(ve).add(t,n),K(e,t,r)}function Ee(e,t,n,r){if(me(e)){var i=void 0===r?(0,a.peekMeta)(e):r
void 0===i||i.isSourceDestroying()||i.isMetaDestroyed()||void 0===i.readableChainWatchers()||((i=(0,a.meta)(e)).readableChainWatchers().remove(t,n),z(e,t,i))}}var Te=[]
function _e(e){e.isWatching&&(Ee(e.object,e.key,e),e.isWatching=!1)}function Ae(e){var t=e.chains
if(void 0!==t)for(var n in t)void 0!==t[n]&&Te.push(t[n])}var Ce=function(){function e(e,t,n){var r
...
for(Ae(e);Te.length>0;)Ae(t=Te.pop()),_e(t)}(this):_e(this)},e.prototype.copyTo=function(e){var t,n=this.paths
...
t.length>0&&r.unchain(t.shift(),t),r.count--,r.count<=0&&(n[r.key]=void 0,r.destroy())},e.prototype.notify=function(e,t){e&&this.isWatching&&((n=this.parent.value())!==this.object&&(Ee(this.object,this.key,this),me(n)?(this.object=n,be(n,this.key,this)):this.object=void 0),this.content=void 0)
...
function Se(e,t,n){var r=void 0===n?(0,a.meta)(e):n,i=r.peekWatching(t)
...
i>0&&(r.writeWatching(t,i-1),1===i&&r.writableChains(ye).remove(t))}}function we(e,t,n){y(t)?Se(e,t,n):K(e,t,n)}function Oe(e,t){var n=(0,a.peekMeta)(e)
return void 0!==n&&n.peekWatching(t)||0}function xe(e,t,n){y(t)?Re(e,t,n):z(e,t,n)}function Ne(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)+1),we(t,o,r)}function Le(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)-1),xe(t,o,r)}var Ie=/\.@each$/
function ke(e,t){var n=e.indexOf("{")
n<0?t(e.replace(Ie,".[]")):function e(t,n,r,i){var o=n.indexOf("}"),s=0,a=void 0,l=void 0
var u=n.substring(r+1,o).split(",")
var c=n.substring(o+1)
t+=n.substring(0,r)
l=u.length
for(;s<l;)(a=c.indexOf("{"))<0?i((t+u[s++]+c).replace(Ie,".[]")):e(t+u[s++],c,a,i)}("",e,n,t)}function De(e,t,n,r){if(!e.isDestroyed){if(y(t))return function(e,t,n,r){var i=t.split("."),o=i.pop()
...
if(i&&o===s)return s
var l=(0,a.meta)(e)
return i||Ne(this,e,t,l),r.set(t,s),M(e,t,l),s},n.prototype.teardown=function(e,t,n){if(!this._volatile){var r=g(e)
void 0!==r&&r.delete(t)&&Le(this,e,t,n)}},n}(W)
function Fe(){for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
var e,t,n,r=t.pop(),i=new Me(r)
return t.length>0&&i.property.apply(i,t),i}var Be=Fe.bind(null),je=Object.freeze({}),He=function(e){function n(n){var r=(0,t.possibleConstructorReturn)(this,e.call(this))
return r.altKey=n,r._dependentKeys=[n],r}return(0,t.inherits)(n,e),n.prototype.setup=function(e,t){var n=(0,a.meta)(e)
n.peekWatching(t)>0&&Ne(this,e,t,n)},n.prototype.teardown=function(e,t,n){n.peekWatching(t)>0&&Le(this,e,t,n)},n.prototype.willWatch=function(e,t,n){Ne(this,e,t,n)},n.prototype.didUnwatch=function(e,t,n){Le(this,e,t,n)},n.prototype.get=function(e,t){var n,r=ne(e,this.altKey),i=h(e)
return i.get(t)!==je&&(n=(0,a.meta)(e),i.set(t,je),Ne(this,e,t,n)),r},n.prototype.set=function(e,t,n){return De(e,this.altKey,n)},n.prototype.readOnly=function(){return this.set=Ue,this},n.prototype.oneWay=function(){return this.set=$e,this},n}(W)
function Ue(e,t){throw new c.default("Cannot set read-only property '"+t+"' on object: "+(0,r.inspect)(e))}function $e(e,t,n){return q(e,t,null),De(e,t,n)}function We(e){var t,n,r=null==e
if(r)return r
if("number"==typeof e.size)return!e.size
var i=typeof e
return"object"===i&&"number"==typeof(t=ne(e,"size"))?!t:"number"==typeof e.length&&"function"!==i?!e.length:"object"===i&&"number"==typeof(n=ne(e,"length"))&&!n}function qe(e){return We(e)||"string"==typeof e&&!1===/\S/.test(e)}He.prototype._meta=void 0,He.prototype.meta=Me.prototype.meta
var Ke=function(){function e(){this._registry=[],this._coreLibIndex=0}return e.prototype._getLibraryByName=function(e){var t,n=this._registry,r=n.length
for(t=0;t<r;t++)if(n[t].name===e)return n[t]},e.prototype.register=function(e,t,n){var r=this._registry.length
this._getLibraryByName(e)||(n&&(r=this._coreLibIndex++),this._registry.splice(r,0,{name:e,version:t}))},e.prototype.registerCoreLibrary=function(e,t){this.register(e,t,!0)},e.prototype.deRegister=function(e){var t=this._getLibraryByName(e),n=void 0
t&&(n=this._registry.indexOf(t),this._registry.splice(n,1))},e}(),ze=new Ke
ze.registerCoreLibrary("Ember",p.default)
var Ve=Object.prototype.hasOwnProperty,Ge=!1,Ye={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},Qe=!1,Xe=[],Je=Object.create(null)
function Ze(){if(Ye.unprocessedNamespaces){var e,t,n,i,o=s.context.lookup,a=Object.keys(o)
...
for(var l in n)if(Ve.call(n,l))if(o=n[l],t[s]=l,o&&o.toString===nt&&void 0===(0,r.getName)(o))(0,r.setName)(o,t.join("."))
...
if(n&&(Ze(),Ye.unprocessedNamespaces=!1),n||Qe){for(e=Xe,t=0;t<e.length;t++)et(e[t])
...
var s=i[t]
return void 0===s&&void 0===(0,a.descriptorFor)(e,t)&&(s=e[t]),"function"==typeof s?(0,r.wrap)(n,s):n}function ut(e,t,i,o,s,l,u,c){i instanceof W?(i._getter&&(i=function(e,t,n,i,o,s){var l=void 0
return void 0===i[t]&&(l=o[t]),l||(l=(0,a.descriptorFor)(s,t,e)),void 0!==l&&l instanceof Me?((n=Object.create(n))._getter=(0,r.wrap)(n._getter,l._getter),l._setter&&(n._setter?n._setter=(0,r.wrap)(n._setter,l._setter):n._setter=l._setter),n):n}(o,t,i,l,s,e)),s[t]=i,l[t]=void 0):(u&&u.indexOf(t)>=0||"concatenatedProperties"===t||"mergedProperties"===t?i=function(e,t,n,i){var o=i[t]||e[t]
...
if(n)for(i=0;i<n.length;i++)r(e,n[i],null,t)}function ft(e,t,n,i){"function"==typeof n&&(pt(e,t,(0,r.getObservers)(n),ce),pt(e,t,(0,r.getListeners)(n),T)),"function"==typeof i&&(pt(e,t,(0,r.getObservers)(i),ue),pt(e,t,(0,r.getListeners)(i),E))}function dt(e,t,n){var i,l,u={},c={},p=(0,a.meta)(e),f=[],d=void 0,h=void 0,m=void 0
for(e._super=r.ROOT,function e(t,n,r,i,o,s){var a,l,u,c=void 0,p=void 0,f=void 0,d=void 0,h=void 0
function m(e){delete r[e],delete i[e]}for(a=0;a<t.length;a++)if(c=t[a],l=n,(p=(u=c)instanceof ht?l.hasMixin(u)?st:(l.addMixin(u),u.properties):u)!==st)if(p){for(f in o.willMergeMixin&&o.willMergeMixin(p),d=at("concatenatedProperties",p,i,o),h=at("mergedProperties",p,i,o),p)p.hasOwnProperty(f)&&(s.push(f),ut(o,f,p[f],n,r,i,d,h))
p.hasOwnProperty("toString")&&(o.toString=p.toString)}else c.mixins&&(e(c.mixins,n,r,i,o,s),c._without&&c._without.forEach(m))}(t,p,u,c,e,f),i=0;i<f.length;i++)if("constructor"!==(d=f[i])&&c.hasOwnProperty(d)){for(m=u[d],h=c[d];m&&m instanceof gt;)m=(l=ct(e,m,u,c)).desc,h=l.value
void 0===m&&void 0===h||(void 0!==(0,a.descriptorFor)(e,d)?ft(e,d,null,h):ft(e,d,e[d],h),o.BINDING_SUPPORT&&s.ENV._ENABLE_BINDING_SUPPORT&&"function"==typeof ht.detectBinding&&ht.detectBinding(d)&&p.writeBindings(d,h),q(e,d,m,h,p))}return o.BINDING_SUPPORT&&s.ENV._ENABLE_BINDING_SUPPORT&&!n&&"function"==typeof ht.finishPartial&&ht.finishPartial(e,p),e}var ht=function(){function e(e,t){this.properties=t,this.mixins=mt(e),this.ownerConstructor=void 0,this._without=void 0}return e.create=function(){Qe=!0
var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return r.methodName=n,r}return(0,t.inherits)(n,e),n.prototype.teardown=function(){throw new Error("Method not implemented.")},n.prototype.get=function(){throw new Error("Method not implemented.")},n.prototype.set=function(){throw new Error("Method not implemented.")},n}(W),vt=function(e){function n(n,r){var i=(0,t.possibleConstructorReturn)(this,e.call(this,yt))
...
return r.desc=n,r.enumerable=!1!==n.enumerable,r}return(0,t.inherits)(n,e),n.prototype.setup=function(e,t){Object.defineProperty(e,t,this.desc)},n.prototype.get=function(e,t){return e[t]},n.prototype.set=function(e,t,n){return e[t]=n},n}(W)
e.computed=Fe,e.ComputedProperty=Me,e._globalsComputed=Be,e.getCacheFor=h,e.getCachedValueFor=m,e.peekCacheFor=g,e.alias=function(e){return new He(e)},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){De(this,n,e)},get:function(){return ne(this,n)}})},e.PROXY_CONTENT=te,e._getPath=re,e.get=ne,e.getWithDefault=function(e,t,n){var r=ne(e,t)
...
e.isEmpty=We,e.isBlank=qe,e.isPresent=function(e){return!qe(e)},e.beginPropertyChanges=H,e.changeProperties=$,e.endPropertyChanges=U,e.notifyPropertyChange=M,e.overrideChains=j,e.propertyDidChange=P,e.propertyWillChange=D,e.PROPERTY_DID_CHANGE=L,e.defineProperty=q,e.Descriptor=W,e.watchKey=K,e.unwatchKey=z,e.ChainNode=Ce,e.finishChains=function(e){var t=e.readableChainWatchers()
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(ye)},e.removeChainWatcher=Ee,e.watchPath=Se,e.unwatchPath=Re,e.isWatching=function(e,t){return Oe(e,t)>0},e.unwatch=xe,e.watch=we,e.watcherCount=Oe,e.libraries=ze,e.Libraries=Ke,e.getProperties=function(e){var t={},n=arguments,r=1
...
for(n=0;n<r.length;n++)i=r[n],De(e,i,t[i])}),t)},e.expandProperties=ke,e.addObserver=ue
e.removeObserver=ce,e.Mixin=ht,e.aliasMethod=function(e){return new gt(e)},e.mixin=function(e){var t,n,r
...
for(i=0;i<s.length;++i)ke(s[i],l)
return(0,r.setObservers)(o,a),o},e.applyMixin=dt,e.InjectedProperty=vt,e.setHasViews=function(e){C=e},e.tagForProperty=R,e.tagFor=w,e.markObjectAsDirty=x,e.runInTransaction=N,e.didRender=void 0,e.assertNotRendered=void 0,e.descriptor=function(e){return new bt(e)},e.tracked=function(e,t,n){return"value"in n?function(e,t){var n=Symbol(e)
...
return""!==r&&("/"!==r[0]&&(r="/"+r),n+="#"+r),n}e.getHistoryPath=u,e.getHashPath=c,e.default=o.Object.extend({location:s.location,history:s.history,global:s.window,userAgent:s.userAgent,cancelRouterSetup:!1,rootURL:"/",detect:function(){var e=this.rootURL,n=function(e){var t,n,r=e.location,i=e.userAgent,o=e.history,s=e.documentMode,l=e.global,p=e.rootURL,f="none",d=!1,h=(0,a.getFullPath)(r);(0,a.supportsHistory)(i,o)?(t=u(p,r),h===t?f="history":"/#"===h.substr(0,2)?(o.replaceState({path:t},null,t),f="history"):(d=!0,(0,a.replacePath)(r,t))):(0,a.supportsHashChange)(s,l)&&(n=c(p,r),h===n||"/"===h&&"/#/"===n?f="hash":(d=!0,(0,a.replacePath)(r,n)))
if(d)return!1
...
for(n=0;n<e.length;n+=3)t(e[n]).to(e[n+1],e[n+2])}},e.prototype.mount=function(n){var i,a,l,u,c,p,f=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},d=this.options.resolveRouteMap(n),h=n
f.as&&(h=f.as)
var m=o(this,h,f.resetNamespace),g={name:n,instanceId:r++,mountPoint:m,fullName:m},v=f.path
"string"!=typeof v&&(v="/"+h)
var y=void 0,b="/_unused_dummy_error_path_route_"+h+"/:error"
d&&(i=!1,(a=this.options.engineInfo)&&(i=!0,this.options.engineInfo=g),s(l=new e(m,(0,t.assign)({engineInfo:g},this.options)),"loading"),s(l,"error",{path:b}),d.class.call(l),y=l.generate(),i&&(this.options.engineInfo=a))
var E=(0,t.assign)({localFullName:"application"},g)
this.enableLoadingSubstates&&(u=h+"_loading",c="application_loading",p=(0,t.assign)({localFullName:c},g),s(this,u,{resetNamespace:f.resetNamespace}),this.options.addRouteForEngine(u,p),u=h+"_error",c="application_error",p=(0,t.assign)({localFullName:c},g),s(this,u,{resetNamespace:f.resetNamespace,path:b}),this.options.addRouteForEngine(u,p)),this.options.addRouteForEngine(m,E),this.push(v,m,y)},e}()
...
var d=l.Object.extend(l.ActionHandler,l.Evented,{queryParams:{},router:n.ROUTER_ROUTER?(0,o.computed)("_router",function(){return this._router}):void 0,_setRouteName:function(e){this.routeName=e,this.fullRouteName=v((0,r.getOwner)(this),e)},_qp:(0,o.computed)(function(){var e,n,i,s,a,p,f,d,h,m,g=this,v=void 0,y=this.controllerName||this.routeName,b=(0,r.getOwner)(this),E=b.lookup("controller:"+y),T=(0,o.get)(this,"queryParams"),_=Object.keys(T).length>0
...
return o}((0,c.normalizeControllerQueryParams)(e),T)):_&&(E=(0,u.default)(b,y),v=T)
var A=[],C={},S=[]
for(var R in v)v.hasOwnProperty(R)&&"unknownProperty"!==R&&"_super"!==R&&(s=void 0,"controller"===(i=(n=v[R]).scope||"model")&&(s=[]),a=n.as||this.serializeQueryParamKey(R),p=(0,o.get)(E,R),Array.isArray(p)&&(p=(0,l.A)(p.slice())),f=n.type||(0,l.typeOf)(p),d=this.serializeQueryParam(p,a,f),h=y+":"+R,m={undecoratedDefaultValue:(0,o.get)(E,R),defaultValue:p,serializedDefaultValue:d,serializedValue:d,type:f,urlKey:a,prop:R,scopedPropertyName:h,controllerName:y,route:this,parts:s,values:null,scope:i},C[R]=C[a]=C[h]=m,A.push(m),S.push(R))
...
if(n){var r,i,s,a,l,u,p,f,d,h=n.state.handlerInfos,m=this._router,v=m._queryParamsFor(h),y=m._qpUpdates,b=void 0
for((0,c.stashParamNames)(m,h),r=0;r<v.qps.length;++r)a=(s=(i=v.qps[r]).route).controller,l=i.urlKey in e&&i.urlKey,u=void 0,p=void 0,y&&i.urlKey in y?(u=(0,o.get)(a,i.prop),p=s.serializeQueryParam(u,i.urlKey,i.type)):l?void 0!==(p=e[l])&&(u=s.deserializeQueryParam(p,i.urlKey,i.type)):(p=i.serializedDefaultValue,u=g(i.defaultValue)),a._qpDelegate=(0,o.get)(s,"_qp.states.inactive"),p!==i.serializedValue&&(n.queryParamsOnly&&!1!==b&&(f=s._optionsForQueryParam(i),(d=(0,o.get)(f,"replace"))?b=!0:!1===d&&(b=!1)),(0,o.set)(a,i.prop,u)),i.serializedValue=p,i.serializedDefaultValue===p&&!n._keepDefaultQueryParamValues||t.push({value:p,visible:!0,key:l||i.urlKey})
...
var s=function(e,t,n,i){var o,s=(0,r.getOwner)(e),a=void 0,l=void 0,u=void 0,c=void 0,p=void 0,f=void 0
i&&(u=i.into&&i.into.replace(/\//g,"."),c=i.outlet,p=i.controller,f=i.model)
...
return{owner:s,into:u,outlet:c,name:a,controller:p,template:d||e._topLevelViewTemplate}}(this,o,n,t)
...
if(c)return c
var p=!0,f={},d={},h=[]
for(t=0;t<l;++t)if(r=this._getQPMeta(e[t])){for(i=0;i<r.qps.length;i++)(a=f[s=(o=r.qps[i]).urlKey])&&a.controllerName!==o.controllerName&&f[s],f[s]=o,h.push(o);(0,n.assign)(d,r.map)}else p=!1
var m={qps:h,map:d}
...
for(r=0;r<c.length;++r)if(i=this._getQPMeta(c[r]))for(o=0,s=i.qps.length;o<s;++o)a=i.qps[o],(l=a.prop in t&&a.prop||a.scopedPropertyName in t&&a.scopedPropertyName||a.urlKey in t&&a.urlKey)?l!==a.scopedPropertyName&&(t[a.scopedPropertyName]=t[l],delete t[l]):(u=(0,p.calculateCacheKey)(a.route.fullRouteName,a.parts,e.params),t[a.scopedPropertyName]=f.lookup(u,a.prop,a.defaultValue))},_scheduleLoadingEvent:function(e,t){this._cancelSlowTransitionTimer(),this._slowTransitionTimer=(0,r.scheduleOnce)("routerTransitions",this,"_handleSlowTransition",e,t)},currentState:null,targetState:null,_handleSlowTransition:function(e,t){if(this._routerMicrolib.activeTransition){var n=new f.default(this,this._routerMicrolib,this._routerMicrolib.activeTransition.state)
...
y(e,function(e,n){if(n!==i&&(o=T(e,"error")))return r._markErrorAsHandled(t),r.intermediateTransitionTo(o,t),!1
var o,s=E(e,"error")
...
y(e,function(e,i){if(i!==r&&(o=T(e,"loading")))return n.intermediateTransitionTo(o),!1
var o,s=E(e,"loading")
...
a&&("currentPath"in a||(0,i.defineProperty)(a,"currentPath"),(0,i.set)(a,"currentPath",r),"currentRouteName"in a||(0,i.defineProperty)(a,"currentRouteName"),(0,i.set)(a,"currentRouteName",o))}}function R(e,t){var n=new f.default(t,t._routerMicrolib,e.state)
...
e.default=r})
e("ember-runtime/lib/mixins/array",["exports","@ember/deprecated-features","ember-metal","ember-utils","@ember/debug","ember-runtime/lib/mixins/enumerable","ember-runtime/lib/compare","ember-environment","ember-runtime/lib/mixins/observable","ember-runtime/lib/copy","@ember/error","ember-runtime/lib/mixins/mutable_enumerable","ember-runtime/lib/type-of"],function(e,t,n,r,i,o,s,a,l,u,c,p,f){"use strict"
var d,h
e.MutableArray=e.NativeArray=e.A=void 0,e.isEmberArray=function(e){return e&&e[g]},e.uniqBy=y,e.isArray=S,e.removeAt=O
var m=Object.freeze([]),g=(0,r.symbol)("EMBER_ARRAY"),v=function(e){return e}
function y(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:v,r=I(),i=new Set,o="function"==typeof t?t:function(e){return(0,n.get)(e,t)}
return e.forEach(function(e){var t=o(e)
i.has(t)||(i.add(t),r.push(e))}),r}function b(e,t){return 2===arguments.length?function(r){return t===(0,n.get)(r,e)}:function(t){return!!(0,n.get)(t,e)}}function E(e,t,r){var i,o=e.length
for(i=r;i<o;i++)if(t((0,n.objectAt)(e,i),i,e))return i
return-1}function T(e,t,r){var i=E(e,t.bind(r),0)
return-1===i?void 0:(0,n.objectAt)(e,i)}function _(e,t,n){return-1!==E(e,t.bind(n),0)}function A(e,t,n){var r=t.bind(n)
return-1===E(e,function(e,t,n){return!r(e,t,n)},0)}function C(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,r=arguments[3],i=e.length
return n<0&&(n+=i),E(e,r&&t!=t?function(e){return e!=e}:function(e){return e===t},n)}function S(e){var t=e
...
return this},d.getEach=(0,n.aliasMethod)("mapBy"),d.setEach=function(e,t){return this.forEach(function(r){return(0,n.set)(r,e,t)})},d.map=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=I()
return this.forEach(function(r,i,o){return n[i]=e.call(t,r,i,o)}),n},d.mapBy=function(e){return this.map(function(t){return(0,n.get)(t,e)})},d.filter=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=I()
...
return this.filter(function(){return!e.apply(t,arguments)})},d.filterBy=function(){return this.filter(b.apply(void 0,arguments))},d.rejectBy=function(){return this.reject(b.apply(void 0,arguments))},d.find=function(e){return T(this,e,arguments.length>1&&void 0!==arguments[1]?arguments[1]:null)},d.findBy=function(){return T(this,b.apply(void 0,arguments))},d.every=function(e){return A(this,e,arguments.length>1&&void 0!==arguments[1]?arguments[1]:null)},d.isEvery=function(){return A(this,b.apply(void 0,arguments))},d.any=function(e){return _(this,e,arguments.length>1&&void 0!==arguments[1]?arguments[1]:null)},d.isAny=function(){return _(this,b.apply(void 0,arguments))},d.reduce=function(e,t){var n=t
...
return this.filter(t)},d["@each"]=t.ARRAY_AT_EACH?(0,n.computed)(function(){return(0,n.eachProxyFor)(this)}).readOnly():void 0,d)),w="Index out of range"
function O(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
if("number"==typeof t){if(t<0||t>=e.length)throw new c.default(w)
e.replace(t,n,m)}return e}var x=n.Mixin.create(R,p.default,{clear:function(){var e=this.length
return 0===e?this:(this.replace(0,e,m),this)},insertAt:function(e,t){if(e>this.length)throw new c.default(w)
...
return(0,n.beginPropertyChanges)(this),e.forEach(function(e){return t.addObject(e)}),(0,n.endPropertyChanges)(this),this}}),N=n.Mixin.create(x,l.default,{objectAt:function(e){return this[e]},replace:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:m
return(0,n.replaceInNativeArray)(this,e,t,r),this},copy:function(e){return e?this.map(function(e){return(0,u.default)(e,!0)}):this.slice()}}),L=["length"]
N.keys().forEach(function(e){Array.prototype[e]&&L.push(e)}),e.NativeArray=N=(h=N).without.apply(h,L)
var I=void 0
a.ENV.EXTEND_PROTOTYPES.Array?(N.apply(Array.prototype),e.A=I=function(e){return e||[]}):e.A=I=function(e){return e||(e=[]),R.detect(e)?e:N.apply(e)},e.A=I,e.NativeArray=N,e.MutableArray=x,e.default=R}),e("ember-runtime/lib/mixins/comparable",["exports","ember-metal"],function(e,t){"use strict"
...
var f=l.Mixin.prototype.reopen,d=new o.WeakSet,h=new WeakMap,m=new WeakMap,g=function(){function e(e){var t,s,u,c,f,d,m,g,v,y,b,E,T=h.get(this.constructor)
void 0!==T&&(h.delete(this.constructor),n.FACTORY_FOR.set(this,T)),this.constructor.proto()
var _=(0,a.meta)(this),A=_.proto
if(_.proto=this,void 0!==e)for(s=this.concatenatedProperties,u=this.mergedProperties,c=void 0!==s&&s.length>0,f=void 0!==u&&u.length>0,d=Object.keys(e),m=0;m<d.length;m++)v=e[g=d[m]],r.BINDING_SUPPORT&&p.ENV._ENABLE_BINDING_SUPPORT&&l.Mixin.detectBinding(g)&&_.writeBindings(g,v),(b=void 0!==(y=(0,a.descriptorFor)(this,g,_)))||(E=this[g],c&&s.indexOf(g)>-1&&(v=E?(0,o.makeArray)(E).concat(v):(0,o.makeArray)(v)),f&&u.indexOf(g)>-1&&(v=(0,i.assign)({},E,v))),b?y.set(this,g,v):"function"!=typeof this.setUnknownProperty||g in this?this[g]=v:this.setUnknownProperty(g,v)
r.BINDING_SUPPORT&&p.ENV._ENABLE_BINDING_SUPPORT&&l.Mixin.finishPartial(this,_),(t=this).init.apply(t,arguments),_.proto=A,(0,l.finishChains)(_),(0,l.sendEvent)(this,"init",void 0,void 0,void 0,_)}return e._initFactory=function(e){h.set(this,e)},e.prototype.reopen=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return f.apply(e.PrototypeMixin,arguments),e},e.create=function(e,t){return new this(void 0===t?e:function(){var e,t,n,r,s,a,l,u,c,p,f,d,h=this.concatenatedProperties,m=this.mergedProperties,g=void 0!==h&&h.length>0,v=void 0!==m&&m.length>0,y={}
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
for(r=0;r<t.length;r++)for(s=t[r],a=Object.keys(s),l=0,u=a.length;l<u;l++)c=a[l],p=s[c],g&&h.indexOf(c)>-1&&(f=y[c],p=f?(0,o.makeArray)(f).concat(p):(0,o.makeArray)(p)),v&&m.indexOf(c)>-1&&(d=y[c],p=(0,i.assign)({},d,p)),y[c]=p
...
d.has(e)&&(d.delete(e),m.has(this)&&m.set(this,l.Mixin.create(this.PrototypeMixin)))},e.reopenClass=function(){return(0,l.applyMixin)(this,arguments,!1),this},e.detect=function(e){if("function"!=typeof e)return!1
...
g.toString=l.classToString,(0,o.setName)(g,"Ember.CoreObject"),g.isClass=!0,g.isMethod=!1,e.default=g}),e("ember-runtime/lib/system/namespace",["exports","ember-babel","ember-metal","ember-utils","ember-runtime/lib/system/object"],function(e,t,n,r,i){"use strict"
...
return l.push(n),n}var c="function"==typeof WeakSet?WeakSet:function(){function e(){this._map=new WeakMap}return e.prototype.add=function(e){return this._map.set(e,!0),this},e.prototype.delete=function(e){return this._map.delete(e)},e.prototype.has=function(e){return this._map.has(e)},e}(),p=/\.(_super|call\(this|apply\(this)/,f=Function.prototype.toString,d=f.call(function(){return this}).indexOf("return this")>-1?function(e){return p.test(f.call(e))}:function(){return!0},h=new WeakMap,m=Object.freeze(function(){})
function g(e){var t=h.get(e)
return void 0===t&&(t=d(e),h.set(e,t)),t}h.set(m,!1)
var v=new WeakMap
function y(e,t){t&&v.set(e,t)}function b(e){return v.get(e)}var E=new WeakMap
function T(e,t){t&&E.set(e,t)}function _(e){return E.get(e)}var A=new c
function C(e,t){function n(){var n=this._super
this._super=t
var r=e.apply(this,arguments)
return this._super=n,r}return A.add(n),y(n,b(e)),T(n,_(e)),n}var S=Object.prototype.toString,R=Function.prototype.toString,w=Array.isArray,O=Object.keys,x=JSON.stringify,N=100,L=4,I=/^[\w$]+$/
...
for(var u in r)r.hasOwnProperty(u)&&this.setupHandler(a,u,r[u],l)},setupHandler:function(e,t,n,r){var i,o,l,p,f,d,h
...
if(p)for(l=0;l<p.length;l++)if((u=p[l])&&u.eventName===n)return u.handler(t)},void 0!==c[t]?(l=c[t],p=t,f=function(e,t){var n=document.createEvent("MouseEvent")
return n.initMouseEvent(e,!1,!1,t.view,t.detail,t.screenX,t.screenY,t.clientX,t.clientY,t.ctrlKey,t.altKey,t.shiftKey,t.metaKey,t.button,t.relatedTarget),Object.defineProperty(n,"target",{value:t.target,enumerable:!0}),n},d=this._eventHandlers[l]=function(e){var t=e.target,n=e.relatedTarget
do{if(r[t.id]){n&&(n===t||t.contains(n))||i(t,f(p,e))
break}if(t.hasAttribute("data-ember-action")){n&&(n===t||t.contains(n))||o(t,f(p,e))
break}t=t.parentNode}while(t&&1===t.nodeType)},e.addEventListener(l,d)):(h=this._eventHandlers[t]=function(e){var t=e.target
...
var b=Object.freeze({}),E=Object.freeze([])
...
O.prototype.add=function(e,t){var n,r,i,o,s,a,l,u=this.rootState,c="^",p=[0,0,0],f=new Array(e.length),d=[],h=!0,m=0
for(n=0;n<e.length;n++){for(o=(i=T(d,(r=e[n]).path,p)).names,s=i.shouldDecodes;m<d.length;m++)4!==(a=d[m]).type&&(h=!1,u=u.put(47,!1,!1),c+="/",u=g[a.type](a,u),c+=v[a.type](a))
f[n]={handler:r.handler,names:o,shouldDecodes:s}}h&&(u=u.put(47,!1,!1),c+="/"),u.handlers=f,u.pattern=c+"$",u.types=p,"object"==typeof t&&null!==t&&t.as&&(l=t.as),l&&(this.names[l]={segments:d,handlers:f})},O.prototype.handlersFor=function(e){var t,n,r=this.names[e]
...
for(l.sort(),t=0;t<l.length;t++)if(null!=(r=e[n=l[t]]))if(i=encodeURIComponent(n),d(r))for(o=0;o<r.length;o++)s=n+"[]="+encodeURIComponent(r[o]),a.push(s)
...
var f=e.length
for(f>1&&"/"===e.charAt(f-1)&&(e=e.substr(0,f-1),p=p.substr(0,p.length-1),l=!0),r=0;r<e.length&&(o=S(o,e.charCodeAt(r))).length;r++);var d=[]
...
var h=d[0]
return h&&h.handlers&&(l&&h.pattern&&"(.+)$"===h.pattern.slice(-5)&&(p+="/"),t=function(e,t,n){var r,i,o,s,a,l,u,c,p,f=e.handlers,d=e.regex()
if(!d||!f)throw new Error("state not initialized")
var h=t.match(d),m=1,g=new R(n)
for(g.length=f.length,r=0;r<f.length;r++){if(o=(i=f[r]).names,s=i.shouldDecodes,a=b,l=!1,o!==E&&s!==E)for(u=0;u<o.length;u++)l=!0,c=o[u],p=h&&h[m++],a===b&&(a={}),O.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[u]?a[c]=p&&decodeURIComponent(p):a[c]=p
...
if(!l&&!n)throw new Error("Nothing handled the event '"+a+"'.")}function u(e,t,n){n.events[e].apply(n,t)}}function d(e,t){var n,r,i=void 0,a={all:{},changed:{},removed:{}}
s(a.all,t)
var u=!1
...
function E(e){return u(e.router,e.sequence,"detected abort."),new y}b.prototype.send=b.prototype.trigger
...
return this.applyToHandlers(e,s,n,l,r,null,i)},n.prototype.applyToHandlers=function(e,t,n,r,i,o,a){var l,u,c,p,f,d,h,m,g,y=new v,b=this.contexts.slice(0),E=t.length
if(this.pivotHandler)for(l=0,u=t.length;l<u;++l)if(t[l].handler===this.pivotHandler._handlerName){E=l
break}for(l=t.length-1;l>=0;--l)p=(c=t[l]).handler,f=e.handlerInfos[l],d=null,c.names.length>0?l>=E?d=this.createParamHandlerInfo(p,n,c.names,b,f):(h=a(p),d=this.getHandlerInfoForDynamicSegment(p,n,c.names,b,f,r,l,h)):d=this.createParamHandlerInfo(p,n,c.names,b,f),o&&(d=d.becomeResolved(null,d.context),m=f&&f.context,c.names.length>0&&"context"in f&&d.context===m&&(d.params=f&&f.params),d.context=m),g=f,(l>=E||d.shouldSupercede(f))&&(E=Math.min(l,E),g=d),i&&!o&&(g=g.becomeResolved(null,g.context)),y.handlerInfos.unshift(g)
if(b.length>0)throw new Error("More context objects were passed than there are dynamic segments for the route: "+r)
return i||this.invalidateChildren(y.handlerInfos,E),s(y.queryParams,this.queryParams||{}),y},n.prototype.invalidateChildren=function(e,t){var n,r,i
...
var f=!1,d=this.url
function h(e){if(e&&e.inaccessibleByURL)throw new x(d)
return e}for(l=0,u=p.length;l<u;++l)(o=(i=w("param",{name:(r=p[l]).handler,getHandler:n,params:r.params})).handler)?h(o):i.handlerPromise=i.handlerPromise.then(h),a=e.handlerInfos[l],f||i.shouldSupercede(a)?(f=!0,c.handlerInfos[l]=i):c.handlerInfos[l]=a
...
var f=B(new O({name:l,contexts:t}).applyToHandlers(p,u,this.getHandler,l,!0,!0,this.getSerializer).handlerInfos,p.handlerInfos)
if(!n||!f)return f
var h={}
s(h,n)
var m=o.queryParams
for(var g in m)m.hasOwnProperty(g)&&h.hasOwnProperty(g)&&(h[g]=m[g])
return f&&!d(h,n)},e.prototype.isActive=function(e){for(t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
var t,n,r,i=a(n)
return this.isActiveIntent(e,i[0],i[1])},e.prototype.trigger=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
f(this,this.currentHandlerInfos,!1,t)},e}()
function k(e,t,n){n&&(e._changedQueryParams=n.all,f(e,t.handlerInfos,!0,["queryParamsDidChange",n.changed,n.all,n.removed]),e._changedQueryParams=null)}function D(e,t,n){var r,i,o,s=function(e,t){var n,r,i,o,s,a=e.handlerInfos,l=t.handlerInfos,u={updatedContext:[],exited:[],entered:[],unchanged:[],reset:void 0},c=!1
...
return u}e.default=I,e.Transition=b}),e("rsvp",["exports","ember-babel","node-module"],function(e,t,n){"use strict"
...
var n=new this(p,t)
return T(n,e),n}function p(){}var f=void 0,d=1,h=2,m={error:null}
function g(e){try{return e.then}catch(e){return m.error=e,m}}var v=void 0
function y(){var e
try{return e=v,v=null,e.apply(this,arguments)}catch(e){return m.error=e,m}}function b(e){return v=e,y}function E(e,t,n){var r
t.constructor===e.constructor&&n===O&&e.constructor.resolve===c?function(e,t){t._state===d?A(e,t._result):t._state===h?(t._onError=null,C(e,t._result)):S(t,void 0,function(n){t===n?A(e,n):T(e,n)},function(t){return C(e,t)})}(e,t):n===m?(r=m.error,m.error=null,C(e,r)):"function"==typeof n?function(e,t,n){s.async(function(e){var r,i=!1,o=b(n).call(t,function(n){i||(i=!0,t===n?A(e,n):T(e,n))},function(t){i||(i=!0,C(e,t))},"Settle: "+(e._label||" unknown promise"))
i||o!==m||(i=!0,r=m.error,m.error=null,C(e,r))},e)}(e,t,n):A(e,t)}function T(e,t){var n,r
e===t?A(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?A(e,t):E(e,t,g(t)))}function _(e){e._onError&&e._onError(e._result),R(e)}function A(e,t){e._state===f&&(e._result=t,e._state=d,0===e._subscribers.length?s.instrument&&u("fulfilled",e):s.async(R,e))}function C(e,t){e._state===f&&(e._state=h,e._result=t,s.async(_,e))}function S(e,t,n,r){var i=e._subscribers,o=i.length
e._onError=null,i[o]=t,i[o+d]=n,i[o+h]=r,0===o&&e._state&&s.async(R,e)}function R(e){var t,n=e._subscribers,r=e._state
if(s.instrument&&u(r===d?"fulfilled":"rejected",e),0!==n.length){var i=void 0,o=void 0,a=e._result
...
this._isUsingOwnResolve?(r=g(e))===O&&e._state!==f?(e._onError=null,this._settledAt(e._state,t,e._result,n)):"function"!=typeof r?this._settledAt(d,t,e,n):this._isUsingOwnPromise?(E(i=new o(p),e,r),this._willSettleAt(i,t,n)):this._willSettleAt(new o(function(t){return t(e)}),t,n):this._willSettleAt(o.resolve(e),t,n)},e.prototype._eachEntry=function(e,t,n){null!==e&&"object"==typeof e?this._settleMaybeThenable(e,t,n):this._setResultAt(d,t,e,n)},e.prototype._settledAt=function(e,t,n,r){var i=this.promise
i._state===f&&(this._abortOnReject&&e===h?C(i,n):(this._setResultAt(e,t,n,r),this._checkFullfillment()))},e.prototype._setResultAt=function(e,t,n){this._remaining--,this._result[t]=n},e.prototype._willSettleAt=function(e,t,n){var r=this
S(e,void 0,function(e){return r._settledAt(d,t,e,n)},function(e){return r._settledAt(h,t,e,n)})},e}()
function N(e,t,n){this._remaining--,this._result[t]=e===d?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}var L="rsvp_"+Date.now()+"-",I=0
...
for(n=0;r._state===f&&n<e.length;n++)S(this.resolve(e[n]),void 0,function(e){return T(r,e)},function(e){return C(r,e)})
...
function W(e,t){return null===e||"object"!=typeof e?k.reject(new TypeError("Promise.hash must be called with an object"),t):new $(k,e,t).promise}var q=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}($)
function K(e,t){return null===e||"object"!=typeof e?k.reject(new TypeError("RSVP.hashSettled must be called with an object"),t):new q(k,e,!1,t).promise}function z(e){throw setTimeout(function(){throw e}),e}function V(e){var t={resolve:void 0,reject:void 0}
return t.promise=new k(function(e,n){t.resolve=e,t.reject=n},e),t}q.prototype._setResultAt=N
...
r?(i=b(this._mapFn)(n,t))===m?this._settledAt(h,t,i.error,!1):this._eachEntry(i,t,!1):(this._remaining--,this._result[t]=n)},n}(x)
...
r?(this._result[t]=n,(i=b(this._mapFn)(n,t))===m?this._settledAt(h,t,i.error,!1):this._eachEntry(i,t,!1)):(this._remaining--,n||(this._result[t]=J))},n}(G)
...
var be=Q,Ee=function(e,t){return s.async(e,t)}
...
e.default={asap:re,cast:be,Promise:k,EventTarget:o,all:B,allSettled:H,race:U,hash:W,hashSettled:K,rethrow:z,defer:V,denodeify:P,configure:a,on:Te,off:_e,resolve:Q,reject:X,map:Y,async:Ee,filter:ee},e.asap=re,e.cast=be,e.Promise=k,e.EventTarget=o,e.all=B,e.allSettled=H,e.race=U,e.hash=W,e.hashSettled=K,e.rethrow=z,e.defer=V,e.denodeify=P,e.configure=a,e.on=Te,e.off=_e,e.resolve=Q,e.reject=X,e.map=Y,e.async=Ee,e.filter=ee}),t("ember")}(),function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?require("jquery"):require("jquery")(t)),e(n)}:e(window.jQuery)}(function(e){var t=function(n,r){this.id=++e.FE.ID
var i={}
...
n&&"IMG"==n.tagName&&e(n).trigger("mousedown"),void 0===this.ul&&this.destroy(),"touchend"==t.type&&this.image&&t.originalEvent&&t.originalEvent.target&&e(t.originalEvent.target).is("img")&&setTimeout(e.proxy(function(){this.image.edit(e(t.originalEvent.target))},this),100),this.ready=!0,this.events.trigger("initialized")}},this)),this.events.trigger("initializationDelayed")):(this.load(e.FE.MODULES),this.load(e.FE.PLUGINS),e(this.o_win).scrollTop(s),void 0===this.ul&&this.destroy(),this.ready=!0,this.events.trigger("initialized"))},this)),this._init()}
t.DEFAULTS={initOnClick:!1,pluginsEnabled:null},t.MODULES={},t.PLUGINS={},t.VERSION="2.9.0",t.INSTANCES=[],t.OPTS_MAPPING={},t.SHARED={},t.ID=0,t.prototype._init=function(){var t=this.$oel.prop("tagName")
...
function i(e,t,n){f(e,t,n)}function o(n){if(void 0===n&&(n=!0),!t.$wp)return!1
...
function f(e,n,r,i,o){"function"==typeof r&&(o=i,i=r,r=!1)
var s=o?t.shared.$_events:p,a=o?t.sid:t.id
r?e.on(n.split(" ").join(".ed"+a+" ")+".ed"+a,r,i):e.on(n.split(" ").join(".ed"+a+" ")+".ed"+a,i),s.push([e,n.split(" ").join(".ed"+a+" ")+".ed"+a])}function d(e){for(var t=0;t<e.length;t++)e[t][0].off(e[t][1])}function h(n,i,o){if(!t.edit.isDisabled()||o){var s,a
...
return void 0!==(a=t.$oel.triggerHandler("froalaEditor."+n,e.merge([t],[i])))&&(i=a),i}},$on:f,$off:function(){d(p),p=[],0===t.shared.count&&(d(t.shared.$_events),t.shared.$_events=[])}}},e.FE.MODULES.node=function(t){function n(e){return e&&"IFRAME"!=e.tagName?Array.prototype.slice.call(e.childNodes||[]):[]}function r(t){return!!t&&t.nodeType==Node.ELEMENT_NODE&&0<=e.FE.BLOCK_TAGS.indexOf(t.tagName.toLowerCase())}function i(e){var t={},n=e.attributes
...
var f=null
if(0<p.length){p=p[0]
try{for(var d,h=!1,m=l.nextSibling;m&&m.nodeType==Node.TEXT_NODE&&0===m.textContent.length;)m=(d=m).nextSibling,e(d).remove()
for(var g,v,y=p.nextSibling;y&&y.nodeType==Node.TEXT_NODE&&0===y.textContent.length;)y=(d=y).nextSibling,e(d).remove()
if(l.nextSibling==p||p.nextSibling==l){for(var b=l.nextSibling==p?l:p,E=b==l?p:l,T=b.previousSibling;T&&T.nodeType==Node.TEXT_NODE&&0===T.length;)T=(d=T).previousSibling,e(d).remove()
...
for(var _=E.nextSibling;_&&_.nodeType==Node.TEXT_NODE&&0===_.length;)_=(d=_).nextSibling,e(d).remove()
...
T.textContent=T.textContent+_.textContent,e(_).remove(),t.opts.htmlUntouched||t.spaces.normalize(T),c.setStart(T,A),c.setEnd(T,A),h=!0}else!T&&_&&_.nodeType==Node.TEXT_NODE?(e(l).remove(),e(p).remove(),t.opts.htmlUntouched||t.spaces.normalize(_),f=e(t.doc.createTextNode("​")),e(_).before(f),c.setStart(_,0),c.setEnd(_,0),h=!0):!_&&T&&T.nodeType==Node.TEXT_NODE&&(e(l).remove(),e(p).remove(),t.opts.htmlUntouched||t.spaces.normalize(T),f=e(t.doc.createTextNode("​")),e(T).after(f),c.setStart(T,T.textContent.length),c.setEnd(T,T.textContent.length),h=!0)}h||((t.browser.chrome||t.browser.edge)&&l.nextSibling==p?(g=u(p,c,!0)||c.setStartAfter(p),v=u(l,c,!1)||c.setEndBefore(l)):(l.previousSibling==p&&(p=(l=p).nextSibling),p.nextSibling&&"BR"===p.nextSibling.tagName||!p.nextSibling&&t.node.isBlock(l.previousSibling)||l.previousSibling&&"BR"==l.previousSibling.tagName||(l.style.display="inline",p.style.display="inline",f=e(t.doc.createTextNode("​"))),g=u(l,c,!0)||e(l).before(f)&&c.setStartBefore(l),v=u(p,c,!1)||e(p).after(f)&&c.setEndAfter(p)),"function"==typeof g&&g(),"function"==typeof v&&v())}catch(e){}}f&&f.remove()
...
return{atStart:i,atEnd:o}}function f(n,r){void 0===r&&(r=!0)
var i=e(n).html()
i&&i.replace(/\u200b/g,"").length!=i.length&&e(n).html(i.replace(/\u200b/g,""))
for(var o=t.node.contents(n),s=0;s<o.length;s++)o[s].nodeType!=Node.ELEMENT_NODE?e(o[s]).remove():(f(o[s],0===s),0===s&&(r=!1))
n.nodeType==Node.TEXT_NODE?e(n).replaceWith('<span data-first="true" data-text="true"></span>'):r&&e(n).attr("data-first",!0)}function d(){return 0===e(this).find("fr-inner").length}function h(){try{if(!t.$wp)return!1
...
t.node.hasClass(a,"fr-marker")?i=(i+1)%2:i?0<e(a).find(".fr-marker").length?i=n(e(a),i):["TD","TH"].indexOf(a.tagName)<0&&!t.node.hasClass(a,"fr-inner")?!t.opts.keepFormatOnDelete||0<t.$el.find("[data-first]").length||t.node.isVoid(a)?e(a).remove():f(a):t.node.hasClass(a,"fr-inner")?0===e(a).find(".fr-inner").length?e(a).html("<br>"):e(a).find(".fr-inner").filter(d).html("<br>"):(e(a).empty(),e(a).attr("data-del-cell",!0)):0<e(a).find(".fr-marker").length&&(i=n(e(a),i))}return i}(t.$el,0)
...
if(v){if(m&&(!g||g!=v)){var y=t.node.blockParent(m),b=t.node.blockParent(v),E=!1,T=!1
if(y&&0<=["UL","OL"].indexOf(y.tagName)&&(E=!(y=null)),b&&0<=["UL","OL"].indexOf(b.tagName)&&(T=!(b=null)),e(m).after(v),y!=b)if(null!=y||E)if(null!=b||T||0!==e(y).parentsUntil(t.$el,"table").length)y&&b&&0===e(y).parentsUntil(t.$el,"table").length&&0===e(b).parentsUntil(t.$el,"table").length&&0===e(y).find(b).length&&0===e(b).find(y).length&&(e(y).append(e(b).html()),e(b).remove())
else{for(g=y;!g.nextSibling&&g.parentNode!=t.el;)g=g.parentNode
for(g=g.nextSibling;g&&"BR"!=g.tagName;){var _=g.nextSibling
e(y).append(g),g=_}g&&"BR"==g.tagName&&e(g).remove()}else{var A=t.node.deepestParent(m)
A?(e(A).after(e(b).html()),e(b).remove()):0===e(b).parentsUntil(t.$el,"table").length&&(e(m).next().after(e(b).html()),e(b).remove())}}}else v=e(m).clone().attr("data-type",!1),e(m).after(v)}}t.$el.find("li:empty").remove(),t.opts.keepFormatOnDelete||t.html.fillEmptyBlocks(),t.html.cleanEmptyTags(!0),t.opts.htmlUntouched||(t.clean.lists(),t.$el.find("li:empty").append("<br>"),t.spaces.normalize())
...
for(n=0;n<l.length;n++){var u,c=l[n],p=s(c.startContainer,c.startOffset),f=s(c.endContainer,c.endOffset);(t.node.isBlock(p)||t.node.hasClass(p,"fr-inner"))&&o.indexOf(p)<0&&o.push(p),(u=t.node.blockParent(p))&&o.indexOf(u)<0&&o.push(u)
for(var d=[],m=p;m!==f&&m!==t.el;)d.indexOf(m)<0&&m.children&&m.children.length?(d.push(m),m=m.children[0]):m.nextSibling?m=m.nextSibling:m.parentNode&&(m=m.parentNode,d.push(m)),t.node.isBlock(m)&&d.indexOf(m)<0&&o.indexOf(m)<0&&(m!==f||0<c.endOffset)&&o.push(m)
t.node.isBlock(f)&&o.indexOf(f)<0&&0<c.endOffset&&o.push(f),(u=t.node.blockParent(f))&&o.indexOf(u)<0&&o.push(u)}}for(n=o.length-1;0<n;n--)e(o[n]).find(o).length&&o.splice(n,1)
...
for(l=t.node.contents(o),i=0;i<l.length;i++)s+=a(l[i])}return s}function f(e,n,r){l=[]
...
if("PRE"==s.tagName&&0<=(l=(a=s).innerHTML).indexOf("\n")&&(a.innerHTML=l.replace(/\n/g,"<br>")),s.nodeType==Node.ELEMENT_NODE&&(s.getAttribute("data-fr-src")&&0!==s.getAttribute("data-fr-src").indexOf("blob:")&&s.setAttribute("data-fr-src",t.helpers.sanitizeURL(d(s.getAttribute("data-fr-src")))),s.getAttribute("href")&&s.setAttribute("href",t.helpers.sanitizeURL(d(s.getAttribute("href")))),s.getAttribute("src")&&s.setAttribute("src",t.helpers.sanitizeURL(d(s.getAttribute("src")))),s.getAttribute("data")&&s.setAttribute("data",t.helpers.sanitizeURL(d(s.getAttribute("data")))),0<=["TABLE","TBODY","TFOOT","TR"].indexOf(s.tagName)&&(s.innerHTML=s.innerHTML.trim())),!t.opts.pasteAllowLocalImages&&s.nodeType==Node.ELEMENT_NODE&&"IMG"==s.tagName&&s.getAttribute("data-fr-src")&&0===s.getAttribute("data-fr-src").indexOf("file://"))return s.parentNode.removeChild(s)
...
else if(s.tagName&&!s.tagName.match(n))"svg"===s.tagName?s.parentNode.removeChild(s):t.browser.safari&&"path"==s.tagName&&s.parentNode&&"svg"==s.parentNode.tagName||(t.browser.safari?s.replaceWith(s.innerHTML):s.outerHTML=s.innerHTML)
else{var f=s.attributes
if(f)for(var h=f.length-1;0<=h;h--){var m=f[h],g=m.nodeName.match(i),v=null
...
var d=e.merge([],t.opts.htmlAllowedAttrs)
for(c=0;c<l.length;c++)0<=d.indexOf(l[c])&&d.splice(d.indexOf(l[c]),1)
return d.push("data-fr-.*"),d.push("fr-.*"),n=new RegExp("^"+p.join("$|^")+"$","gi"),i=new RegExp("^"+d.join("$|^")+"$","gi"),r=new RegExp("^"+t.opts.htmlRemoveTags.join("$|^")+"$","gi"),o=t.opts.htmlAllowedStyleProps.length?new RegExp("((^|;|\\s)"+t.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)")+":.+?(?=(;)|$))","gi"):null,f(s,h,!0)},toHTML5:function(){var n=t.el.querySelectorAll(Object.keys(e.FE.HTML5Map).join(","))
if(n.length){var r=!1
...
o&&"BR"!=o.tagName&&e(i.previousSibling).remove()}}}(),function(){for(var n=t.el.querySelectorAll("li:empty"),r=0;r<n.length;r++)e(n[r]).remove()}()},invisibleSpaces:function(e){return e.replace(/\u200b/g,"").length==e.length?e:t.clean.exec(e,s)},exec:f}},e.FE.MODULES.spaces=function(t){function n(n,r){var i=n.previousSibling,o=n.nextSibling,s=n.textContent,a=n.parentNode
if(!t.html.isPreformatted(a)){r&&(s=s.replace(/[\f\n\r\t\v ]{2,}/g," "),o&&"BR"!==o.tagName&&!t.node.isBlock(o)||!(t.node.isBlock(a)||t.node.isLink(a)&&!a.nextSibling||t.node.isElement(a))||(s=s.replace(/[\f\n\r\t\v ]{1,}$/g,"")),i&&"BR"!==i.tagName&&!t.node.isBlock(i)||!(t.node.isBlock(a)||t.node.isLink(a)&&!a.previousSibling||t.node.isElement(a))||(s=s.replace(/^[\f\n\r\t\v ]{1,}/g,""))," "!==s||!(i&&t.node.isVoid(i)||o&&t.node.isVoid(o))||i&&o&&t.node.isVoid(i)&&t.node.isVoid(o)||(s="")),(!i&&t.node.isBlock(o)||!o&&t.node.isBlock(i))&&t.node.isBlock(a)&&a!==t.el&&(s=s.replace(/^[\f\n\r\t\v ]{1,}/g,"")),r||(s=s.replace(new RegExp(e.FE.UNICODE_NBSP,"g")," "))
for(var l="",u=0;u<s.length;u++)32!=s.charCodeAt(u)||0!==u&&32!=l.charCodeAt(u-1)||i&&o&&t.node.isVoid(i)&&t.node.isVoid(o)?l+=s[u]:l+=e.FE.UNICODE_NBSP;(!o||o&&t.node.isBlock(o)||o&&o.nodeType==Node.ELEMENT_NODE&&t.win.getComputedStyle(o)&&"block"==t.win.getComputedStyle(o).display)&&(l=l.replace(/ $/,e.FE.UNICODE_NBSP)),!i||t.node.isVoid(i)||t.node.isBlock(i)||1!==(l=l.replace(/^\u00A0([^ $])/," $1")).length||160!==l.charCodeAt(0)||!o||t.node.isVoid(o)||t.node.isBlock(o)||(l=" "),r||(l=l.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g,"$1 $2")),n.textContent!=l&&(n.textContent=l)}}function r(e,r){if(void 0!==e&&e||(e=t.el),void 0===r&&(r=!1),!e.getAttribute||"false"!=e.getAttribute("contenteditable"))if(e.nodeType==Node.TEXT_NODE)n(e,r)
...
var p=o()
for(p+=","+e.FE.VOID_ELEMENTS.join(","),p+=", .fr-inner",p+=","+t.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),")+":not(.fr-marker)",r=s.length-1;0<=r;r--)if(!(s[r].textContent&&0<s[r].textContent.replace(/\u200B|\n/g,"").length||0<s[r].querySelectorAll(p).length)){for(var f=t.node.contents(s[r]),d=!1,h=0;h<f.length;h++)if(f[h].nodeType!=Node.COMMENT_NODE&&f[h].textContent&&0<f[h].textContent.replace(/\u200B|\n/g,"").length){d=!0
break}d||i.push(s[r])}return i}function o(){return e.FE.BLOCK_TAGS.join(", ")}function s(n){var r,i,o=e.merge([],e.FE.VOID_ELEMENTS)
...
else{var p=l.textContent
l.nodeType!==Node.TEXT_NODE||0<p.replace(/\n/g,"").replace(/(^ *)|( *$)/g,"").length||p.replace(/(^ *)|( *$)/g,"").length&&p.indexOf("\n")<0?(null==s&&(s=t.doc.createElement(i),u=!0,r&&s.setAttribute("class","fr-temp-div"),o.appendChild(s),a=!1),s.appendChild(l.cloneNode(!0)),a||t.node.hasClass(l,"fr-marker")||l.nodeType==Node.TEXT_NODE&&0===p.replace(/ /g,"").length||(a=!0)):u=!0}l=c}u&&(e.innerHTML="",e.appendChild(o))}}function l(e,t){for(var n=e.length-1;0<=n;n--)a(e[n],t)}function u(e,n,r,i,o){if(!t.$wp)return!1
...
return r?r[n]:null}function f(e){var t=e.doctype,n="<!DOCTYPE html>"
...
if(o)return!1
i&&r&&"BR"!=i.tagName&&!t.node.isBlock(i)&&!o&&0<r.textContent.replace(/\u200B/g,"").length&&0<i.textContent.length&&!t.node.hasClass(i,"fr-marker")&&(t.el==r&&!o&&t.opts.enter==e.FE.ENTER_BR&&t.browser.msie||n.parentNode.removeChild(n))}else!r||t.node.isBlock(r)||t.node.isElement(r)||n.previousSibling||n.nextSibling||!t.node.isDeletable(n.parentNode)||d(n.parentNode)}function h(){t.opts.htmlUntouched||(s(),u(),c(),t.spaces.normalize(null,!0),t.html.fillEmptyBlocks(),t.clean.lists(),t.clean.tables(),t.clean.toHTML5(),t.html.cleanBRs()),t.selection.restore(),m(),t.placeholder.refresh()}function m(){t.node.isEmpty(t.el)&&(null!=n()?t.el.querySelector(o())||t.el.querySelector(t.opts.htmlDoNotWrapTags.join(":not(.fr-marker),")+":not(.fr-marker)")||(t.core.hasFocus()?(t.$el.html("<"+n()+">"+e.FE.MARKERS+"<br/></"+n()+">"),t.selection.restore()):t.$el.html("<"+n()+"><br/></"+n()+">")):t.el.querySelector("*:not(.fr-marker):not(br)")||(t.core.hasFocus()?(t.$el.html(e.FE.MARKERS+"<br/>"),t.selection.restore()):t.$el.html("<br/>")))}function g(e,t){return p(e,"<"+t+"[^>]*?>([\\w\\W]*)</"+t+">",1)}function v(n,r){var i=e("<div "+(p(n,"<"+r+"([^>]*?)>",1)||"")+">")
return t.node.rawAttributes(i.get(0))}function y(e){return(p(e,"<!DOCTYPE([^>]*?)>",0)||"<!DOCTYPE html>").replace(/\n/g," ").replace(/ {2,}/g," ")}function b(e,n){t.opts.htmlExecuteScripts?e.html(n):e.get(0).innerHTML=n}function E(e){var t
...
""===i.getAttribute("class")&&i.removeAttribute("class"),""===i.getAttribute("style")&&i.removeAttribute("style")}if("BR"===e.tagName)d(e)
...
a.length&&a[a.length-1].nodeType==Node.TEXT_NODE&&t.$el.append("<br>")}},cleanEmptyTags:s,cleanWhiteTags:C,cleanBlankSpaces:c,blocks:function(){return t.$el.get(0).querySelectorAll(o())},getDoctype:f,set:function(n){var r,i,o,s=t.clean.html((n||"").trim(),[],[],t.opts.fullPage)
...
var f=y(s),d=v(s,"html")
b(t.$el,p+"\n"+a),t.node.clearAttributes(t.el),t.$el.attr(l),t.$el.addClass("fr-view"),t.$el.attr("spellcheck",t.opts.spellcheck),t.$el.attr("dir",t.opts.direction),b(t.$head,u),t.node.clearAttributes(t.$head.get(0)),t.$head.attr(c),t.node.clearAttributes(t.$html.get(0)),t.$html.attr(d),t.iframe_document.doctype.parentNode.replaceChild((r=f,i=t.iframe_document,(o=r.match(/<!DOCTYPE ?([^ ]*) ?([^ ]*) ?"?([^"]*)"? ?"?([^"]*)"?>/i))?i.implementation.createDocumentType(o[1],o[3],o[4]):i.implementation.createDocumentType("html")),t.iframe_document.doctype)}else b(t.$el,s)
...
for(i=0;i<t.doc.styleSheets.length;i++){var p,d=0
try{p=t.doc.styleSheets[i].cssRules,t.doc.styleSheets[i].ownerNode&&"STYLE"==t.doc.styleSheets[i].ownerNode.nodeType&&(d=1)}catch(e){}if(p)for(var h=0,m=p.length;h<m;h++)if(p[h].selectorText&&0<p[h].style.cssText.length){var g,v=p[h].selectorText.replace(/body |\.fr-view /g,"").replace(/::/g,":")
...
for(var y=1e3*d+E(p[h].selectorText),b=p[h].style.cssText.split(";"),A=0;A<b.length;A++){var C=b[A].trim().split(":")[0]
if(C&&!C.match(c)&&(a[g[o]][C]||(a[g[o]][C]=0)<=(g[o].getAttribute("fr-original-style")||"").indexOf(C+":")&&(a[g[o]][C]=1e4),y>=a[g[o]][C]&&(a[g[o]][C]=y,b[A].trim().length))){var S=b[A].trim().split(":")
S.splice(0,1),l.push([g[o],C.trim(),S.join(":").trim(),y])}}}}}for(l.sort(_),i=0;i<l.length;i++){var R=l[i]
...
O.splice(0,1),s[i].style[x.trim()]=O.join(":").trim()}}}if(t.node.isEmpty(t.el))t.opts.fullPage&&(r=f(t.iframe_document),r+="<html"+t.node.attributes(t.$html.get(0))+">"+t.$html.find("head").get(0).outerHTML+"<body></body></html>")
else if(void 0===e&&(e=!1),t.opts.fullPage){r=f(t.iframe_document),t.$el.removeClass("fr-view")
...
l.outerHTML=o}else l.outerHTML=o}else t.el.innerHTML=t.el.innerHTML+o}h(),t.keys.positionCaret(),t.events.trigger("html.inserted")},wrap:u,unwrap:function(){t.$el.find("div.fr-temp-div").each(function(){this.previousSibling&&this.previousSibling.nodeType===Node.TEXT_NODE&&e(this).before("<br>"),e(this).attr("data-empty")||!this.nextSibling||t.node.isBlock(this.nextSibling)&&!e(this.nextSibling).hasClass("fr-temp-div")?e(this).replaceWith(e(this).html()):e(this).replaceWith(e(this).html()+"<br>")}),t.$el.find(".fr-temp-div").removeClass("fr-temp-div").filter(function(){return""===e(this).attr("class")}).removeAttr("class")},escapeEntities:function(e){return e.replace(/</gi,"&lt;").replace(/>/gi,"&gt;").replace(/"/gi,"&quot;").replace(/'/gi,"&#39;")},checkIfEmpty:m,extractNode:g,extractNodeAttrs:v,extractDoctype:y,cleanBRs:function(){for(var e=t.el.getElementsByTagName("br"),n=0;n<e.length;n++)d(e[n])},_init:function(){if(t.$wp){var e=function(){C(),t.placeholder&&setTimeout(t.placeholder.refresh,0)}
...
if(t.node.isEmpty(s,!0)&&a){for(var c="",p="",f=i.parentNode;!t.node.isList(f)&&f.parentNode&&("LI"!==f.parentNode.tagName||f.parentNode===s);)c=t.node.openTagString(f)+c,p+=t.node.closeTagString(f),f=f.parentNode
c=t.node.openTagString(f)+c,p+=t.node.closeTagString(f)
var d
for(d=f.parentNode&&"LI"==f.parentNode.tagName?p+"<li>"+e.FE.MARKERS+"<br>"+c:u?p+"<"+u+">"+e.FE.MARKERS+"<br></"+u+">"+c:p+e.FE.MARKERS+"<br>"+c;["UL","OL"].indexOf(f.tagName)<0||f.parentNode&&"LI"===f.parentNode.tagName;)f=f.parentNode
e(s).replaceWith('<span id="fr-break"></span>')
var h=t.node.openTagString(f)+e(f).html()+t.node.closeTagString(f)
h=h.replace(/<span id="fr-break"><\/span>/g,d),e(f).replaceWith(h),t.$el.find("li:empty").remove()}else if(l&&a||!t.node.isEmpty(s,!0)){for(var m="<br>",g=i.parentNode;g&&"LI"!=g.tagName;)m=t.node.openTagString(g)+m+t.node.closeTagString(g),g=g.parentNode
e(s).before("<li>"+m+"</li>"),e(i).remove()}else if(l){o=r(s)
for(var v=e.FE.MARKERS+"<br>",y=i.parentNode;y&&"LI"!=y.tagName;)v=t.node.openTagString(y)+v+t.node.closeTagString(y),y=y.parentNode
...
a=t.node.openTagString(e(s).clone().addClass(u).get(0))+a,l=t.node.closeTagString(s)+l}o=l+o+a+e.FE.MARKERS+(t.opts.keepFormatOnDelete?e.FE.INVISIBLE_SPACE:""),e(r).replaceWith('<span id="fr-break"></span>')
...
1<(a=t.node.contents(s)).length&&"BR"===a[a.length-1].tagName&&e(a[a.length-1]).remove(),e(o).remove()}else{var c=r(o)
if(e(i).replaceWith(e.FE.MARKERS),c.parentNode&&"LI"==c.parentNode.tagName){var p=c.previousSibling
t.node.isBlock(p)?(e(o).find(t.html.blockTagsQuery()).not("ol, ul, table").each(function(){this.parentNode==o&&e(this).replaceWith(e(this).html()+(t.node.isEmpty(this)?"":"<br>"))}),e(p).append(e(o).html())):e(c).before(e(o).html())}else{var f=t.html.defaultTag()
f&&0===e(o).find(t.html.blockTagsQuery()).length?e(c).before("<"+f+">"+e(o).html()+"</"+f+">"):e(c).before(e(o).html())}e(o).remove(),t.html.wrap(),0===e(c).find("li").length&&e(c).remove()}},_del:function(r){var i,o=n(r),s=o.nextSibling
...
for(;p&&"BR"!==p.tagName&&!t.node.isBlock(p);){var f=p
p=p.nextSibling,e(i).append(f)}p&&"BR"==p.tagName&&e(p).remove(),e(n).remove()}else n.nextSibling&&"BR"==n.nextSibling.tagName&&e(n.nextSibling).remove()}function u(n){var r=0<e(n).parentsUntil(t.$el,"BLOCKQUOTE").length,i=t.node.deepestParent(n,[],!r)
...
if(a&&"BLOCKQUOTE"==a.tagName)return o(n,a)?(s=t.html.defaultTag(),r?e(n).replaceWith("<br>"+e.FE.MARKERS):s?e(a).after("<"+s+">"+e.FE.MARKERS+"<br></"+s+">"):e(a).after(e.FE.MARKERS+"<br>"),e(n).remove()):f(n,r,i),!1
...
"PRE"!=a.tagName||n.nextSibling||(r=!0),t.node.isBlock(a)&&!r||(u="<br/>")
var c,p="",d="",h="",m="";(s=t.html.defaultTag())&&t.node.isBlock(a)&&(h="<"+s+">",m="</"+s+">",a.tagName==s.toUpperCase()&&(h=t.node.openTagString(e(a).clone().removeAttr("id").get(0))))
do{if(l=l.parentNode,!r||l!=a||r&&!t.node.isBlock(a))if(p+=t.node.closeTagString(l),l==a&&t.node.isBlock(a))d=h+d
else{var g="A"==l.tagName&&o(n,l)?"fr-to-remove":""
d=t.node.openTagString(e(l).clone().addClass(g).get(0))+d}}while(l!=a)
u=p+u+d+(n.parentNode==a&&t.node.isBlock(a)?"":e.FE.INVISIBLE_SPACE)+e.FE.MARKERS,t.node.isBlock(a)&&!e(a).find("*:last").is("br")&&e(a).append("<br/>"),e(n).after('<span id="fr-break"></span>'),e(n).remove(),a.nextSibling&&!t.node.isBlock(a.nextSibling)||t.node.isBlock(a)||e(a).after("<br>"),c=(c=!r&&t.node.isBlock(a)?t.node.openTagString(a)+e(a).html()+m:t.node.openTagString(a)+e(a).html()+t.node.closeTagString(a)).replace(/<span id="fr-break"><\/span>/g,u),e(a).replaceWith(c)}}function f(n,r,s){var a=t.node.deepestParent(n,[],!s)
...
var c="",p=""
do{var f=l
if(l=l.parentNode,"BLOCKQUOTE"==a.tagName&&t.node.isEmpty(f)&&!t.node.hasClass(f,"fr-marker")&&0<e(f).find(n).length&&e(f).after(n),"BLOCKQUOTE"!=a.tagName||!o(n,l)&&!i(n,l))if(!r||l!=a||r&&!t.node.isBlock(a)){c+=t.node.closeTagString(l)
var d="A"==l.tagName&&o(n,l)?"fr-to-remove":""
p=t.node.openTagString(e(l).clone().addClass(d).removeAttr("id").get(0))+p}else"BLOCKQUOTE"==a.tagName&&r&&(p=c="")}while(l!=a)
var h=a==n.parentNode&&t.node.isBlock(a)||n.nextSibling
if("BLOCKQUOTE"==a.tagName)if(n.previousSibling&&t.node.isBlock(n.previousSibling)&&n.nextSibling&&"BR"==n.nextSibling.tagName&&(e(n.nextSibling).after(n),n.nextSibling&&"BR"==n.nextSibling.tagName&&e(n.nextSibling).remove()),r)u=c+u+e.FE.MARKERS+p
...
t.el.normalize()
var u=!1
0<e(l).parentsUntil(t.$el,"BLOCKQUOTE").length&&(u=!0),e(l).parentsUntil(t.$el,"TD, TH").length&&(u=!1),n(l)?!s(l)||a||u?p(l,a,u):t.cursorLists._endEnter(l):r(l)?!s(l)||a||u?function n(r,s,a){var l,u=t.node.deepestParent(r,[],!a)
if(u&&"TABLE"==u.tagName)return e(u).find("td:first, th:first").prepend(r),n(r,s,a)
if(u&&"BLOCKQUOTE"==u.tagName)if(i(r,u)){if(!s)return(l=t.html.defaultTag())?e(u).before("<"+l+">"+e.FE.MARKERS+"<br></"+l+">"):e(u).before(e.FE.MARKERS+"<br>"),e(r).remove(),!1}else o(r,u)?p(r,s,!0):f(r,s,!0)
...
if(t.opts.keepFormatOnDelete){for(var c=r,d=e.FE.INVISIBLE_SPACE;c!=u&&!t.node.isElement(c);)c=c.parentNode,d=t.node.openTagString(c)+d+t.node.closeTagString(c)
e(u).before(d)}else e(u).before(t.node.openTagString(e(u).clone().removeAttr("id").get(0))+"<br>"+t.node.closeTagString(u))}else e(u).before("<br>")
e(r).remove()}}(l,a,u):t.cursorLists._startEnter(l):!s(l)||a||u?f(l,a,u):t.cursorLists._middleEnter(l),t.$el.find(".fr-to-remove").each(function(){for(var n=t.node.contents(this),r=0;r<n.length;r++)n[r].nodeType==Node.TEXT_NODE&&(n[r].textContent=n[r].textContent.replace(/\u200B/g,""))
...
else if("BLOCKQUOTE"!=l.tagName&&"BLOCKQUOTE"==o.tagName)for(a=t.node.contents(o);a.length&&t.node.isBlock(a[0]);)o=a[0],a=t.node.contents(o)
...
if(r&&g(r.which))return d(),!0
t.events.disableBlur()
var s=r.which
if(16===s)return!0
if((n=s)===e.FE.KEYCODE.IME)return o=!0
o=!1
var a,l,u,p=v(s)&&!m(r)&&!r.altKey,f=s==e.FE.KEYCODE.BACKSPACE||s==e.FE.KEYCODE.DELETE
if(((!r.shiftKey||33!==s&&34!==s&&35!==s&&36!==s)&&t.selection.isFull()&&!t.opts.keepFormatOnDelete&&!t.placeholder.isVisible()||f&&t.placeholder.isVisible()&&t.opts.keepFormatOnDelete)&&(p||f)&&(c(),!v(s)))return r.preventDefault(),!0
s==e.FE.KEYCODE.ENTER?r.shiftKey?((u=r).preventDefault(),u.stopPropagation(),t.opts.multiLine&&(t.selection.isCollapsed()||t.selection.remove(),t.cursor.enter(!0))):(l=r,t.opts.multiLine?(t.helpers.isIOS()||(l.preventDefault(),l.stopPropagation()),t.selection.isCollapsed()||t.selection.remove(),t.cursor.enter()):(l.preventDefault(),l.stopPropagation())):s===e.FE.KEYCODE.BACKSPACE&&(r.metaKey||r.ctrlKey)?setTimeout(function(){t.events.disableBlur(),t.events.focus()},0):s!=e.FE.KEYCODE.BACKSPACE||m(r)||r.altKey?s!=e.FE.KEYCODE.DELETE||m(r)||r.altKey||r.shiftKey?s==e.FE.KEYCODE.SPACE?function(n){var r=t.selection.element()
...
t.placeholder.refresh()}(r),t.events.enableBlur()}function f(){if(!t.$wp)return!0
var n
...
r.textContent=r.textContent.replace(/\u200B/gi,"")}}(n),t.selection.restore())}function h(r){var i=t.selection.element()
if(i&&0<=["INPUT","TEXTAREA"].indexOf(i.tagName))return!0
...
if(r&&!t.helpers.isIOS()&&(r.which==e.FE.KEYCODE.ENTER||r.which==e.FE.KEYCODE.BACKSPACE||37<=r.which&&r.which<=40&&!t.browser.msie))try{f()}catch(e){}d()}function m(e){if(-1!=navigator.userAgent.indexOf("Mac OS X")){if(e.metaKey&&!e.altKey)return!0}else if(e.ctrlKey&&!e.altKey)return!0
...
default:return!1}}function y(n){var o=n.which
...
return!(!n.target||n.target===t.el)||0===r.length||void(t.$el.outerHeight()-n.offsetY<=10?E(r[r.length-1])&&(i?t.$el.append("<"+i+">"+e.FE.MARKERS+"<br></"+i+">"):t.$el.append(e.FE.MARKERS+"<br>"),t.selection.restore(),f()):n.offsetY<=10&&E(r[0])&&(i?t.$el.prepend("<"+i+">"+e.FE.MARKERS+"<br></"+i+">"):t.$el.prepend(e.FE.MARKERS+"<br>"),t.selection.restore(),f()))}function _(){r&&clearTimeout(r)}return{_init:function(){t.events.on("keydown",y),t.events.on("input",s),t.events.on("mousedown",u),t.events.on("keyup input",b),t.events.on("keypress",l),t.events.on("keydown",p),t.events.on("keyup",h),t.events.on("destroy",_),t.events.on("html.inserted",h),t.events.on("cut",a),t.events.on("click",T)},ctrlKey:m,isCharacter:v,isArrow:g,forceUndo:function(){r&&(clearTimeout(r),t.undo.saveStep(),i=null)},isIME:function(){return o},isBrowserAction:function(t){var n=t.which
return m(t)||n==e.FE.KEYCODE.F5},positionCaret:f}},e.FE.MODULES.accessibility=function(t){var n=!0
...
var c,p=n.find("button:visible:not(.fr-disabled), .fr-group span.fr-command:visible"),f=p.index(t.shared.$f_el)
if(0===f&&!a||f==p.length-1&&a)o&&(n.parent().is(".fr-popup")&&(c=!s(n.parent().children().not(".fr-buttons"),!a)),!1===c&&(t.shared.$f_el=null)),o&&!1===c||i(n,!a)
else r(e(p.get(f+(a?1:-1))))
return!1}}function p(e,t){return c(e,t,!0)}function f(e,t){return c(e,t)}function d(e){if(t.shared.$f_el){var n
...
t&&setTimeout(function(){r(t),e.data("popup-button",null)},0)}function y(e){var n=t.popups.areVisible(e)
n&&n.data("popup-button",null)}function b(n){var r=-1!=navigator.userAgent.indexOf("Mac OS X")?n.metaKey:n.ctrlKey
if(n.which==e.FE.KEYCODE.F10&&!r&&!n.shiftKey&&n.altKey){t.shared.with_kb=!0
var i=t.popups.areVisible(t),o=!1
return i&&(o=s(i.children().not(".fr-buttons"))),o||l(),t.shared.with_kb=!1,n.preventDefault(),n.stopPropagation(),!1}return!0}return{_init:function(){t.$wp?t.events.on("keydown",b,!0):t.events.$on(t.$win,"keydown",b,!0),t.events.on("mousedown",function(e){y(t),t.shared.$f_el&&(t.accessibility.restoreSelection(),e.stopPropagation(),t.events.disableBlur(),t.shared.$f_el=null)},!0),t.events.on("blur",function(){t.shared.$f_el=null,y(t)},!0)},registerPopup:function(r){var o,a,l=t.popups.get(r),u=(o=r,a=t.popups.get(o),{_tiKeydown:function(n){var r=a.data("instance")||t
if(!1===r.events.trigger("popup.tab",[n]))return!1
var l=n.which,u=a.find(":focus:first")
if(e.FE.KEYCODE.TAB==l){n.preventDefault()
var c=a.children().not(".fr-buttons"),p=c.find("input, textarea, button, select").filter(":visible").not(".fr-no-touch input, .fr-no-touch textarea, .fr-no-touch button, .fr-no-touch select, :disabled").toArray(),f=p.indexOf(this)+(n.shiftKey?-1:1)
if(0<=f&&f<p.length)return r.events.disableBlur(),e(p[f]).focus(),n.stopPropagation(),!1
var d=a.find(".fr-buttons")
if(d.length&&i(d,!!n.shiftKey))return n.stopPropagation(),!1
...
var h=null
0<a.find(".fr-submit:visible").length?h=a.find(".fr-submit:visible:first"):a.find(".fr-dismiss:visible").length&&(h=a.find(".fr-dismiss:visible:first")),h&&(n.preventDefault(),n.stopPropagation(),r.events.disableBlur(),r.button.exec(h))}},_tiMouseenter:function(){y(a.data("instance")||t)}})
...
if(t.node.isBlock(l)&&"HR"!==r.tagName)return o(l.firstChild,i,s),!1
...
if(c){for(var p=c.nextSibling;"BR"===p.tagName;)p=p.nextSibling
...
var f=c.html().replace(/<span id="mark"><\/span>/,l+t.node.closeTagString(c.get(0))+u+p+l+t.node.openTagString(c.get(0))+u)
return c.replaceWith(t.node.openTagString(c.get(0))+f+t.node.closeTagString(c.get(0))),!0}return!1}function l(n,o){void 0===o&&(o={}),o.style&&delete o.style
var s=t.selection.isCollapsed()
t.selection.save()
for(var l=!0;l;){l=!1
for(var u=t.$el.find(".fr-marker"),c=0;c<u.length;c++){var p=e(u[c]),f=null
if(p.attr("data-cloned")||s||(f=p.clone().removeClass("fr-marker").addClass("fr-clone"),!0===p.data("type")?p.attr("data-cloned",!0).after(f):p.attr("data-cloned",!0).before(f)),a(p,n,o,s)){l=!0
...
else{for(var f=e(p).find(a||"*:not(a):not(br)"),d=f.length-1;0<=d;d--){var h=f[d]
t.node.isBlock(h)||t.node.isVoid(h)||void 0!==a&&!i(h,r(a,l))?t.node.isBlock(h)&&void 0===a&&"TABLE"!=p.tagName&&t.node.clearAttributes(h):t.node.hasClass(h,"fr-clone")||(h.outerHTML=h.innerHTML)}void 0===a&&p.nodeType==Node.ELEMENT_NODE&&!t.node.isVoid(p)||i(p,r(a,l))?t.node.isBlock(p)||e(p).replaceWith(p.innerHTML):void 0===a&&p.nodeType==Node.ELEMENT_NODE&&t.node.isBlock(p)&&"TABLE"!=p.tagName&&t.node.clearAttributes(p)}else 0<e(p).find(".fr-marker").length&&(s=n(e(p),s,a,l))}return s}(t.$el,0,n,o),s||(t.$el.find(".fr-marker").remove(),t.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),s&&t.$el.find(".fr-marker").before(e.FE.INVISIBLE_SPACE).after(e.FE.INVISIBLE_SPACE),t.html.cleanEmptyTags(),t.el.normalize(),t.selection.restore()}function u(n,r){var i,s,l,u,p,f=null
if(t.selection.isCollapsed()){t.markers.insert()
var d=(s=t.$el.find(".fr-marker")).parent()
if(t.node.openTagString(d.get(0))=='<span style="'+n+": "+d.css(n)+';">'){if(t.node.isEmpty(d.get(0)))f=e('<span style="'+n+": "+r+';">'+e.FE.INVISIBLE_SPACE+e.FE.MARKERS+"</span>"),d.replaceWith(f)
else{var h={}
h["style*"]=n+":",a(s,"span",h,!0),s=t.$el.find(".fr-marker"),r?(f=e('<span style="'+n+": "+r+';">'+e.FE.INVISIBLE_SPACE+e.FE.MARKERS+"</span>"),s.replaceWith(f)):s.replaceWith(e.FE.INVISIBLE_SPACE+e.FE.MARKERS)}t.html.cleanEmptyTags()}else t.node.isEmpty(d.get(0))&&d.is("span")?(s.replaceWith(e.FE.MARKERS),d.css(n,r)):(f=e('<span style="'+n+": "+r+';">'+e.FE.INVISIBLE_SPACE+e.FE.MARKERS+"</span>"),s.replaceWith(f))
f&&c(f,n,r)}else{if(t.selection.save(),null==r||"color"==n&&0<t.$el.find(".fr-marker").parents("u, a").length){var m=t.$el.find(".fr-marker")
...
else for(;t.node.isLastSibling(s.get(0))&&!s.parent().is(t.$el)&&!t.node.isElement(s.parent().get(0))&&!t.node.isBlock(s.parent().get(0));)s.parent().after(s)}for(var g=t.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling;g.firstChild;)g=g.firstChild
var v={class:"fr-unprocessed"}
for(r&&(v.style=n+": "+r+";"),o(g,"span",v),t.$el.find(".fr-marker + .fr-unprocessed").each(function(){e(this).prepend(e(this).prev())}),t.$el.find(".fr-unprocessed + .fr-marker").each(function(){e(this).prev().append(this)}),(r||"").match(/\dem$/)&&t.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");0<t.$el.find("span.fr-unprocessed").length;){if((f=t.$el.find("span.fr-unprocessed:first").removeClass("fr-unprocessed")).parent().get(0).normalize(),f.parent().is("span")&&1==f.parent().get(0).childNodes.length){f.parent().css(n,r)
var y=f
f=f.parent(),y.replaceWith(y.html())}var b=f.find("span")
for(i=b.length-1;0<=i;i--)l=b[i],u=n,p=void 0,(p=e(l)).css(u,""),""===p.attr("style")&&p.replaceWith(p.html())
c(f,n,r)}}!function(){for(var n;0<t.$el.find(".fr-split:empty").length;)t.$el.find(".fr-split:empty").remove()
...
if((l=l.not(u)).length){for(var c="",p="",f="",d="",h=n.get(0);h=h.parentNode,e(h).addClass("fr-split"),c+=t.node.closeTagString(h),p=t.node.openTagString(e(h).clone().addClass("fr-split").get(0))+p,l.get(0)!=h&&(f+=t.node.closeTagString(h),d=t.node.openTagString(e(h).clone().addClass("fr-split").get(0))+d),l.get(0)!=h;);var m=c+t.node.openTagString(e(l.get(0)).clone().css(r,i||"").get(0))+d+n.css(r,"").get(0).outerHTML+f+"</span>"+p
...
return n<0&&(e+=123),e}function c(e){return!(!e||"block"===e.css("display")||(e.remove(),0))}function p(e){return e&&0===t.$box.find(e).length}var f=0
function d(){if(10<f&&(t[i(a("0ppecjvc=="))](),setTimeout(function(){e.FE=null},10)),!t.$box)return!1
t.$wp.prepend(a(i(a(n)))),o=t.$wp.find("> div:first"),s=o.find("> a"),"rtl"==t.opts.direction&&o.css("left","auto").css("right",0).attr("direction","rtl"),f++}function h(e){for(var t=[a("9qqG-7amjlwq=="),a("KA3B3C2A6D1D5H5H1A3=="),a("3B9B3B5F3C4G3E3=="),a("QzbzvxyB2yA-9m=="),a("ji1kacwmgG5bc=="),a("nmA-13aogi1A3c1jd=="),a("BA9ggq=="),a("emznbjbH3fij=="),a("tkC-22d1qC-13sD1wzF-7==")],n=0;n<t.length;n++)if(String.prototype.endsWith||(String.prototype.endsWith=function(e,t){return(void 0===t||t>this.length)&&(t=this.length),this.substring(t-e.length,t)===e}),e.endsWith(t[n]))return!0
...
n=null}return t.selection.save(),t.events.disableBlur(),n=null,i?(i.html(""),t.browser.edge&&t.opts.iframe&&t.$el.append(i)):(i=e('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'),t.browser.webkit?(i.css("top",t.$sc.scrollTop()),t.$el.after(i)):t.browser.edge&&t.opts.iframe?t.$el.append(i):t.$box.after(i),t.events.on("destroy",function(){i.remove()})),t.helpers.isIOS()||i.focus(),t.win.setTimeout(p,1),!1}function c(i){if(i.originalEvent&&(i=i.originalEvent),i&&i.dataTransfer&&i.dataTransfer.getData){var s="",a=i.dataTransfer.types
...
r&&"string"==typeof r&&(n=r),(!e||e&&!1!==t.events.trigger("paste.wordPaste",[n]))&&d(n,e)}function f(e){for(var t="",n=0;n++<e;)t+="&nbsp;"
return t}function d(n,r,i){var s,a=null,l=null
...
try{r=t.win.localStorage.getItem("fr-copied-text")}catch(e){}return!(!r||e("<div>").html(n).text().replace(/\u00A0/gi," ").replace(/\r|\n/gi,"")!=r.replace(/\u00A0/gi," ").replace(/\r|\n/gi,""))}(n))&&(n=t.win.localStorage.getItem("fr-copied-html")),!p)){var d=t.opts.htmlAllowedStyleProps
t.opts.htmlAllowedStyleProps=t.opts.pasteAllowedStyleProps,t.opts.htmlAllowComments=!1,n=(n=(n=n.replace(/<span class="Apple-tab-span">\s*<\/span>/g,f(t.opts.tabSpaces||4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g,function(e,n){return f(n.length*(t.opts.tabSpaces||4))})).replace(/\t/g,f(t.opts.tabSpaces||4)),n=t.clean.html(n,t.opts.pasteDeniedTags,t.opts.pasteDeniedAttrs),t.opts.htmlAllowedStyleProps=d,t.opts.htmlAllowComments=!0,n=(n=(n=m(n)).replace(/\r/g,"")).replace(/^ */g,"").replace(/ *$/g,"")}!r||t.wordPaste&&i||(0===(n=n.replace(/^\n*/g,"").replace(/^ /g,"")).indexOf("<colgroup>")&&(n="<table>"+n+"</table>"),n=m(n=function(e){var n
...
for(s=v.length-1;0<=s;s--){var y=v[s]
0===y.attributes.length&&(y.outerHTML=y.innerHTML)}var b=t.selection.element(),E=!1
if(b&&e(b).parentsUntil(t.el,"ul, ol").length&&(E=!0),E){var T=g.children
...
r.length&&(r.removeClass("fr-active").attr("aria-expanded",!1).next().attr("aria-hidden",!0),r.prev(".fr-expanded").removeClass("fr-expanded"),r.parent(".fr-toolbar:not(.fr-inline)").css("zIndex","")),e.parents(".fr-popup, .fr-toolbar").data("instance").commands.exec(t,n)}function a(n){var r=n.parents(".fr-popup, .fr-toolbar").data("instance")
...
t.length&&(t.removeClass("fr-active").attr("aria-expanded",!1).next().attr("aria-hidden",!0),t.parent(".fr-toolbar:not(.fr-inline)").css("zIndex",""),t.prev().removeClass("fr-expanded"))}function c(e){e.preventDefault(),e.stopPropagation()}function p(e){if(e.stopPropagation(),!t.helpers.isMobile())return!1}function f(e,n,r){if(t.helpers.isMobile()&&!1===n.showOnMobile)return""
var i=n.displaySelection
"function"==typeof i&&(i=i(t))
var o=""
if("options"!==n.type)if(i){var s="function"==typeof n.defaultSelection?n.defaultSelection(t):n.defaultSelection
o='<span style="width:'+(n.displaySelectionWidth||100)+'px">'+t.language.translate(s||n.title)+"</span>"}else o=t.icon.create(n.icon||e),o+='<span class="fr-sr-only">'+(t.language.translate(n.title)||"")+"</span>"
var a=n.popup?' data-popup="true"':"",l=n.modal?' data-modal="true"':"",u=t.shortcuts.get(e+".")
u=u?" ("+u+")":""
var c=e+"-"+t.id,p="dropdown-menu-"+c,d='<button id="'+c+'"type="button" tabIndex="-1" role="button"'+(n.toggle?' aria-pressed="false"':"")+("dropdown"==n.type||"options"==n.type?' aria-controls="'+p+'" aria-expanded="false" aria-haspopup="true"':"")+(n.disabled?' aria-disabled="true"':"")+' title="'+(t.language.translate(n.title)||"")+u+'" class="fr-command fr-btn'+("dropdown"==n.type||"options"==n.type?" fr-dropdown":"")+("options"==n.type?" fr-options":"")+" fr-btn-"+t.icon.getTemplate(n.icon)+(n.displaySelection?" fr-selection":"")+(n.back?" fr-back":"")+(n.disabled?" fr-disabled":"")+(r?"":" fr-hidden")+'" data-cmd="'+e+'"'+a+l+">"+o+"</button>"
if("dropdown"==n.type||"options"==n.type){var h='<div id="'+p+'" class="fr-dropdown-menu" role="listbox" aria-labelledby="'+c+'" aria-hidden="true"><div class="fr-dropdown-wrapper" role="presentation"><div class="fr-dropdown-content" role="presentation">'
h+=function(e,n){var r=""
...
s=s?'<span class="fr-shortcut">'+s+"</span>":"",r+='<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="'+("options"===n.type?e.replace(/Options/g,""):e)+'" data-param1="'+o+'" title="'+i[o]+'">'+t.language.translate(i[o])+"</a></li>"}r+="</ul>"}return r}(e,n),d+=h+="</div></div></div>"}return n.hasOptions&&n.hasOptions.apply(t)&&(n.type="options",n.hasOptions=!1,d='<div class="fr-btn-wrap">'+d+f(e+"Options",n,r)+"</div>"),d}function d(n){var r=t.$tb&&t.$tb.data("instance")||t
...
0===s.parents(".fr-popup").length?i||e.FE.COMMANDS[a]&&e.FE.COMMANDS[a].forcedRefresh?r.button.refresh(s):t.node.hasClass(s.get(0),"fr-dropdown")||(s.removeClass("fr-active"),s.attr("aria-pressed")&&s.attr("aria-pressed",!1)):s.parents(".fr-popup").is(":visible")&&r.button.refresh(s)}},0)}function h(){d(n),d(r)}function m(){n=[],r=[]}t.shared.popup_buttons||(t.shared.popup_buttons=[]),r=t.shared.popup_buttons
var g=null
...
a&&void 0!==a.plugin&&t.opts.pluginsEnabled.indexOf(a.plugin)<0||(a?i+=f(s,a,void 0===r||0<=r.indexOf(s)):"|"==s?i+='<div class="fr-separator fr-vs" role="separator" aria-orientation="vertical"></div>':"-"==s&&(i+='<div class="fr-separator fr-hs" role="separator" aria-orientation="horizontal"></div>'))}return i},bindCommands:function(i,o){t.events.bindClick(i,".fr-command:not(.fr-disabled)",l),t.events.$on(i,t._mousedown+" "+t._mouseup+" "+t._move,".fr-dropdown-menu",c,!0),t.events.$on(i,t._mousedown+" "+t._mouseup+" "+t._move,".fr-dropdown-menu .fr-dropdown-wrapper",p,!0)
var s=i.get(0).ownerDocument,a="defaultView"in s?s.defaultView:s.parentWindow,f=function(n){(!n||n.type==t._mouseup&&n.target!=e("html").get(0)||"keydown"==n.type&&(t.keys.isCharacter(n.which)&&!t.keys.ctrlKey(n)||n.which==e.FE.KEYCODE.ESC))&&u(i)}
t.events.$on(e(a),t._mouseup+" resize keydown",f,!0),t.opts.iframe&&t.events.$on(t.$win,t._mouseup,f,!0),t.node.hasClass(i.get(0),"fr-popup")?e.merge(r,i.find(".fr-btn").toArray()):e.merge(n,i.find(".fr-btn").toArray()),t.tooltip.bind(i,".fr-btn, .fr-title",o)},refresh:function(n){var r,i=n.parents(".fr-popup, .fr-toolbar").data("instance")||t,o=n.data("cmd")
...
return r==e.FE.KEYCODE.ESC?(o(i),t.accessibility.focusModalButton(l),!1):!(!e(n.target).is("input[type=text], textarea")&&r!=e.FE.KEYCODE.ARROW_UP&&r!=e.FE.KEYCODE.ARROW_DOWN&&!t.keys.isBrowserAction(n)&&(n.preventDefault(),n.stopPropagation(),1))},!0),o(i,!0)}var u,c,p
...
if(i.is("input:file")&&i.closest(".fr-layer").addClass("fr-input-focus"),n.preventDefault(),n.stopPropagation(),setTimeout(function(){r.events.enableBlur()},t.browser.msie?100:0),r.helpers.isMobile()){var s=e(r.o_win).scrollTop()
...
t.node.hasClass(o.get(0),"fr-above")&&(e+=o.outerHeight()),n<e||e<0?o.addClass("fr-hidden"):o.removeClass("fr-hidden")}}}}function f(e,r){t.events.on("mouseup",e._editorMouseup,!0),t.$wp&&t.events.on("keydown",e._editorKeydown),t.events.on("blur",function(){o()&&t.markers.remove(),a()}),t.$wp&&!t.helpers.isMobile()&&t.events.$on(t.$wp,"scroll.popup"+r,e._repositionPopup),t.events.on("window.mouseup",e._windowMouseup,!0),t.events.on("window.keydown",e._windowKeydown,!0),n[r].data("inst"+t.id,!0),t.events.on("destroy",function(){t.core.sameInstance(n[r])&&n[r].removeClass("fr-active").appendTo("body:first")},!0)}function d(){for(var e in n)if(n.hasOwnProperty(e)){var t=n[e]
t&&(t.html("").removeData().remove(),n[e]=null)}n=[]}return t.shared.exit_flag=!1,{_init:function(){t.events.on("shared.destroy",d,!0),t.events.on("window.mousedown",l),t.events.on("window.touchmove",u),t.events.$on(e(t.o_win),"scroll",u),t.events.on("mousedown",function(e){o()&&(e.stopPropagation(),t.$el.find(".fr-marker").remove(),l(),t.events.disableBlur())})},create:function(r,i){var o=function(r,i){var o,s,a=function(n,r){var i=e.FE.POPUP_TEMPLATES[n]
if(!i)return null
...
var p="body"==t.opts.scrollableContainer?t.helpers.scrollTop():u,f=o.is(".fr-sticky-on")
...
var v=a.top&&h<p+r&&p+r<=h+m-s&&(t.helpers.isInViewPort(t.$sc.get(0))||"body"==t.opts.scrollableContainer),y=a.bottom&&h+s<p+l-i&&p+l-i<h+m
v||y?(o.css("width",d.get(0).getBoundingClientRect().width+"px"),f||(o.addClass("fr-sticky-on"),o.removeClass("fr-sticky-off"),o.css("top")&&("auto"!=o.data("top")?o.css("top",t.helpers.getPX(o.data("top"))+u):o.data("top","auto")),o.css("bottom")&&("auto"!=o.data("bottom")?o.css("bottom",t.helpers.getPX(o.data("bottom"))+c):o.css("bottom","auto")))):t.node.hasClass(o.get(0),"fr-sticky-off")||(o.width(""),o.removeClass("fr-sticky-on"),o.addClass("fr-sticky-off"),o.css("top")&&"auto"!=o.data("top")&&a.top&&o.css("top",0),o.css("bottom")&&"auto"!=o.data("bottom")&&a.bottom&&o.css("bottom",0))}}function s(){if(t._stickyElements)for(var e=0;e<t._stickyElements.length;e++)o(t._stickyElements[e])}return{_init:function(){!function(){if(t._stickyElements=[],t.helpers.isIOS()){var n=function(){if(t.helpers.requestAnimationFrame()(n),!1!==t.events.trigger("position.refresh"))for(var e=0;e<t._stickyElements.length;e++)i(t._stickyElements[e])}
...
t.node.hasClass(r.next().get(0),"fr-dropdown-menu")&&(o=r.next()),t.node.hasClass(r.next().get(0),"fr-options")&&(r=r.parent()),r.removeClass("fr-hidden").appendTo(t.$tb),o&&o.appendTo(t.$tb)}}function s(n,r){setTimeout(function(){if((!n||n.which!=e.FE.KEYCODE.ESC)&&t.selection.inEditor()&&t.core.hasFocus()&&!t.popups.areVisible()&&(t.opts.toolbarVisibleWithoutSelection||!t.selection.isCollapsed()&&!t.keys.isIME()||r)){if(t.$tb.data("instance",t),!1===t.events.trigger("toolbar.show",[n]))return!1
...
var l=null
function u(n){clearTimeout(l),n&&n.which==e.FE.KEYCODE.ESC||(l=setTimeout(s,t.opts.typingTimer))}function c(){t.events.on("window.mousedown",a),t.events.on("keydown",a),t.events.on("blur",a),t.helpers.isMobile()||t.events.on("window.mouseup",s),t.helpers.isMobile()?t.helpers.isIOS()||(t.events.on("window.touchend",s),t.browser.mozilla&&setInterval(s,200)):t.events.on("window.keyup",u),t.events.on("keydown",function(t){t&&t.which==e.FE.KEYCODE.ESC&&a()}),t.events.on("keydown",function(t){if(t.which==e.FE.KEYCODE.ALT)return t.stopPropagation(),!1},!0),t.events.$on(t.$wp,"scroll.toolbar",s),t.events.on("commands.after",s),t.helpers.isMobile()&&(t.events.$on(t.$doc,"selectionchange",u),t.events.$on(t.$doc,"orientationchange",s))}function p(){t.$tb.html("").removeData().remove(),t.$tb=null}function f(){t.$box.removeClass("fr-top fr-bottom fr-inline fr-basic"),t.$box.find(".fr-sticky-dummy").remove()}function d(){t.opts.theme&&t.$tb.addClass(t.opts.theme+"-theme"),1<t.opts.zIndex&&t.$tb.css("z-index",t.opts.zIndex+1),"auto"!=t.opts.direction&&t.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-"+t.opts.direction),t.helpers.isMobile()?t.$tb.addClass("fr-mobile"):t.$tb.addClass("fr-desktop"),t.opts.toolbarContainer?(t.opts.toolbarInline&&(c(),a()),t.opts.toolbarBottom?t.$tb.addClass("fr-bottom"):t.$tb.addClass("fr-top")):t.opts.toolbarInline?(t.$sc.append(t.$tb),t.$tb.data("container",t.$sc),t.$tb.addClass("fr-inline"),t.$tb.prepend('<span class="fr-arrow"></span>'),c(),t.opts.toolbarBottom=!1):(t.opts.toolbarBottom&&!t.helpers.isIOS()?(t.$box.append(t.$tb),t.$tb.addClass("fr-bottom"),t.$box.addClass("fr-bottom")):(t.opts.toolbarBottom=!1,t.$box.prepend(t.$tb),t.$tb.addClass("fr-top"),t.$box.addClass("fr-top")),t.$tb.addClass("fr-basic"),t.opts.toolbarSticky&&(t.opts.toolbarStickyOffset&&(t.opts.toolbarBottom?t.$tb.css("bottom",t.opts.toolbarStickyOffset):t.$tb.css("top",t.opts.toolbarStickyOffset)),t.position.addSticky(t.$tb))),function(){var o=e.merge([],i())
...
t.opts.toolbarContainer?(t.shared.$tb?(t.$tb=t.shared.$tb,t.opts.toolbarInline&&c()):(t.shared.$tb=e('<div class="fr-toolbar"></div>'),t.$tb=t.shared.$tb,e(t.opts.toolbarContainer).append(t.$tb),d(),t.$tb.data("instance",t)),t.opts.toolbarInline?t.$box.addClass("fr-inline"):t.$box.addClass("fr-basic"),t.events.on("focus",function(){t.$tb.data("instance",t)},!0),t.opts.toolbarInline=!1):t.opts.toolbarInline?(t.$box.addClass("fr-inline"),t.shared.$tb?(t.$tb=t.shared.$tb,c()):(t.shared.$tb=e('<div class="fr-toolbar"></div>'),t.$tb=t.shared.$tb,d())):(t.$box.addClass("fr-basic"),t.$tb=e('<div class="fr-toolbar"></div>'),d(),t.$tb.data("instance",t)),t.events.on("destroy",f,!0),t.events.on(t.opts.toolbarInline||t.opts.toolbarContainer?"shared.destroy":"destroy",p,!0)},hide:a,show:function(){if(!1===t.events.trigger("toolbar.show"))return!1
...
o=!t.accessibility.focusToolbar(a,!!n.shiftKey)}else if(e.FE.KEYCODE.ARROW_UP==i||e.FE.KEYCODE.ARROW_DOWN==i||e.FE.KEYCODE.ARROW_LEFT==i||e.FE.KEYCODE.ARROW_RIGHT==i){if(r.is("span.fr-select-color")){var l=r.parent().find("span.fr-select-color"),u=l.index(r),c=t.opts.colorsStep,p=Math.floor(l.length/c),f=u%c,d=Math.floor(u/c)*c+f,h=p*c
e.FE.KEYCODE.ARROW_UP==i?d=((d-c)%h+h)%h:e.FE.KEYCODE.ARROW_DOWN==i?d=(d+c)%h:e.FE.KEYCODE.ARROW_LEFT==i?d=((d-1)%h+h)%h:e.FE.KEYCODE.ARROW_RIGHT==i&&(d=(d+1)%h)
var m=e(l.get(d))
...
s=p.index(i)
var f=t.opts.emoticonsStep,d=Math.floor(p.length/f),h=s%f,m=Math.floor(s/f)*f+h,g=d*f
e.FE.KEYCODE.ARROW_UP==l?m=((m-f)%g+g)%g:e.FE.KEYCODE.ARROW_DOWN==l?m=(m+f)%g:e.FE.KEYCODE.ARROW_LEFT==l?m=((m-1)%g+g)%g:e.FE.KEYCODE.ARROW_RIGHT==l&&(m=(m+1)%g),a=e(p.get(m)),t.events.disableBlur(),a.focus(),o=!1}}else e.FE.KEYCODE.ENTER==l&&(i.is("a")?i[0].click():t.button.exec(i),o=!1)
...
function o(r,i){var o,s,a,l,u,c,p,f
...
else if(null==i)(c=(l=r.parent()).offset().top+l.outerHeight())<(f=r.offset().top+r.outerHeight())&&(c=(l=e(l).parent()).offset().top+l.outerHeight()),o=f+Math.min(Math.abs(c-f)/2,t.opts.lineBreakerOffset),a=l.outerWidth(),s=l.offset().left
else{l=r.parent()
var d=r.offset().top+r.height(),h=i.offset().top
if(h<d)return!1
o=(d+h)/2,a=l.outerWidth(),s=l.offset().left}t.opts.iframe&&(s+=t.$iframe.offset().left-t.helpers.scrollLeft(),o+=t.$iframe.offset().top-t.helpers.scrollTop()),t.$box.append(n),n.css("top",o-t.win.pageYOffset),n.css("left",s-t.win.pageXOffset),n.css("width",a),n.data("tag1",r),n.data("tag2",i),n.addClass("fr-visible").data("instance",t)}function s(n){if(n){var r=e(n)
...
var u={buttons:n,input_layer:r+='<div class="fr-action-buttons"><button class="fr-command fr-submit" role="button" data-cmd="linkInsert" href="#" tabIndex="'+ ++i+'" type="button">'+t.language.translate("Insert")+"</button></div></div>"},f=t.popups.create("link.insert",u)
return t.$wp&&t.events.$on(t.$wp,"scroll.link-insert",function(){(t.image?t.image.get():null)&&t.popups.isVisible("link.insert")&&p(),t.popups.isVisible("link.insert")&&c()}),f}function u(o,s,a){if(void 0===a&&(a={}),!1===t.events.trigger("link.beforeInsert",[o,s,a]))return!1
var l=t.image?t.image.get():null
l||"A"==t.el.tagName?"A"==t.el.tagName&&t.$el.focus():(t.selection.restore(),t.popups.hide("link.insert"))
var u=o
if(t.opts.linkConvertEmailAddress&&t.helpers.isEmail(o)&&!/^mailto:.*/i.test(o)&&(o="mailto:"+o),""===t.opts.linkAutoPrefix||new RegExp("^("+e.FE.LinkProtocols.join("|")+"):.","i").test(o)||/^data:image.*/i.test(o)||/^(https?:|ftps?:|file:|)\/\//i.test(o)||/^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(o)||["/","{","[","#","(","."].indexOf((o||"")[0])<0&&(o=t.opts.linkAutoPrefix+t.helpers.sanitizeURL(o)),o=t.helpers.sanitizeURL(o),t.opts.linkAlwaysBlank&&(a.target="_blank"),t.opts.linkAlwaysNoFollow&&(a.rel="nofollow"),t.helpers.isEmail(u)&&(a.target=null,a.rel=null),"_blank"==a.target?(t.opts.linkNoOpener&&(a.rel?a.rel+=" noopener":a.rel="noopener"),t.opts.linkNoReferrer&&(a.rel?a.rel+=" noreferrer":a.rel="noreferrer")):null==a.target&&(a.rel?a.rel=a.rel.replace(/noopener/,"").replace(/noreferrer/,""):a.rel=null),s=s||"",o===t.opts.linkAutoPrefix)return t.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"),t.events.trigger("link.bad",[u]),!1
var c,p=n()
if(p){if((c=e(p)).attr("href",o),0<s.length&&c.text()!=s&&!l){for(var f=c.get(0);1===f.childNodes.length&&f.childNodes[0].nodeType==Node.ELEMENT_NODE;)f=f.childNodes[0]
e(f).text(s)}l||c.prepend(e.FE.START_MARKER).append(e.FE.END_MARKER),c.attr(a),l||t.selection.restore()}else{l?l.wrap('<a href="'+o+'"></a>'):(t.format.remove("a"),t.selection.isCollapsed()?(s=0===s.length?u:s,t.html.insert('<a href="'+o+'">'+e.FE.START_MARKER+s.replace(/&/g,"&amp;")+e.FE.END_MARKER+"</a>"),t.selection.restore()):0<s.length&&s!=t.selection.text().replace(/\n/g,"")?(t.selection.remove(),t.html.insert('<a href="'+o+'">'+e.FE.START_MARKER+s.replace(/&/g,"&amp;")+e.FE.END_MARKER+"</a>"),t.selection.restore()):(function(){if(!t.selection.isCollapsed()){t.selection.save()
...
for(var d=r(),h=0;h<d.length;h++)(c=e(d[h])).attr(a),c.removeAttr("_moz_dirty")
1==d.length&&t.$wp&&!l&&(e(d[0]).prepend(e.FE.START_MARKER).append(e.FE.END_MARKER),t.selection.restore())}if(l){var m=t.popups.get("link.insert")
...
e(this).toggleClass("fr-active",n).attr("aria-selected",n)})}},refresh:function(e){this.link.get()?e.removeClass("fr-hidden"):e.addClass("fr-hidden")},plugin:"link"})}),function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?require("jquery"):require("jquery")(t)),e(n)}:e(window.jQuery)}(function(e){e.extend(e.FE.DEFAULTS,{listAdvancedTypes:!0}),e.FE.PLUGINS.lists=function(t){function n(e){return'<span class="fr-open-'+e.toLowerCase()+'"></span>'}function r(e){return'<span class="fr-close-'+e.toLowerCase()+'"></span>'}function i(i){var o,s
...
t.helpers.getPX(e(u).css(f))&&0<=(e(u).attr("style")||"").indexOf(f+":")&&(p+=' style="'+f+":"+t.helpers.getPX(e(u).css(f))+'px;"'),t.html.defaultTag()&&0===l.find(t.html.blockTagsQuery()).length&&l.wrapInner("<"+t.html.defaultTag()+p+"></"+t.html.defaultTag()+">"),t.node.isEmpty(l.get(0),!0)||0!==l.find(t.html.blockTagsQuery()).length||l.append("<br>"),l.append(n("LI")),l.prepend(r("LI"))}l.after(n(u.tagName)),"LI"==u.parentNode.tagName&&(u=u.parentNode.parentNode),a.indexOf(u)<0&&a.push(u)}for(o=0;o<a.length;o++){var d=e(a[o]),h=d.html()
h=(h=h.replace(/<span class="fr-close-([a-z]*)"><\/span>/g,"</$1>")).replace(/<span class="fr-open-([a-z]*)"><\/span>/g,"<$1>"),d.replaceWith(t.node.openTagString(d.get(0))+h+t.node.closeTagString(d.get(0)))}t.$el.find("li:empty").remove(),t.$el.find("ul:empty, ol:empty").remove(),t.clean.lists(),t.html.wrap()}function o(n){t.selection.save()
...
if(1<i.length||i.length&&(t.selection.info(i[0]).atStart||t.node.isEmpty(i[0])))return n.preventDefault(),n.stopPropagation(),n.shiftKey?s(i):o(i),!1}},!0)},format:function(n,r){var o,s
for(t.selection.save(),t.html.wrap(!0,!0,!0,!0),t.selection.restore(),s=t.selection.blocks(),o=0;o<s.length;o++)"LI"!=s[o].tagName&&"LI"==s[o].parentNode.tagName&&(s[o]=s[o].parentNode)
if(t.selection.save(),function(e,t){for(var n=!0,r=0;r<e.length;r++){if("LI"!=e[r].tagName)return!1
e[r].parentNode.tagName!=t&&(n=!1)}return n}(s,n)?r||i(s):function(n,r){!function(n,r){for(var i=[],o=0;o<n.length;o++){var s=n[o].parentNode
...
o&&n[a].tagName.toLowerCase()==o?e(n[a]).replaceWith(u+"<li"+t.node.attributes(n[a])+">"+e(n[a]).html()+"</li>"+c):e(n[a]).wrap(u+"<li></li>"+c)}t.clean.lists()}(s,n),t.html.unwrap(),t.selection.restore(),r=r||"default"){for(s=t.selection.blocks(),o=0;o<s.length;o++)"LI"!=s[o].tagName&&"LI"==s[o].parentNode.tagName&&(s[o]=s[o].parentNode)
for(o=0;o<s.length;o++)"LI"==s[o].tagName&&(e(s[o].parentNode).css("list-style-type",r),0===(e(s[o].parentNode).attr("style")||"").length&&e(s[o].parentNode).removeAttr("style"))}},refresh:function(n,r){var i=e(t.selection.element())
...
if(n||(n=d()),n){t.popups.setContainer("table.edit",t.$sc)
...
return t.events.$on(s,"mouseenter",".fr-table-size .fr-select-table-size .fr-table-cell",function(t){f(e(t.currentTarget))},!0),i=s,t.events.$on(i,"focus","[tabIndex]",function(t){f(e(t.currentTarget))}),t.events.on("popup.tab",function(n){var r=e(n.currentTarget)
...
var p=c*l+u,d=e(s.get(p))
f(d),t.events.disableBlur(),d.focus(),i=!1}}else e.FE.KEYCODE.ENTER==o&&(t.button.exec(r),i=!1)
return!1===i&&(n.preventDefault(),n.stopPropagation()),i},!0),s}function f(e){var n=e.data("row"),r=e.data("col"),i=e.parent()
...
o<=n&&s<=r?a.addClass("hover"):o<=n+1||o<=2&&!t.helpers.isMobile()?a.css("display","inline-block"):2<o&&!t.helpers.isMobile()&&a.css("display","none")}e.addClass("fr-active-item")}function d(e){if(e)return t.popups.onHide("table.edit",c),!0
...
if(!l)break}l&&y(u,l,"colspan",0,u.length-1,e,t)}function v(e,t,n){var r,i,o,s,a,l=0,u=T(n)
...
if(!l)break}l&&y(u,l,"rowspan",e,t,0,u[0].length-1)}function y(e,t,n,r,i,o,s){var a,l,u
for(a=r;a<=i;a++)for(l=o;l<=s;l++)r<a&&e[a][l]==e[a-1][l]||o<l&&e[a][l]==e[a][l-1]||1<(u=parseInt(e[a][l].getAttribute(n),10)||1)&&(1<u-t?e[a][l].setAttribute(n,u-t):e[a][l].removeAttribute(n))}function b(e,t,n,r,i){v(e,t,i),g(n,r,i)}function E(e){var n=t.$el.find(".fr-selected-cell")
...
var i=T(),o=_(n,i),s=_(r,i),a=function t(n,r,i,o,s){var a,l,u,c,p=n,f=r,d=i,h=o
for(a=p;a<=f;a++)(1<(parseInt(e(s[a][d]).attr("rowspan"),10)||1)||1<(parseInt(e(s[a][d]).attr("colspan"),10)||1))&&(c=A((u=_(s[a][d],s)).row,u.col,s),p=Math.min(u.row,p),f=Math.max(c.row,f),d=Math.min(u.col,d),h=Math.max(c.col,h)),(1<(parseInt(e(s[a][h]).attr("rowspan"),10)||1)||1<(parseInt(e(s[a][h]).attr("colspan"),10)||1))&&(c=A((u=_(s[a][h],s)).row,u.col,s),p=Math.min(u.row,p),f=Math.max(c.row,f),d=Math.min(u.col,d),h=Math.max(c.col,h))
for(l=d;l<=h;l++)(1<(parseInt(e(s[p][l]).attr("rowspan"),10)||1)||1<(parseInt(e(s[p][l]).attr("colspan"),10)||1))&&(c=A((u=_(s[p][l],s)).row,u.col,s),p=Math.min(u.row,p),f=Math.max(c.row,f),d=Math.min(u.col,d),h=Math.max(c.col,h)),(1<(parseInt(e(s[f][l]).attr("rowspan"),10)||1)||1<(parseInt(e(s[f][l]).attr("colspan"),10)||1))&&(c=A((u=_(s[f][l],s)).row,u.col,s),p=Math.min(u.row,p),f=Math.max(c.row,f),d=Math.min(u.col,d),h=Math.max(c.col,h))
return p==n&&f==r&&d==i&&h==o?{min_i:n,max_i:r,min_j:i,max_j:o}:t(p,f,d,h,s)}(Math.min(o.row,s.row),Math.max(o.row,s.row),Math.min(o.col,s.col),Math.max(o.col,s.col),i)
...
if(t.undo.canDo()||t.undo.saveStep(),null!==o&&null!==s){var u,c,p,f=T(a),d=[],h=[],m=[],g=[]
for(u=0;u<f.length;u++)c=e(f[u][o]),p=e(f[u][s]),d[u]=c.outerWidth(),m[u]=p.outerWidth(),h[u]=d[u]/l*100,g[u]=m[u]/l*100
for(u=0;u<f.length;u++)if(c=e(f[u][o]),p=e(f[u][s]),f[u][o]!=f[u][s]){var v=(h[u]*(d[u]+i-r)/d[u]).toFixed(4)
c.css("width",v+"%"),p.css("width",(h[u]+g[u]-v).toFixed(4)+"%")}}else{var y,b=a.parent(),E=l/b.width()*100,_=(parseInt(a.css("margin-left"),10)||0)/b.width()*100,A=(parseInt(a.css("margin-right"),10)||0)/b.width()*100
"rtl"==t.opts.direction&&0===s||"rtl"!=t.opts.direction&&0!==s?(y=(l+i-r)/l*E,a.css("margin-right","calc(100% - "+Math.round(y).toFixed(4)+"% - "+Math.round(_).toFixed(4)+"%)")):("rtl"==t.opts.direction&&0!==s||"rtl"!=t.opts.direction&&0===s)&&(y=(l-i+r)/l*E,a.css("margin-left","calc(100% - "+Math.round(y).toFixed(4)+"% - "+Math.round(A).toFixed(4)+"%)")),a.css("width",Math.round(y).toFixed(4)+"%")}t.selection.restore(),t.undo.saveStep(),t.events.trigger("table.resized",[a.get(0)])}n.removeData("origin"),n.removeData("release-position"),n.removeData("first"),n.removeData("second"),n.removeData("table")}(),B()}}function D(n){if(!0===i&&0<t.opts.tableEditButtons.length){if(e(n.currentTarget).closest("table").is(X())){if("TD"==n.currentTarget.tagName&&0===t.$el.find("th.fr-selected-cell").length)return void x(s,n.currentTarget)
...
return n.offset().top<=a&&a<n.offset().top+n.outerHeight()/2?(o=parseInt(r.find("a").css("width"),10),r.css("top",u+n.offset().top-t.$box.offset().top-o/2),r.css("left",l+n.offset().left-t.$box.offset().left-o-5),r.data("selected-cell",n.find("td:first")),r.data("position","above"),r.addClass("fr-visible"),!1):n.offset().top+n.outerHeight()/2<=a&&a<n.offset().top+n.outerHeight()?(o=parseInt(r.find("a").css("width"),10),r.css("top",u+n.offset().top-t.$box.offset().top+n.outerHeight()-o/2),r.css("left",l+n.offset().left-t.$box.offset().left-o-5),r.data("selected-cell",n.find("td:first")),r.data("position","below"),r.addClass("fr-visible"),!1):void 0})}function $(i){a=null
...
if(Math.abs(r.pageX-u)<=t.opts.tableResizerOffset||Math.abs(c-r.pageX)<=t.opts.tableResizerOffset){var p,f,d,h,m,g=T(s),v=_(i,g),y=A(v.row,v.col,g),b=s.offset().top,E=s.outerHeight()-1
"rtl"!=t.opts.direction?r.pageX-u<=t.opts.tableResizerOffset?(d=u,0<v.col?(h=u-q(v.col-1,g)+t.opts.tableResizingLimit,m=u+q(v.col,g)-t.opts.tableResizingLimit,p=v.col-1,f=v.col):(p=null,f=0,h=s.offset().left-1-parseInt(s.css("margin-left"),10),m=s.offset().left-1+s.width()-g[0].length*t.opts.tableResizingLimit)):c-r.pageX<=t.opts.tableResizerOffset&&(d=c,y.col<g[y.row].length&&g[y.row][y.col+1]?(h=c-q(y.col,g)+t.opts.tableResizingLimit,m=c+q(y.col+1,g)-t.opts.tableResizingLimit,p=y.col,f=y.col+1):(p=y.col,f=null,h=s.offset().left-1+g[0].length*t.opts.tableResizingLimit,m=a.offset().left-1+a.width()+parseFloat(a.css("padding-left")))):c-r.pageX<=t.opts.tableResizerOffset?(d=c,0<v.col?(h=c-q(v.col,g)+t.opts.tableResizingLimit,m=c+q(v.col-1,g)-t.opts.tableResizingLimit,p=v.col,f=v.col-1):(p=null,f=0,h=s.offset().left+g[0].length*t.opts.tableResizingLimit,m=a.offset().left-1+a.width()+parseFloat(a.css("padding-left")))):r.pageX-u<=t.opts.tableResizerOffset&&(d=u,y.col<g[y.row].length&&g[y.row][y.col+1]?(h=u-q(y.col+1,g)+t.opts.tableResizingLimit,m=u+q(y.col,g)-t.opts.tableResizingLimit,p=y.col+1,f=y.col):(p=y.col,f=null,h=a.offset().left+parseFloat(a.css("padding-left")),m=s.offset().left-1+s.width()-g[0].length*t.opts.tableResizingLimit)),n||(t.shared.$table_resizer||(t.shared.$table_resizer=e('<div class="fr-table-resizer"><div></div></div>')),n=t.shared.$table_resizer,t.events.$on(n,"mousedown",function(e){return!t.core.sameInstance(n)||(0<Q().length&&L(),1==e.which?(t.selection.save(),l=!0,n.addClass("fr-moving"),R(),t.edit.off(),n.find("div").css("opacity",1),!1):void 0)}),t.events.$on(n,"mousemove",function(e){if(!t.core.sameInstance(n))return!0
l&&(t.opts.iframe&&(e.pageX-=t.$iframe.offset().left),z(e))}),t.events.on("shared.destroy",function(){n.html("").removeData().remove(),n=null},!0),t.events.on("destroy",function(){t.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"),n.hide().appendTo(e("body:first"))},!0)),n.data("table",s),n.data("first",p),n.data("second",f),n.data("instance",t),t.$wp.append(n)
var C=d-t.win.pageXOffset-t.opts.tableResizerOffset-t.$wp.offset().left,S=b-t.$wp.offset().top+t.$wp.scrollTop()
t.opts.iframe&&(C+=t.$iframe.offset().left,S+=t.$iframe.offset().top,h+=t.$iframe.offset().left,m+=t.$iframe.offset().left),n.data("max-left",h),n.data("max-right",m),n.data("origin",d-t.win.pageXOffset),n.css("top",S),n.css("left",C),n.css("height",E),n.find("div").css("height",E),n.css("padding-left",t.opts.tableResizerOffset),n.css("padding-right",t.opts.tableResizerOffset),n.show()}else t.core.sameInstance(n)&&B()}}(i,o),!t.opts.tableInsertHelper||t.popups.areVisible()||t.$tb.hasClass("fr-inline")&&t.$tb.is(":visible")||function(n,i){if(0===Q().length){var o,s,a
...
t.opts.iframe&&(e+=t.$iframe.offset().top-t.helpers.scrollTop()),n.css("top",e)}}function q(t,n){var r,i=e(n[0][t]).outerWidth()
for(r=1;r<n.length;r++)i=Math.min(i,e(n[r][t]).outerWidth())
return i}function K(e,t,n){var r,i=0
for(r=e;r<=t;r++)i+=q(r,n)
return i}function z(e){if(1<Q().length&&o&&R(),!1===o&&!1===i&&!1===l)a&&clearTimeout(a),t.edit.isDisabled()&&!t.popups.isVisible("table.edit")||(a=setTimeout($,30,e))
...
if(!t.helpers.isMobile()){l=i=o=!1,t.events.$on(t.$el,"mousedown",I),t.popups.onShow("image.edit",function(){S(),i=o=!1}),t.popups.onShow("link.edit",function(){S(),i=o=!1}),t.events.on("commands.mousedown",function(e){0<e.parents(".fr-toolbar").length&&S()}),t.events.$on(t.$el,"mouseenter","th, td",D),t.events.$on(t.$win,"mouseup",k),t.opts.iframe&&t.events.$on(e(t.o_win),"mouseup",k),t.events.$on(t.$win,"mousemove",z),t.events.$on(e(t.o_win),"scroll",W),t.events.on("contentChanged",function(){0<Q().length&&(u(),t.$el.find("img").on("load.selected-cells",function(){e(this).off("load.selected-cells"),0<Q().length&&u()}))}),t.events.$on(e(t.o_win),"resize",function(){S()}),t.events.on("toolbar.esc",function(){if(0<Q().length)return t.events.disableBlur(),t.events.focus(),!1},!0),t.events.$on(e(t.o_win),"keydown",function(){o&&i&&(i=o=!1,t.$el.removeClass("fr-no-selection"),t.edit.on(),t.selection.setAtEnd(t.$el.find(".fr-selected-cell:last").get(0)),t.selection.restore(),S())}),t.events.$on(t.$el,"keydown",function(n){n.shiftKey?!1===function(n){var r=Q()
...
n=[]}),p(!0),d(!0)}t.events.on("destroy",Y)},insert:function(n,r){var i,o,s="<table "+(t.opts.tableDefaultWidth?'style="width: '+t.opts.tableDefaultWidth+';" ':"")+'class="fr-inserted-table"><tbody>',a=100/r
...
0===p?e(n.find("tr").not(n.find("table tr")).get(r+1)).prepend(c):e(s[r+1][p-1]).after(c)}}var f=o.parent()
o.remove(),0===f.find("tr").length&&f.remove(),s=T(n)}b(0,s.length-1,0,s[0].length-1,n),0<a.min_i?t.selection.setAtEnd(s[a.min_i-1][0]):t.selection.setAtEnd(s[0][0]),t.selection.restore(),t.popups.hide("table.edit")}}},insertColumn:function(n){var r=X()
...
break}r==o[t][a]?(a+=parseInt(e(r).attr("colspan"),10)||1,u++):(a+=parseInt(e(o[t][a]).attr("colspan"),10)||1,"after"==n&&(r=0===u?-1:s.find("> th, > td").get(u-1)))}var p,f=e(r)
if("after"==n&&i<a-1||"before"==n&&0<i&&o[t][i]==o[t][i-1]){if(0===t||0<t&&o[t][i]!=o[t-1][i]){var d=parseInt(f.attr("colspan"),10)+1
f.attr("colspan",d),f.css("width",(f.data("old-width")*c/l+c).toFixed(4)+"%"),f.removeData("old-width")}}else p=0<s.find("th").length?'<th style="width: '+c.toFixed(4)+'%;"><br></th>':'<td style="width: '+c.toFixed(4)+'%;"><br></td>',-1==r?s.prepend(p):null==r?s.append(p):"before"==n?f.before(p):"after"==n&&f.after(p)}),r.find("th, td").each(function(){(a=e(this)).data("old-width")&&(a.css("width",(a.data("old-width")*c/l).toFixed(4)+"%"),a.removeData("old-width"))}),t.popups.isVisible("table.edit")&&u()}},deleteColumn:function(){var n=X()
if(0<n.length){var r,i,o,s=T(),a=w(s)
...
1==u?o.removeAttr("colspan"):o.attr("colspan",u),o.css("width",(100*(o.data("old-width")-q(i,s))/l).toFixed(4)+"%"),o.removeData("old-width")}else{var c=e(o.parent().get(0))
...
var f=l.find("tr:empty")
for(n=f.length-1;0<=n;n--)e(f[n]).remove()
...
for(p=0;p<a.length;p++)if(0===p||a[p][l.col]!=a[p-1][l.col]){var f=e(a[p][l.col])
if(!f.is(n)){var d=(parseInt(f.attr("colspan"),10)||1)+1
f.attr("colspan",d)}}o=o/i*100/2,n.css("width",o.toFixed(4)+"%"),s.css("width",o.toFixed(4)+"%")}n.after(s),S(),t.popups.hide("table.edit")}},splitCellHorizontally:function(){if(1==Q().length){var n=t.$el.find(".fr-selected-cell"),r=n.parent(),i=n.closest("table"),o=parseInt(n.attr("rowspan"),10),s=T(),a=_(n.get(0),s),l=n.clone().html("<br>")
if(1<o){var u=Math.ceil(o/2)
1<u?n.attr("rowspan",u):n.removeAttr("rowspan"),1<o-u?l.attr("rowspan",o-u):l.removeAttr("rowspan")
for(var c=a.row+u,p=0===a.col?a.col:a.col-1;0<=p&&(s[c][p]==s[c][p-1]||0<c&&s[c][p]==s[c-1][p]);)p--;-1==p?e(i.find("tr").not(i.find("table tr")).get(c)).prepend(l):e(s[c][p]).after(l)}else{var f,d=e("<tr>").append(l)
for(f=0;f<s[0].length;f++)if(0===f||s[a.row][f]!=s[a.row][f-1]){var h=e(s[a.row][f])
h.is(n)||h.attr("rowspan",(parseInt(h.attr("rowspan"),10)||1)+1)}r.after(d)}S(),t.popups.hide("table.edit")}},addHeader:function(){var t=X()
...
s=!t.accessibility.focusToolbar(a,!!n.shiftKey)}else if(e.FE.KEYCODE.ARROW_UP==i||e.FE.KEYCODE.ARROW_DOWN==i||e.FE.KEYCODE.ARROW_LEFT==i||e.FE.KEYCODE.ARROW_RIGHT==i){var l=r.parent().find("span.fr-command"),u=l.index(r),c=t.opts.colorsStep,p=Math.floor(l.length/c),f=u%c,d=Math.floor(u/c)*c+f,h=p*c
e.FE.KEYCODE.ARROW_UP==i?d=((d-c)%h+h)%h:e.FE.KEYCODE.ARROW_DOWN==i?d=(d+c)%h:e.FE.KEYCODE.ARROW_LEFT==i?d=((d-1)%h+h)%h:e.FE.KEYCODE.ARROW_RIGHT==i&&(d=(d+1)%h)
var m=e(l.get(d))
...
i||(i=new t(this),r.data("bs.alert",i)),"close"===n&&i[n](this)})},t._handleDismiss=function(e){return function(t){t&&t.preventDefault(),e.close(this)}},i(t,null,[{key:"VERSION",get:function(){return"4.1.3"}}]),t}()
return e(document).on(n.CLICK_DATA_API,'[data-dismiss="alert"]',l._handleDismiss(new l)),e.fn.alert=l._jQueryInterface,e.fn.alert.Constructor=l,e.fn.alert.noConflict=function(){return e.fn.alert=t,l._jQueryInterface},l}(t),u=function(e){var t="button",n=e.fn[t],r="active",o="btn",s="focus",a='[data-toggle^="button"]',l='[data-toggle="buttons"]',u="input",c=".active",p=".btn",f={CLICK_DATA_API:"click.bs.button.data-api",FOCUS_BLUR_DATA_API:"focus.bs.button.data-api blur.bs.button.data-api"},d=function(){function t(e){this._element=e}var n=t.prototype
...
r||(r=new t(this),e(this).data("bs.button",r)),"toggle"===n&&r[n]()})},i(t,null,[{key:"VERSION",get:function(){return"4.1.3"}}]),t}()
return e(document).on(f.CLICK_DATA_API,a,function(t){t.preventDefault()
var n=t.target
e(n).hasClass(o)||(n=e(n).closest(p)),d._jQueryInterface.call(e(n),"toggle")}).on(f.FOCUS_BLUR_DATA_API,a,function(t){var n=e(t.target).closest(p)[0]
e(n).toggleClass(s,/^focus(in)?$/.test(t.type))}),e.fn[t]=d._jQueryInterface,e.fn[t].Constructor=d,e.fn[t].noConflict=function(){return e.fn[t]=n,d._jQueryInterface},d}(t),c=function(e){var t="carousel",n="bs.carousel",r="."+n,o=e.fn[t],l={interval:5e3,keyboard:!0,slide:!1,pause:"hover",wrap:!0},u={interval:"(number|boolean)",keyboard:"boolean",slide:"(boolean|string)",pause:"(string|boolean)",wrap:"boolean"},c="next",p="prev",f="left",d="right",h={SLIDE:"slide"+r,SLID:"slid"+r,KEYDOWN:"keydown"+r,MOUSEENTER:"mouseenter"+r,MOUSELEAVE:"mouseleave"+r,TOUCHEND:"touchend"+r,LOAD_DATA_API:"load.bs.carousel.data-api",CLICK_DATA_API:"click.bs.carousel.data-api"},m="carousel",g="active",v="slide",y="carousel-item-right",b="carousel-item-left",E="carousel-item-next",T="carousel-item-prev",_={ACTIVE:".active",ACTIVE_ITEM:".active.carousel-item",ITEM:".carousel-item",NEXT_PREV:".carousel-item-next, .carousel-item-prev",INDICATORS:".carousel-indicators",DATA_SLIDE:"[data-slide], [data-slide-to]",DATA_RIDE:'[data-ride="carousel"]'},A=function(){function o(t,n){this._items=null,this._interval=null,this._activeElement=null,this._isPaused=!1,this._isSliding=!1,this.touchTimeout=null,this._config=this._getConfig(n),this._element=e(t)[0],this._indicatorsElement=this._element.querySelector(_.INDICATORS),this._addEventListeners()}var A=o.prototype
...
if(t===c?(r=b,i=E,o=f):(r=y,i=T,o=d),p&&e(p).hasClass(g))this._isSliding=!1
...
u&&(l.interval=!1),o._jQueryInterface.call(e(i),l),u&&e(i).data(n).to(u),t.preventDefault()}}},i(o,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return l}}]),o}()
...
A._jQueryInterface.call(i,i.data())}}),e.fn[t]=A._jQueryInterface,e.fn[t].Constructor=A,e.fn[t].noConflict=function(){return e.fn[t]=o,A._jQueryInterface},A}(t),p=function(e){var t="collapse",n="bs.collapse",r=e.fn[t],o={toggle:!0,parent:""},l={toggle:"boolean",parent:"(string|element)"},u={SHOW:"show.bs.collapse",SHOWN:"shown.bs.collapse",HIDE:"hide.bs.collapse",HIDDEN:"hidden.bs.collapse",CLICK_DATA_API:"click.bs.collapse.data-api"},c="show",p="collapse",f="collapsing",d="collapsed",h="width",m="height",g={ACTIVES:".show, .collapsing",DATA_TOGGLE:'[data-toggle="collapse"]'},v=function(){function r(t,n){this._isTransitioning=!1,this._element=t,this._config=this._getConfig(n),this._triggerArray=e.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#'+t.id+'"],[data-toggle="collapse"][data-target="#'+t.id+'"]'))
...
e(this._element).removeClass(p).addClass(f),this._element.style[l]=0,this._triggerArray.length&&e(this._triggerArray).removeClass(d).attr("aria-expanded",!0),this.setTransitioning(!0)
var h="scroll"+(l[0].toUpperCase()+l.slice(1)),m=a.getTransitionDurationFromElement(this._element)
e(this._element).one(a.TRANSITION_END,function(){e(o._element).removeClass(f).addClass(p).addClass(c),o._element.style[l]="",o.setTransitioning(!1),e(o._element).trigger(u.SHOWN)}).emulateTransitionEnd(m),this._element.style[l]=this._element[h]+"px"}}},v.hide=function(){var t=this
...
this._element.style[r]=this._element.getBoundingClientRect()[r]+"px",a.reflow(this._element),e(this._element).addClass(f).removeClass(p).removeClass(c)
var i=this._triggerArray.length
if(i>0)for(var o=0;o<i;o++){var s=this._triggerArray[o],l=a.getSelectorFromElement(s)
if(null!==l)e([].slice.call(document.querySelectorAll(l))).hasClass(c)||e(s).addClass(d).attr("aria-expanded",!1)}this.setTransitioning(!0)
this._element.style[r]=""
var h=a.getTransitionDurationFromElement(this._element)
e(this._element).one(a.TRANSITION_END,function(){t.setTransitioning(!1),e(t._element).removeClass(f).addClass(p).trigger(u.HIDDEN)}).emulateTransitionEnd(h)}}},v.setTransitioning=function(e){this._isTransitioning=e},v.dispose=function(){e.removeData(this._element,n),this._config=null,this._parent=null,this._element=null,this._triggerArray=null,this._isTransitioning=null},v._getConfig=function(e){return(e=s({},o,e)).toggle=Boolean(e.toggle),a.typeCheckConfig(t,e,l),e},v._getDimension=function(){return e(this._element).hasClass(h)?h:m},v._getParent=function(){var t=this,n=null
...
n.length&&e(n).toggleClass(d,!r).attr("aria-expanded",r)}},r._getTargetFromElement=function(e){var t=a.getSelectorFromElement(e)
...
a[t]()}})},i(r,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return o}}]),r}()
...
v._jQueryInterface.call(t,i)})}),e.fn[t]=v._jQueryInterface,e.fn[t].Constructor=v,e.fn[t].noConflict=function(){return e.fn[t]=r,v._jQueryInterface},v}(t),f=function(e){var t="dropdown",r="bs.dropdown",o="."+r,l=e.fn[t],u=new RegExp("38|40|27"),c={HIDE:"hide"+o,HIDDEN:"hidden"+o,SHOW:"show"+o,SHOWN:"shown"+o,CLICK:"click"+o,CLICK_DATA_API:"click.bs.dropdown.data-api",KEYDOWN_DATA_API:"keydown.bs.dropdown.data-api",KEYUP_DATA_API:"keyup.bs.dropdown.data-api"},p="disabled",f="show",d="dropup",h="dropright",m="dropleft",g="dropdown-menu-right",v="position-static",y='[data-toggle="dropdown"]',b=".dropdown form",E=".dropdown-menu",T=".navbar-nav",_=".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",A="top-start",C="top-end",S="bottom-start",R="bottom-end",w="right-start",O="left-start",x={offset:0,flip:!0,boundary:"scrollParent",reference:"toggle",display:"dynamic"},N={offset:"(number|string|function)",flip:"boolean",boundary:"(string|element)",reference:"(string|element)",display:"string"},L=function(){function l(e,t){this._element=e,this._popper=null,this._config=this._getConfig(t),this._menu=this._getMenuElement(),this._inNavbar=this._detectNavbar(),this._addEventListeners()}var b=l.prototype
return b.toggle=function(){if(!this._element.disabled&&!e(this._element).hasClass(p)){var t=l._getParentFromElement(this._element),r=e(this._menu).hasClass(f)
...
e(this._element).on(c.CLICK,function(e){e.preventDefault(),e.stopPropagation(),t.toggle()})},b._getConfig=function(n){return n=s({},this.constructor.Default,e(this._element).data(),n),a.typeCheckConfig(t,n,this.constructor.DefaultType),n},b._getMenuElement=function(){if(!this._menu){var e=l._getParentFromElement(this._element)
e&&(this._menu=e.querySelector(E))}return this._menu},b._getPlacement=function(){var t=e(this._element.parentNode),n=S
return t.hasClass(d)?(n=A,e(this._menu).hasClass(g)&&(n=C)):t.hasClass(h)?n=w:t.hasClass(m)?n=O:e(this._menu).hasClass(g)&&(n=R),n},b._detectNavbar=function(){return e(this._element).closest(".navbar").length>0},b._getPopperConfig=function(){var e=this,t={}
...
n[t]()}})},l._clearMenus=function(t){if(!t||3!==t.which&&("keyup"!==t.type||9===t.which))for(var n=[].slice.call(document.querySelectorAll(y)),i=0,o=n.length;i<o;i++){var s=l._getParentFromElement(n[i]),a=e(n[i]).data(r),u={relatedTarget:n[i]}
if(t&&"click"===t.type&&(u.clickEvent=t),a){var p=a._menu
if(e(s).hasClass(f)&&!(t&&("click"===t.type&&/input|textarea/i.test(t.target.tagName)||"keyup"===t.type&&9===t.which)&&e.contains(s,t.target))){var d=e.Event(c.HIDE,u)
e(s).trigger(d),d.isDefaultPrevented()||("ontouchstart"in document.documentElement&&e(document.body).children().off("mouseover",null,e.noop),n[i].setAttribute("aria-expanded","false"),e(p).removeClass(f),e(s).removeClass(f).trigger(e.Event(c.HIDDEN,u)))}}}},l._getParentFromElement=function(e){var t,n=a.getSelectorFromElement(e)
return n&&(t=document.querySelector(n)),t||e.parentNode},l._dataApiKeydownHandler=function(t){if((/input|textarea/i.test(t.target.tagName)?!(32===t.which||27!==t.which&&(40!==t.which&&38!==t.which||e(t.target).closest(E).length)):u.test(t.which))&&(t.preventDefault(),t.stopPropagation(),!this.disabled&&!e(this).hasClass(p))){var n=l._getParentFromElement(this),r=e(n).hasClass(f)
...
38===t.which&&o>0&&o--,40===t.which&&o<i.length-1&&o++,o<0&&(o=0),i[o].focus()}}else{if(27===t.which){var s=n.querySelector(y)
e(s).trigger("focus")}e(this).trigger("click")}}},i(l,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return x}},{key:"DefaultType",get:function(){return N}}]),l}()
return e(document).on(c.KEYDOWN_DATA_API,y,L._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API,E,L._dataApiKeydownHandler).on(c.CLICK_DATA_API+" "+c.KEYUP_DATA_API,L._clearMenus).on(c.CLICK_DATA_API,y,function(t){t.preventDefault(),t.stopPropagation(),L._jQueryInterface.call(e(this),"toggle")}).on(c.CLICK_DATA_API,b,function(e){e.stopPropagation()}),e.fn[t]=L._jQueryInterface,e.fn[t].Constructor=L,e.fn[t].noConflict=function(){return e.fn[t]=l,L._jQueryInterface},L}(t),d=function(e){var t="modal",n=".bs.modal",r=e.fn.modal,o={backdrop:!0,keyboard:!0,focus:!0,show:!0},l={backdrop:"(boolean|string)",keyboard:"boolean",focus:"boolean",show:"boolean"},u={HIDE:"hide.bs.modal",HIDDEN:"hidden.bs.modal",SHOW:"show.bs.modal",SHOWN:"shown.bs.modal",FOCUSIN:"focusin.bs.modal",RESIZE:"resize.bs.modal",CLICK_DISMISS:"click.dismiss.bs.modal",KEYDOWN_DISMISS:"keydown.dismiss.bs.modal",MOUSEUP_DISMISS:"mouseup.dismiss.bs.modal",MOUSEDOWN_DISMISS:"mousedown.dismiss.bs.modal",CLICK_DATA_API:"click.bs.modal.data-api"},c="modal-scrollbar-measure",p="modal-backdrop",f="modal-open",d="fade",h="show",m={DIALOG:".modal-dialog",DATA_TOGGLE:'[data-toggle="modal"]',DATA_DISMISS:'[data-dismiss="modal"]',FIXED_CONTENT:".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",STICKY_CONTENT:".sticky-top"},g=function(){function r(e,t){this._config=this._getConfig(t),this._element=e,this._dialog=e.querySelector(m.DIALOG),this._backdrop=null,this._isShown=!1,this._isBodyOverflowing=!1,this._ignoreBackdropClick=!1,this._scrollbarWidth=0}var g=r.prototype
...
i[t](n)}else a.show&&i.show(n)})},i(r,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return o}}]),r}()
...
if(e(this.tip).hasClass(m)){var f=a.getTransitionDurationFromElement(this.tip)
e(this.tip).one(a.TRANSITION_END,p).emulateTransitionEnd(f)}else p()}},A.hide=function(t){var n=this,r=this.getTipElement(),i=e.Event(this.constructor.Event.HIDE),o=function(){n._hoverState!==f&&r.parentNode&&r.parentNode.removeChild(r),n._cleanTipClass(),n.element.removeAttribute("aria-describedby"),e(n.element).trigger(n.constructor.Event.HIDDEN),null!==n._popper&&n._popper.destroy(),t&&t()}
if(e(this.element).trigger(i),!i.isDefaultPrevented()){if(e(r).removeClass(g),"ontouchstart"in document.documentElement&&e(document.body).children().off("mouseover",null,e.noop),this._activeTrigger[T]=!1,this._activeTrigger[E]=!1,this._activeTrigger[b]=!1,e(this.tip).hasClass(m)){var s=a.getTransitionDurationFromElement(r)
...
n[t]()}})},i(o,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return p}},{key:"NAME",get:function(){return t}},{key:"DATA_KEY",get:function(){return"bs.tooltip"}},{key:"Event",get:function(){return h}},{key:"EVENT_KEY",get:function(){return r}},{key:"DefaultType",get:function(){return u}}]),o}()
return e.fn[t]=A._jQueryInterface,e.fn[t].Constructor=A,e.fn[t].noConflict=function(){return e.fn[t]=o,A._jQueryInterface},A}(t),m=function(e){var t="popover",n=".bs.popover",r=e.fn[t],o=new RegExp("(^|\\s)bs-popover\\S+","g"),a=s({},h.Default,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'}),l=s({},h.DefaultType,{content:"(string|element|function)"}),u="fade",c="show",p=".popover-header",f=".popover-body",d={HIDE:"hide"+n,HIDDEN:"hidden"+n,SHOW:"show"+n,SHOWN:"shown"+n,INSERTED:"inserted"+n,CLICK:"click"+n,FOCUSIN:"focusin"+n,FOCUSOUT:"focusout"+n,MOUSEENTER:"mouseenter"+n,MOUSELEAVE:"mouseleave"+n},m=function(r){var s,h
...
"function"==typeof n&&(n=n.call(this.element)),this.setElementContent(t.find(f),n),t.removeClass(u+" "+c)},g._getContent=function(){return this.element.getAttribute("data-content")||this.config.content},g._cleanTipClass=function(){var t=e(this.getTipElement()),n=t.attr("class").match(o)
...
n[t]()}})},i(m,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return a}},{key:"NAME",get:function(){return t}},{key:"DATA_KEY",get:function(){return"bs.popover"}},{key:"Event",get:function(){return d}},{key:"EVENT_KEY",get:function(){return n}},{key:"DefaultType",get:function(){return l}}]),m}(h)
return e.fn[t]=m._jQueryInterface,e.fn[t].Constructor=m,e.fn[t].noConflict=function(){return e.fn[t]=r,m._jQueryInterface},m}(t),g=function(e){var t="scrollspy",n=e.fn[t],r={offset:10,method:"auto",target:""},o={offset:"number",method:"string",target:"(string|element)"},l={ACTIVATE:"activate.bs.scrollspy",SCROLL:"scroll.bs.scrollspy",LOAD_DATA_API:"load.bs.scrollspy.data-api"},u="dropdown-item",c="active",p={DATA_SPY:'[data-spy="scroll"]',ACTIVE:".active",NAV_LIST_GROUP:".nav, .list-group",NAV_LINKS:".nav-link",NAV_ITEMS:".nav-item",LIST_ITEMS:".list-group-item",DROPDOWN:".dropdown",DROPDOWN_ITEMS:".dropdown-item",DROPDOWN_TOGGLE:".dropdown-toggle"},f="offset",d="position",h=function(){function n(t,n){var r=this
...
return h.refresh=function(){var t=this,n=this._scrollElement===this._scrollElement.window?f:d,r="auto"===this._config.method?n:this._config.method,i=r===d?this._getScrollTop():0
...
r[t]()}})},i(n,null,[{key:"VERSION",get:function(){return"4.1.3"}},{key:"Default",get:function(){return r}}]),n}()
...
r?this._activate(r,r.parentNode,g):g()}}},h.dispose=function(){e.removeData(this._element,"bs.tab"),this._element=null},h._activate=function(t,n,r){var i=this,o=("UL"===n.nodeName?e(n).find(d):e(n).children(f))[0],s=r&&o&&e(o).hasClass(l),u=function(){return i._transitionComplete(t,o,r)}
...
i[n]()}})},i(t,null,[{key:"VERSION",get:function(){return"4.1.3"}}]),t}()
...
if(t[0]<2&&t[1]<9||1===t[0]&&9===t[1]&&t[2]<1||t[0]>=4)throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")})(t),e.Util=a,e.Alert=l,e.Button=u,e.Carousel=c,e.Collapse=p,e.Dropdown=f,e.Modal=d,e.Popover=m,e.Scrollspy=g,e.Tab=v,e.Tooltip=h,Object.defineProperty(e,"__esModule",{value:!0})}),createDeprecatedModule("ember/resolver"),createDeprecatedModule("resolver"),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
...
function p(e){return!!(0,s.default)(e)&&!!e.match(c)}function f(e){return"/"===e.charAt(0)}function d(e){return"/"===e.charAt(e.length-1)}function h(e){return e.substring(1)}function m(e){return e.slice(0,-1)}function g(e){return f(e)&&(e=h(e)),d(e)&&(e=m(e)),e}var v=0
...
return"GET"!==e&&!(!p(n)&&!p((0,i.default)(o,"Content-Type")))&&"object"===(void 0===r?"undefined":l(r))})(s,e)&&(e.data=JSON.stringify(e.data)),v+=1
var c=(0,n.default)(e.url,e),f=new a.default(function(e,n){c.done(function(i,s,a){var l=o.handleResponse(a.status,(0,r.default)(a.getAllResponseHeaders()),i,u)
...
r?i=g(i):d(i)&&(i=m(i)),n.push(i)}return f(e)&&0!==n.length&&(e=h(e)),n.push(e),n.join("/")},handleResponse:function(e,t,n,r){return this.isSuccess(e,t,n)?n:(n=this.normalizeErrorResponse(e,t,n),this._createCorrectError(e,t,n,r))},_createCorrectError:function(e,n,r,i){var o=void 0
...
l="popups.hide.["+(u=u.replace(s,"-"))+"]"}var c=a.indexOf("-getHtml",-8);-1!==c&&c===a.length-8?t.events.on(l,Ember.run.bind(this,this.didEditorEventReturnHtml,a,t),!0):t.events.on(l,Ember.run.bind(this,this.didEditorEvent,a),!0)}var p=this.get("update"),f=this.get("updateEvent")
p&&f&&t.events.on(f,Ember.run.bind(this,this.didEditorEventReturnHtml,"update",t),!0),t.events.on("destroy",Ember.run.bind(this,this.didDestroyEditor,t),!1),this.get("_initPromises").forEach(function(e){return e()}),this.set("_initPromises",[]),this.set("_editorInitializing",!1),this.set("_editorInitialized",!0)
